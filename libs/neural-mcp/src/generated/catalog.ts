// Generated by libs/neural-mcp/scripts/generate-catalog.mjs. Do not edit.
import type {
...
export const GENERATED_COMPONENTS = [
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/accordion-content/contract",
      "readme": "neural://components/accordion-content/readme",
      "llms": "neural://components/accordion-content/llms"
    },
    "sourceDirectory": "libs/neural-ng/accordion",
    "readme": "# NeuralNg Accordion v0.1 Beta\n\nSignals-first accessible disclosure groups for Angular 22+. Accordion supports\neither concise data items or fully projected panel composition.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralAccordion, NeuralAccordionPanel, NeuralAccordionHeader, NeuralAccordionContent } from '@neural-ng/core/accordion';\n```\n\n## Data-driven usage\n\n```html\n<neural-accordion [items]=\"faqs\" itemLabel=\"question\" itemValue=\"id\" itemContent=\"answer\" itemDisabled=\"disabled\" [(value)]=\"openFaq\" />\n```\n\n`itemValue` must resolve to a unique string or number. When it is missing or\ninvalid, the stable render index is used. Data content is rendered as text, not\nHTML. Duplicate values produce a development warning because panel identity\nmust remain deterministic.\n\n## Projected composition\n\n```html\n<neural-accordion accordionId=\"settings\" [(value)]=\"openPanel\">\n  <neural-accordion-panel value=\"profile\">\n    <neural-accordion-header>Profile</neural-accordion-header>\n    <neural-accordion-content> Custom Angular content </neural-accordion-content>\n  </neural-accordion-panel>\n</neural-accordion>\n```\n\nDo not combine `items` and projected panels. In development, NeuralNg warns and\nuses `items` if both sources are present.\n\nProgrammatic `value` writes update expansion state without emitting the\nuser-only `panelChange` event.\n\n## State\n\n`value` is a model input. In single mode it contains a string, number, or null.\nWith `multiple`, it contains an array of open values.\n\n- `multiple`: allows several expanded panels. Default `false`.\n- `collapsible`: allows the active single panel to close. Default `true`.\n  It only changes single-mode behavior.\n- `disabled`: disables every panel.\n- `panelChange`: optional detailed user event with `panelValue`, `expanded`,\n  previous/next model values, and `keyboard` or `pointer` source.\n\nNormal `[(value)]` binding does not require importing\n`NeuralAccordionPanelChange`.\n\n## Accessibility and keyboard behavior\n\nEvery header is a native button. It owns `aria-expanded` and `aria-controls`;\neach content region references its header with `aria-labelledby`. Collapsed\ncontent is `aria-hidden` and inert.\n\n- Enter or Space toggles the focused header through native button behavior.\n- Arrow Down and Arrow Up move between enabled headers and wrap.\n- Home and End focus the first and last enabled headers.\n- Disabled headers are skipped.\n\nIDs are deterministic and SSR-safe. Set `accordionId` when tests or external\nrelationships need a stable explicit prefix.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural behavior.\nApplication-wide `provideNeuralNg({ unstyled: true })` is also respected.\n\n```ts\nconst classes: NeuralAccordionClasses = {\n  root: 'faq',\n  panel: 'faq__panel',\n  expandedPanel: 'faq__panel--open',\n  disabledPanel: 'faq__panel--disabled',\n  header: 'faq__header',\n  trigger: 'faq__trigger',\n  label: 'faq__label',\n  icon: 'faq__icon',\n  content: 'faq__content',\n  contentInner: 'faq__content-inner',\n};\n```\n\nProjected sections additionally accept `panelClass`, `headerClass`,\n`triggerClass`, and `contentClass`.\n\nThe default chevron uses CSS and does not require Neural Icons.\n\n## Beta boundary\n\nThe Beta API does not create lazy content, fetch remote data, reorder panels,\nor coordinate loading state. Put application-owned loading and error states\ninside projected content. True lazy instantiation needs a separate template\ncontract and will be designed independently.\n",
    "llms": "# NeuralNg Accordion\n\nCurrent component maturity: beta.\n\nImport Accordion only from `@neural-ng/core/accordion`. Use standalone imports.\n\nCanonical imports are `NeuralAccordion`, `NeuralAccordionPanel`,\n`NeuralAccordionHeader`, and `NeuralAccordionContent`.\n\nFor object arrays, prefer `items` with `itemLabel`, `itemValue`,\n`itemContent`, and optionally `itemDisabled`. `itemValue` must be a unique\nstring or number. Data content is plain text.\n\nInvalid or missing data values fall back to the stable render index. Values\nmust remain unique; development mode warns about duplicates. Programmatic\n`value` writes do not emit the user-only `panelChange` event.\n\nFor custom Angular markup, compose `neural-accordion-panel`,\n`neural-accordion-header`, and `neural-accordion-content`. Never combine data\nitems and projected panels.\n\nBind `[(value)]`. Single mode uses `string | number | null`; `multiple` mode\nuses an array. `panelChange` is optional and should only be used when the\ninteraction source or previous value is needed. Do not invent `onOpen`,\n`onClose`, or `activeIndex` APIs.\n\nHeaders are native buttons with complete ARIA relationships and keyboard\nnavigation. Do not add custom key handlers around Accordion.\n\nUse `unstyled` and typed `classes` for headless rendering. The default chevron\nis CSS-only; do not require Neural Icons.\n\nCanonical example:\n\n```html\n<neural-accordion accordionId=\"account\" [(value)]=\"openPanel\">\n  <neural-accordion-panel value=\"profile\">\n    <neural-accordion-header>Profile</neural-accordion-header>\n    <neural-accordion-content>Profile settings</neural-accordion-content>\n  </neural-accordion-panel>\n</neural-accordion>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/accordion-header/contract",
      "readme": "neural://components/accordion-header/readme",
      "llms": "neural://components/accordion-header/llms"
    },
    "sourceDirectory": "libs/neural-ng/accordion",
    "readme": "# NeuralNg Accordion v0.1 Beta\n\nSignals-first accessible disclosure groups for Angular 22+. Accordion supports\neither concise data items or fully projected panel composition.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralAccordion, NeuralAccordionPanel, NeuralAccordionHeader, NeuralAccordionContent } from '@neural-ng/core/accordion';\n```\n\n## Data-driven usage\n\n```html\n<neural-accordion [items]=\"faqs\" itemLabel=\"question\" itemValue=\"id\" itemContent=\"answer\" itemDisabled=\"disabled\" [(value)]=\"openFaq\" />\n```\n\n`itemValue` must resolve to a unique string or number. When it is missing or\ninvalid, the stable render index is used. Data content is rendered as text, not\nHTML. Duplicate values produce a development warning because panel identity\nmust remain deterministic.\n\n## Projected composition\n\n```html\n<neural-accordion accordionId=\"settings\" [(value)]=\"openPanel\">\n  <neural-accordion-panel value=\"profile\">\n    <neural-accordion-header>Profile</neural-accordion-header>\n    <neural-accordion-content> Custom Angular content </neural-accordion-content>\n  </neural-accordion-panel>\n</neural-accordion>\n```\n\nDo not combine `items` and projected panels. In development, NeuralNg warns and\nuses `items` if both sources are present.\n\nProgrammatic `value` writes update expansion state without emitting the\nuser-only `panelChange` event.\n\n## State\n\n`value` is a model input. In single mode it contains a string, number, or null.\nWith `multiple`, it contains an array of open values.\n\n- `multiple`: allows several expanded panels. Default `false`.\n- `collapsible`: allows the active single panel to close. Default `true`.\n  It only changes single-mode behavior.\n- `disabled`: disables every panel.\n- `panelChange`: optional detailed user event with `panelValue`, `expanded`,\n  previous/next model values, and `keyboard` or `pointer` source.\n\nNormal `[(value)]` binding does not require importing\n`NeuralAccordionPanelChange`.\n\n## Accessibility and keyboard behavior\n\nEvery header is a native button. It owns `aria-expanded` and `aria-controls`;\neach content region references its header with `aria-labelledby`. Collapsed\ncontent is `aria-hidden` and inert.\n\n- Enter or Space toggles the focused header through native button behavior.\n- Arrow Down and Arrow Up move between enabled headers and wrap.\n- Home and End focus the first and last enabled headers.\n- Disabled headers are skipped.\n\nIDs are deterministic and SSR-safe. Set `accordionId` when tests or external\nrelationships need a stable explicit prefix.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural behavior.\nApplication-wide `provideNeuralNg({ unstyled: true })` is also respected.\n\n```ts\nconst classes: NeuralAccordionClasses = {\n  root: 'faq',\n  panel: 'faq__panel',\n  expandedPanel: 'faq__panel--open',\n  disabledPanel: 'faq__panel--disabled',\n  header: 'faq__header',\n  trigger: 'faq__trigger',\n  label: 'faq__label',\n  icon: 'faq__icon',\n  content: 'faq__content',\n  contentInner: 'faq__content-inner',\n};\n```\n\nProjected sections additionally accept `panelClass`, `headerClass`,\n`triggerClass`, and `contentClass`.\n\nThe default chevron uses CSS and does not require Neural Icons.\n\n## Beta boundary\n\nThe Beta API does not create lazy content, fetch remote data, reorder panels,\nor coordinate loading state. Put application-owned loading and error states\ninside projected content. True lazy instantiation needs a separate template\ncontract and will be designed independently.\n",
    "llms": "# NeuralNg Accordion\n\nCurrent component maturity: beta.\n\nImport Accordion only from `@neural-ng/core/accordion`. Use standalone imports.\n\nCanonical imports are `NeuralAccordion`, `NeuralAccordionPanel`,\n`NeuralAccordionHeader`, and `NeuralAccordionContent`.\n\nFor object arrays, prefer `items` with `itemLabel`, `itemValue`,\n`itemContent`, and optionally `itemDisabled`. `itemValue` must be a unique\nstring or number. Data content is plain text.\n\nInvalid or missing data values fall back to the stable render index. Values\nmust remain unique; development mode warns about duplicates. Programmatic\n`value` writes do not emit the user-only `panelChange` event.\n\nFor custom Angular markup, compose `neural-accordion-panel`,\n`neural-accordion-header`, and `neural-accordion-content`. Never combine data\nitems and projected panels.\n\nBind `[(value)]`. Single mode uses `string | number | null`; `multiple` mode\nuses an array. `panelChange` is optional and should only be used when the\ninteraction source or previous value is needed. Do not invent `onOpen`,\n`onClose`, or `activeIndex` APIs.\n\nHeaders are native buttons with complete ARIA relationships and keyboard\nnavigation. Do not add custom key handlers around Accordion.\n\nUse `unstyled` and typed `classes` for headless rendering. The default chevron\nis CSS-only; do not require Neural Icons.\n\nCanonical example:\n\n```html\n<neural-accordion accordionId=\"account\" [(value)]=\"openPanel\">\n  <neural-accordion-panel value=\"profile\">\n    <neural-accordion-header>Profile</neural-accordion-header>\n    <neural-accordion-content>Profile settings</neural-accordion-content>\n  </neural-accordion-panel>\n</neural-accordion>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/accordion-panel/contract",
      "readme": "neural://components/accordion-panel/readme",
      "llms": "neural://components/accordion-panel/llms"
    },
    "sourceDirectory": "libs/neural-ng/accordion",
    "readme": "# NeuralNg Accordion v0.1 Beta\n\nSignals-first accessible disclosure groups for Angular 22+. Accordion supports\neither concise data items or fully projected panel composition.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralAccordion, NeuralAccordionPanel, NeuralAccordionHeader, NeuralAccordionContent } from '@neural-ng/core/accordion';\n```\n\n## Data-driven usage\n\n```html\n<neural-accordion [items]=\"faqs\" itemLabel=\"question\" itemValue=\"id\" itemContent=\"answer\" itemDisabled=\"disabled\" [(value)]=\"openFaq\" />\n```\n\n`itemValue` must resolve to a unique string or number. When it is missing or\ninvalid, the stable render index is used. Data content is rendered as text, not\nHTML. Duplicate values produce a development warning because panel identity\nmust remain deterministic.\n\n## Projected composition\n\n```html\n<neural-accordion accordionId=\"settings\" [(value)]=\"openPanel\">\n  <neural-accordion-panel value=\"profile\">\n    <neural-accordion-header>Profile</neural-accordion-header>\n    <neural-accordion-content> Custom Angular content </neural-accordion-content>\n  </neural-accordion-panel>\n</neural-accordion>\n```\n\nDo not combine `items` and projected panels. In development, NeuralNg warns and\nuses `items` if both sources are present.\n\nProgrammatic `value` writes update expansion state without emitting the\nuser-only `panelChange` event.\n\n## State\n\n`value` is a model input. In single mode it contains a string, number, or null.\nWith `multiple`, it contains an array of open values.\n\n- `multiple`: allows several expanded panels. Default `false`.\n- `collapsible`: allows the active single panel to close. Default `true`.\n  It only changes single-mode behavior.\n- `disabled`: disables every panel.\n- `panelChange`: optional detailed user event with `panelValue`, `expanded`,\n  previous/next model values, and `keyboard` or `pointer` source.\n\nNormal `[(value)]` binding does not require importing\n`NeuralAccordionPanelChange`.\n\n## Accessibility and keyboard behavior\n\nEvery header is a native button. It owns `aria-expanded` and `aria-controls`;\neach content region references its header with `aria-labelledby`. Collapsed\ncontent is `aria-hidden` and inert.\n\n- Enter or Space toggles the focused header through native button behavior.\n- Arrow Down and Arrow Up move between enabled headers and wrap.\n- Home and End focus the first and last enabled headers.\n- Disabled headers are skipped.\n\nIDs are deterministic and SSR-safe. Set `accordionId` when tests or external\nrelationships need a stable explicit prefix.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural behavior.\nApplication-wide `provideNeuralNg({ unstyled: true })` is also respected.\n\n```ts\nconst classes: NeuralAccordionClasses = {\n  root: 'faq',\n  panel: 'faq__panel',\n  expandedPanel: 'faq__panel--open',\n  disabledPanel: 'faq__panel--disabled',\n  header: 'faq__header',\n  trigger: 'faq__trigger',\n  label: 'faq__label',\n  icon: 'faq__icon',\n  content: 'faq__content',\n  contentInner: 'faq__content-inner',\n};\n```\n\nProjected sections additionally accept `panelClass`, `headerClass`,\n`triggerClass`, and `contentClass`.\n\nThe default chevron uses CSS and does not require Neural Icons.\n\n## Beta boundary\n\nThe Beta API does not create lazy content, fetch remote data, reorder panels,\nor coordinate loading state. Put application-owned loading and error states\ninside projected content. True lazy instantiation needs a separate template\ncontract and will be designed independently.\n",
    "llms": "# NeuralNg Accordion\n\nCurrent component maturity: beta.\n\nImport Accordion only from `@neural-ng/core/accordion`. Use standalone imports.\n\nCanonical imports are `NeuralAccordion`, `NeuralAccordionPanel`,\n`NeuralAccordionHeader`, and `NeuralAccordionContent`.\n\nFor object arrays, prefer `items` with `itemLabel`, `itemValue`,\n`itemContent`, and optionally `itemDisabled`. `itemValue` must be a unique\nstring or number. Data content is plain text.\n\nInvalid or missing data values fall back to the stable render index. Values\nmust remain unique; development mode warns about duplicates. Programmatic\n`value` writes do not emit the user-only `panelChange` event.\n\nFor custom Angular markup, compose `neural-accordion-panel`,\n`neural-accordion-header`, and `neural-accordion-content`. Never combine data\nitems and projected panels.\n\nBind `[(value)]`. Single mode uses `string | number | null`; `multiple` mode\nuses an array. `panelChange` is optional and should only be used when the\ninteraction source or previous value is needed. Do not invent `onOpen`,\n`onClose`, or `activeIndex` APIs.\n\nHeaders are native buttons with complete ARIA relationships and keyboard\nnavigation. Do not add custom key handlers around Accordion.\n\nUse `unstyled` and typed `classes` for headless rendering. The default chevron\nis CSS-only; do not require Neural Icons.\n\nCanonical example:\n\n```html\n<neural-accordion accordionId=\"account\" [(value)]=\"openPanel\">\n  <neural-accordion-panel value=\"profile\">\n    <neural-accordion-header>Profile</neural-accordion-header>\n    <neural-accordion-content>Profile settings</neural-accordion-content>\n  </neural-accordion-panel>\n</neural-accordion>\n```\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/avatar-group/contract",
      "readme": "neural://components/avatar-group/readme",
      "llms": "neural://components/avatar-group/llms"
    },
    "sourceDirectory": "libs/neural-ng/avatar",
    "readme": "# NeuralNg Avatar\n\nImage, initials, icon, and custom fallback identities for Angular 22+.\n\n```ts\nimport { NeuralAvatar, NeuralAvatarGroup, type NeuralAvatarClasses } from '@neural-ng/core/avatar';\n\n@Component({ imports: [NeuralAvatar, NeuralAvatarGroup] })\nexport class Example {}\n```\n\n## Image and fallback\n\n```html\n<neural-avatar src=\"/users/ada.webp\" srcSet=\"/users/ada.webp 1x, /users/ada@2x.webp 2x\" sizes=\"48px\" name=\"Ada Lovelace\" loading=\"lazy\" />\n```\n\n`name` supplies the native image alt text when `alt` is not explicitly set.\nIt also derives a two-letter fallback from the first and last words. Override\nthat value with `initials`.\n\nFallback priority is:\n\n1. Valid `src`\n2. Explicit or derived initials\n3. `iconClass`\n4. Projected fallback content\n\n```html\n<neural-avatar name=\"Ada Lovelace\" />\n<neural-avatar initials=\"AL\" ariaLabel=\"Ada Lovelace\" />\n<neural-avatar iconClass=\"nt nt-user\" ariaLabel=\"Account\" />\n<neural-avatar ariaLabel=\"Neural AI\"><strong>AI</strong></neural-avatar>\n```\n\nNeural Icons are optional. Avatar never adds an icon package dependency;\nconsumers opt in with `iconClass`.\n\n## Sizes and shapes\n\nSizes are `extra-small`, `small`, `medium`, `large`, and `extra-large`. Shapes are `circle`, `rounded`,\nand `square`. `imageFit` accepts `cover` or `contain`. Responsive image inputs\nare `srcSet` and `sizes`; native loading inputs are `loading`, `decoding`,\n`fetchPriority`, and `referrerPolicy`.\n\n`imageLoaded` and `imageError` emit the native `Event`. An image error switches\nto fallback without displaying a broken image. Changing `src` resets the error\nstate and retries.\n\n## Badge composition\n\nImport `NeuralBadgeDirective` from `@neural-ng/core/badge` and place it directly on\nthe Avatar host:\n\n```html\n<neural-avatar name=\"Ada Lovelace\" neuralBadge=\"\" neuralBadgeDot neuralBadgePosition=\"bottom-end\" neuralBadgeSeverity=\"success\" neuralBadgeAriaLabel=\"Online\" />\n```\n\nNotification counts use the same API:\n\n```html\n<neural-avatar name=\"Ada Lovelace\" [neuralBadge]=\"5\" neuralBadgePosition=\"top-end\" neuralBadgeSeverity=\"error\" />\n```\n\n## AvatarGroup\n\n```html\n<neural-avatar-group [max]=\"3\" ariaLabel=\"Project team\" overflowLabel=\"{count} more teammates\">\n  <neural-avatar name=\"Ada Lovelace\" />\n  <neural-avatar name=\"Grace Hopper\" />\n  <neural-avatar name=\"Margaret Hamilton\" />\n  <neural-avatar name=\"Radia Perlman\" />\n</neural-avatar-group>\n```\n\n`max` limits visible projected Avatars and renders `+N` for the remainder.\n`overflowLabel` must retain the `{count}` placeholder and should be localized.\nLogical overlap follows RTL automatically.\n\n## Headless mode\n\nAvatar inputs:\n\n- `unstyled`\n- `avatarClass`\n- `classes`: `root`, `image`, `fallback`, `initials`, `icon`, `content`\n\nAvatarGroup inputs:\n\n- `unstyled`\n- `groupClass`\n- `classes`: `root`, `overflow`\n\nStructural hooks remain in unstyled mode. Global headless mode is available\nthrough `provideNeuralNg({ unstyled: true })`.\n\nPrimary tokens include `--neural-avatar-*-size`,\n`--neural-avatar-fallback-*`, `--neural-avatar-group-overlap`, and\n`--neural-avatar-group-overflow-*`.\n\n`AvatarComponent` and `AvatarGroupComponent` remain deprecated compatibility\naliases. New code should use `NeuralAvatar` and `NeuralAvatarGroup`.\n\n## Beta boundary\n\nBeta includes native responsive images, deterministic fallbacks, image retry,\nfive sizes, three shapes, shared Badge composition, grouped overflow, RTL, and\nheadless ownership. Upload, crop, presence transport, profile fetching,\ninteractive user menus, and tooltip behavior remain separate concerns.\n",
    "llms": "NeuralNg Avatar rules\n\n- Import Avatar only from `@neural-ng/core/avatar`.\n- Add `NeuralAvatar` directly to standalone component imports.\n- Add `NeuralAvatarGroup` when `<neural-avatar-group>` is used.\n- `AvatarComponent` and `AvatarGroupComponent` are deprecated compatibility aliases; generate canonical Neural names.\n- Prefer `name` for identity; it supplies derived initials and fallback accessibility.\n- Set `alt=\"\"` explicitly only when the image is decorative.\n- Fallback priority is image, initials, iconClass, then projected content.\n- `iconClass` is optional. Never assume Neural Icons is a core dependency.\n- Sizes: `extra-small`, `small`, `medium`, `large`, `extra-large`.\n- Shapes: `circle`, `rounded`, `square`.\n- Image fit: `cover`, `contain`.\n- Use `srcSet` and `sizes` for responsive sources.\n- `imageLoaded` and `imageError` emit native Event values.\n- Image errors switch to fallback; a new src retries automatically.\n- Compose status dots and counts with `NeuralBadgeDirective` from `@neural-ng/core/badge`.\n- Do not create Avatar-specific Badge markup or positioning logic.\n- AvatarGroup max keeps that many Avatars visible and renders +N overflow.\n- Localize AvatarGroup `overflowLabel` and preserve its `{count}` placeholder.\n- Group overlap uses logical CSS and follows RTL.\n- `unstyled` removes visual classes while structural hooks remain.\n- Avatar slots: `root`, `image`, `fallback`, `initials`, `icon`, `content`.\n- AvatarGroup slots: `root`, `overflow`.\n- Global unstyled mode is `provideNeuralNg({ unstyled: true })`.\n- Current maturity is Beta. Upload, crop, presence transport, profile fetching, interactive menus, and tooltips are separate concerns.\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/badge-directive/contract",
      "readme": "neural://components/badge-directive/readme",
      "llms": "neural://components/badge-directive/llms"
    },
    "sourceDirectory": "libs/neural-ng/badge",
    "readme": "# NeuralNg Badge\n\nCompact status, count, and metadata indicators for Angular 22+.\n\n```ts\nimport { NeuralBadge, NeuralBadgeDirective, type NeuralBadgeClasses } from '@neural-ng/core/badge';\n```\n\n```html\n<neural-badge [value]=\"128\" [max]=\"99\" severity=\"info\" />\n<neural-badge dot severity=\"success\" ariaLabel=\"Online\" />\n<neural-badge severity=\"success\">\n  <i class=\"nt nt-check\"></i>\n  Verified\n</neural-badge>\n```\n\n`value` accepts strings and numbers. Numeric values above `max` are visually\ncapped while the real value remains available through `aria-label`. Zero and\nnegative values are rendered normally. When `value` is absent, projected\ncontent is displayed.\n\nSemantic severities are `primary`, `secondary`, `neutral`, `info`, `success`,\n`warning`, and `error`. Sizes are `small`, `medium`, and `large`. `rounded` defaults to\n`true`; `dot` creates a visual-only dot and should be paired with `ariaLabel`\nwhen it conveys meaning. Use `badgeHidden` to hide the badge explicitly without\ntreating zero as empty. `ariaLive` accepts `off`, `polite`, or `assertive`.\n\n`unstyled` removes NeuralNg visual classes while preserving structural hooks.\nTyped class slots are `root`, `value`, and `content`.\n\n## Badge directive\n\n`NeuralBadgeDirective` attaches the real `NeuralBadge` to any suitable anchor:\n\n```html\n<button aria-label=\"Notifications, 8 unread\" [neuralBadge]=\"8\" neuralBadgePosition=\"top-end\" neuralBadgeSeverity=\"error\">\n  <i class=\"nt nt-bell\" aria-hidden=\"true\"></i>\n</button>\n```\n\nAvailable positions are `start`, `end`, `top-start`, `top-end`,\n`bottom-start`, and `bottom-end`. Corner positions use logical CSS, follow\nRTL automatically, and do not affect layout. `null` and `undefined` remove the\ngenerated Badge host; zero remains visible. A dot can omit a value:\n\n```html\n<span neuralBadge=\"\" neuralBadgeDot neuralBadgePosition=\"bottom-end\" neuralBadgeAriaLabel=\"Online\"> Avatar </span>\n```\n\nDirective inputs are:\n\n| Input                  | Default   | Purpose                                |\n| ---------------------- | --------- | -------------------------------------- |\n| `neuralBadge`          | `null`    | String or numeric value.               |\n| `neuralBadgePosition`  | `top-end` | Inline or logical-corner placement.    |\n| `neuralBadgeSeverity`  | `neutral` | Semantic Badge severity.               |\n| `neuralBadgeSize`      | `small`   | Badge size.                            |\n| `neuralBadgeMax`       | `null`    | Numeric visual cap.                    |\n| `neuralBadgeAriaLabel` | `null`    | Accessible Badge label.                |\n| `neuralBadgeAriaLive`  | `off`     | Live-region behavior.                  |\n| `neuralBadgeClass`     | `''`      | Consumer class for the Badge root.     |\n| `neuralBadgeHostClass` | `''`      | Consumer class for the generated host. |\n| `neuralBadgeRounded`   | `true`    | Rounded visual treatment.              |\n| `neuralBadgeDot`       | `false`   | Render a dot instead of a value.       |\n| `neuralBadgeHidden`    | `false`   | Explicitly remove the generated Badge. |\n| `neuralBadgeUnstyled`  | `false`   | Remove the Badge visual layer.         |\n\nThe anchor receives the structural `neural-badge-anchor` class. Overlay offset\nand stacking are controlled with `--neural-badge-anchor-offset` and\n`--neural-badge-anchor-z-index`. Replaced or void elements such as `img` and\n`input` should be placed inside a wrapper carrying the directive. The generated\ncomponent is attached in Angular's hydration-safe post-render phase so the\nserver and client never create duplicate Badge nodes.\n\nButton uses this same directive internally through its shorter `badge` inputs:\n\n```html\n<neural-button [badge]=\"12\" badgePosition=\"end\" badgeSeverity=\"error\"> Notifications </neural-button>\n```\n\nUse Button's integration when Badge belongs to a NeuralNg action, the directive\nfor arbitrary anchors, and `<neural-badge>` for standalone inline indicators.\n\n## Compatibility aliases\n\n`BadgeComponent` and `BadgeDirective` remain exported as deprecated aliases for\nearly alpha consumers. New code and generated code must use `NeuralBadge` and\n`NeuralBadgeDirective`.\n\n## Beta boundary\n\nBadge Beta includes standalone values, numeric caps, projected content, dots,\nsemantic severities, three sizes, live-region control, explicit visibility,\ntyped class slots, global/local unstyled behavior, arbitrary-anchor placement,\nlogical RTL positions, hydration-safe creation, and Button composition. Badge\ndoes not own anchor interaction, tooltip behavior, or Tag semantics.\n",
    "llms": "NeuralNg Badge rules\n\n- Import only from `@neural-ng/core/badge`.\n- Import `NeuralBadge` for `<neural-badge>` and `NeuralBadgeDirective` for `[neuralBadge]` from `@neural-ng/core/badge`.\n- Add the canonical symbol directly to the standalone consumer component's `imports` array.\n- Never generate the deprecated `BadgeComponent` or `BadgeDirective` aliases in new code.\n- Use `[neuralBadge]` to attach a real Badge component to an arbitrary anchor.\n- Directive positions: `start`, `end`, `top-start`, `top-end`, `bottom-start`, `bottom-end`.\n- Logical corner positions follow RTL and do not change anchor layout.\n- `null` and `undefined` remove a directive Badge; zero remains visible.\n- Use a wrapper as the directive anchor for replaced or void elements such as `img` and `input`.\n- The directive creates its Badge in Angular's hydration-safe post-render phase; do not replace this with constructor-time DOM mutation.\n- Use `value` for text or numeric content.\n- Use `max` only for numeric visual caps; the real number stays accessible.\n- Zero and negative numbers are valid values.\n- When `value` is absent, projected content is rendered.\n- Severities: `primary`, `secondary`, `neutral`, `info`, `success`, `warning`, `error`.\n- Sizes: `small`, `medium`, `large`.\n- `rounded` defaults to true.\n- A meaningful `dot` badge must have an `ariaLabel`.\n- Use `ariaLive=\"polite\"` for non-urgent dynamic counters.\n- Use `badgeHidden` for explicit visibility.\n- `unstyled` removes visual classes, not structural hooks.\n- Typed class slots: `root`, `value`, `content`.\n- For a Badge inside NeuralNg Button, prefer Button's shorter `badge` inputs; Button delegates to `NeuralBadgeDirective`.\n- Badge is Beta: do not invent outputs, interactive behavior, tooltip inputs, Tag semantics, or undocumented positions.\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/breadcrumb-item/contract",
      "readme": "neural://components/breadcrumb-item/readme",
      "llms": "neural://components/breadcrumb-item/llms"
    },
    "sourceDirectory": "libs/neural-ng/breadcrumb",
    "readme": "# NeuralNg Breadcrumb\n\nAccessible, Signals-based breadcrumb navigation for Angular 22+.\n\n```ts\nimport { NeuralBreadcrumb, NeuralBreadcrumbItemComponent, NeuralBreadcrumbSeparatorTemplate, type NeuralBreadcrumbItem } from '@neural-ng/core/breadcrumb';\n```\n\n```html\n<neural-breadcrumb ariaLabel=\"Page trail\" [items]=\"items\" [maxItems]=\"3\" [overflowTooltipDelay]=\"100\" (itemSelect)=\"select($event)\" />\n```\n\nThe last item receives `aria-current=\"page\"` unless an item explicitly sets\n`current`. Use `routerLink` for Angular navigation or `href` for normal links.\n`maxItems >= 2` keeps the first and trailing items visible and moves middle\nitems into an accessible NeuralNg Menu. `overflowLabel` is used for both the\ntrigger's accessible name and its hover/focus Tooltip.\n`overflowTooltipDelay` controls its delay in milliseconds and defaults to\n`100`.\n\nProjected items and a custom separator are also supported:\n\n```html\n<neural-breadcrumb>\n  <neural-breadcrumb-item key=\"home\" label=\"Home\" routerLink=\"/\" />\n  <neural-breadcrumb-item key=\"current\" label=\"Current\" />\n  <ng-template neuralBreadcrumbSeparator>/</ng-template>\n</neural-breadcrumb>\n```\n\n`unstyled` removes NeuralNg visual classes while preserving semantic and\nstructural classes. Typed class slots are `root`, `list`, `item`, `link`,\n`current`, `disabled`, `icon`, `label`, `separator`, `overflowItem`, and\n`overflowTrigger`.\n\n## Navigation and selection\n\nEach item requires a stable `key` and visible `label`. `routerLink` supports\nstring, command-array, or UrlTree values together with `queryParams`,\n`fragment`, `queryParamsHandling`, `preserveFragment`, `skipLocationChange`,\n`replaceUrl`, `state`, and `target`.\nNative `href` items retain `target` and `rel`. Disabled items are readable but\ninert. `itemSelect` emits `{ key, item, originalEvent }` for visible and\noverflow selections.\n\n## Accessibility\n\nBreadcrumb renders a named `nav` landmark containing an ordered list. The last\nitem receives `aria-current=\"page\"` unless an explicit current item exists.\nThe overflow trigger is a native Button and delegates popup keyboard behavior\nto NeuralNg Menu. Links retain native or Angular Router keyboard semantics.\n\n## Compatibility aliases\n\n`BreadcrumbComponent`, `BreadcrumbItemComponent`, and\n`BreadcrumbSeparatorTemplate` remain deprecated aliases for early alpha\nconsumers. New code must use `NeuralBreadcrumb`,\n`NeuralBreadcrumbItemComponent`, and `NeuralBreadcrumbSeparatorTemplate`.\n\n## Beta boundary\n\nBreadcrumb Beta includes immutable data items, projected items, Router and\nnative links, current/disabled states, selection events, responsive Menu\noverflow, Tooltip delay, icon/template separators, RTL, SSR-safe rendering,\ntyped class slots, and global/local unstyled behavior. Route construction,\napplication history, page titles, and navigation authorization remain\napplication concerns.\n",
    "llms": "NeuralNg Breadcrumb rules\n\n- Import `NeuralBreadcrumb`, `NeuralBreadcrumbItemComponent`, and `NeuralBreadcrumbSeparatorTemplate` only from `@neural-ng/core/breadcrumb`.\n- Add only the canonical runtime symbols used by the template directly to standalone component imports.\n- Never generate deprecated `BreadcrumbComponent`, `BreadcrumbItemComponent`, or `BreadcrumbSeparatorTemplate` aliases in new code.\n- Every item needs a stable `key` and visible `label`.\n- Prefer `routerLink` for Angular routes and `href` for document navigation.\n- The last item is current by default; use `current` only to override it.\n- `maxItems >= 2` collapses middle items into an accessible NeuralNg Menu.\n- `overflowLabel` labels the trigger and provides its hover/focus Tooltip.\n- `overflowTooltipDelay` defaults to `100` milliseconds.\n- Use either `[items]` or `<neural-breadcrumb-item>` children, never both.\n- Customize separators with `separatorIconClass` or\n  `<ng-template neuralBreadcrumbSeparator>`.\n- `itemSelect` emits `{ key, item, originalEvent }`.\n- `unstyled` removes visual classes, not semantics or structural hooks.\n- `routerLink` accepts a string, command array, or UrlTree and composes with `queryParams`, `fragment`, `queryParamsHandling`, `preserveFragment`, `skipLocationChange`, `replaceUrl`, `state`, and `target`.\n- `href` retains native `target` and `rel` behavior.\n- Do not add custom arrow-key handlers; visible items retain native link behavior and overflow delegates to Neural Menu.\n- Current maturity is Beta. Do not invent route construction, history, authorization, page-title, or tooltip APIs.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/breadcrumb-separator-template/contract",
      "readme": "neural://components/breadcrumb-separator-template/readme",
      "llms": "neural://components/breadcrumb-separator-template/llms"
    },
    "sourceDirectory": "libs/neural-ng/breadcrumb",
    "readme": "# NeuralNg Breadcrumb\n\nAccessible, Signals-based breadcrumb navigation for Angular 22+.\n\n```ts\nimport { NeuralBreadcrumb, NeuralBreadcrumbItemComponent, NeuralBreadcrumbSeparatorTemplate, type NeuralBreadcrumbItem } from '@neural-ng/core/breadcrumb';\n```\n\n```html\n<neural-breadcrumb ariaLabel=\"Page trail\" [items]=\"items\" [maxItems]=\"3\" [overflowTooltipDelay]=\"100\" (itemSelect)=\"select($event)\" />\n```\n\nThe last item receives `aria-current=\"page\"` unless an item explicitly sets\n`current`. Use `routerLink` for Angular navigation or `href` for normal links.\n`maxItems >= 2` keeps the first and trailing items visible and moves middle\nitems into an accessible NeuralNg Menu. `overflowLabel` is used for both the\ntrigger's accessible name and its hover/focus Tooltip.\n`overflowTooltipDelay` controls its delay in milliseconds and defaults to\n`100`.\n\nProjected items and a custom separator are also supported:\n\n```html\n<neural-breadcrumb>\n  <neural-breadcrumb-item key=\"home\" label=\"Home\" routerLink=\"/\" />\n  <neural-breadcrumb-item key=\"current\" label=\"Current\" />\n  <ng-template neuralBreadcrumbSeparator>/</ng-template>\n</neural-breadcrumb>\n```\n\n`unstyled` removes NeuralNg visual classes while preserving semantic and\nstructural classes. Typed class slots are `root`, `list`, `item`, `link`,\n`current`, `disabled`, `icon`, `label`, `separator`, `overflowItem`, and\n`overflowTrigger`.\n\n## Navigation and selection\n\nEach item requires a stable `key` and visible `label`. `routerLink` supports\nstring, command-array, or UrlTree values together with `queryParams`,\n`fragment`, `queryParamsHandling`, `preserveFragment`, `skipLocationChange`,\n`replaceUrl`, `state`, and `target`.\nNative `href` items retain `target` and `rel`. Disabled items are readable but\ninert. `itemSelect` emits `{ key, item, originalEvent }` for visible and\noverflow selections.\n\n## Accessibility\n\nBreadcrumb renders a named `nav` landmark containing an ordered list. The last\nitem receives `aria-current=\"page\"` unless an explicit current item exists.\nThe overflow trigger is a native Button and delegates popup keyboard behavior\nto NeuralNg Menu. Links retain native or Angular Router keyboard semantics.\n\n## Compatibility aliases\n\n`BreadcrumbComponent`, `BreadcrumbItemComponent`, and\n`BreadcrumbSeparatorTemplate` remain deprecated aliases for early alpha\nconsumers. New code must use `NeuralBreadcrumb`,\n`NeuralBreadcrumbItemComponent`, and `NeuralBreadcrumbSeparatorTemplate`.\n\n## Beta boundary\n\nBreadcrumb Beta includes immutable data items, projected items, Router and\nnative links, current/disabled states, selection events, responsive Menu\noverflow, Tooltip delay, icon/template separators, RTL, SSR-safe rendering,\ntyped class slots, and global/local unstyled behavior. Route construction,\napplication history, page titles, and navigation authorization remain\napplication concerns.\n",
    "llms": "NeuralNg Breadcrumb rules\n\n- Import `NeuralBreadcrumb`, `NeuralBreadcrumbItemComponent`, and `NeuralBreadcrumbSeparatorTemplate` only from `@neural-ng/core/breadcrumb`.\n- Add only the canonical runtime symbols used by the template directly to standalone component imports.\n- Never generate deprecated `BreadcrumbComponent`, `BreadcrumbItemComponent`, or `BreadcrumbSeparatorTemplate` aliases in new code.\n- Every item needs a stable `key` and visible `label`.\n- Prefer `routerLink` for Angular routes and `href` for document navigation.\n- The last item is current by default; use `current` only to override it.\n- `maxItems >= 2` collapses middle items into an accessible NeuralNg Menu.\n- `overflowLabel` labels the trigger and provides its hover/focus Tooltip.\n- `overflowTooltipDelay` defaults to `100` milliseconds.\n- Use either `[items]` or `<neural-breadcrumb-item>` children, never both.\n- Customize separators with `separatorIconClass` or\n  `<ng-template neuralBreadcrumbSeparator>`.\n- `itemSelect` emits `{ key, item, originalEvent }`.\n- `unstyled` removes visual classes, not semantics or structural hooks.\n- `routerLink` accepts a string, command array, or UrlTree and composes with `queryParams`, `fragment`, `queryParamsHandling`, `preserveFragment`, `skipLocationChange`, `replaceUrl`, `state`, and `target`.\n- `href` retains native `target` and `rel` behavior.\n- Do not add custom arrow-key handlers; visible items retain native link behavior and overflow delegates to Neural Menu.\n- Current maturity is Beta. Do not invent route construction, history, authorization, page-title, or tooltip APIs.\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/card-body/contract",
      "readme": "neural://components/card-body/readme",
      "llms": "neural://components/card-body/llms"
    },
    "sourceDirectory": "libs/neural-ng/card",
    "readme": "# NeuralNg Card\n\nCard Beta is a composable, headless-capable content container. It uses native\n`article`, `header`, and `footer` elements while keeping visual ownership in CSS\nclasses and design tokens.\n\n## Import\n\n```ts\nimport { NeuralCard, NeuralCardBody, NeuralCardFooter, NeuralCardHeader } from '@neural-ng/core/card';\n```\n\n## Basic composition\n\n```html\n<neural-card ariaLabelledby=\"profile-card-title\">\n  <neural-card-header>\n    <h2 id=\"profile-card-title\">Profile</h2>\n  </neural-card-header>\n\n  <neural-card-body>\n    <p>Manage the public details shown on your account.</p>\n  </neural-card-body>\n\n  <neural-card-footer>\n    <neural-button>Save</neural-button>\n  </neural-card-footer>\n</neural-card>\n```\n\nThe root renders a native `<article>`. Use `role=\"region\"` only when the card is\nimportant enough to be a named landmark and provide `ariaLabel` or\n`ariaLabelledby`. Ordinary cards normally need no explicit role or accessible\nname.\n\nHeader, body, and footer are independent standalone components. They must be\nplaced inside `neural-card`; omit any section that is not needed. Project real\nheading elements instead of relying on presentational title inputs.\n\n## Inputs\n\n### `neural-card`\n\n| Input            | Type                                         | Default | Purpose                                      |\n| ---------------- | -------------------------------------------- | ------- | -------------------------------------------- |\n| `role`           | `article \\| region \\| group \\| presentation` | `null`  | Optional explicit role on the native article |\n| `ariaLabel`      | `string \\| null`                             | `null`  | Accessible name                              |\n| `ariaLabelledby` | `string \\| null`                             | `null`  | ID reference for the accessible name         |\n| `cardClass`      | `string`                                     | `''`    | Class applied to the native article          |\n| `classes`        | `NeuralCardClasses`                          | `{}`    | Typed root/header/body/footer class slots    |\n| `unstyled`       | `boolean`                                    | `false` | Remove NeuralNg visual classes               |\n\nSection components accept `headerClass`, `bodyClass`, and `footerClass`\nrespectively. Local section classes are additive to the matching `classes`\nslot.\n\n## Headless usage\n\n```html\n<neural-card\n  unstyled\n  cardClass=\"rounded-xl border border-slate-700 bg-slate-950\"\n  [classes]=\"{\n    header: 'p-5 border-b border-slate-700',\n    body: 'p-5 text-slate-300',\n    footer: 'flex gap-3 p-5'\n  }\"\n>\n  <neural-card-header><h2>Custom card</h2></neural-card-header>\n  <neural-card-body>Owned entirely by consumer classes.</neural-card-body>\n</neural-card>\n```\n\n`unstyled` removes only `*-base` visual classes. Structural hooks, projected\ncontent, native semantics, ARIA attributes, and consumer classes remain.\n`provideNeuralNg({ unstyled: true })` enables the same behavior globally.\n\n## Design tokens\n\nThe stable neutral theme defines `--neural-card-*` tokens for background,\nborder, radius, shadow, typography, section padding, alignment, gaps, and\noptional section borders. Glass, Mist, and Futuristic override only token values.\nConsumers can override tokens on any ancestor or use `unstyled` for full class\nownership.\n\nCard contains no browser-only APIs and is safe for SSR and hydration.\n\n## Compatibility aliases\n\n`CardComponent`, `CardHeaderComponent`, `CardBodyComponent`, and\n`CardFooterComponent` remain deprecated compatibility aliases. New code and AI\ngenerated code must use the canonical `NeuralCard*` symbols.\n",
    "llms": "# NeuralNg Card Beta\n\nImport Card only from `@neural-ng/core/card`. It is standalone; never create or\nimport an NgModule.\n\n## Rules\n\n- Use `neural-card` as the root.\n- Import `NeuralCard` and compose `NeuralCardHeader`, `NeuralCardBody`, and\n  `NeuralCardFooter` only when those sections are present.\n- Never generate the deprecated `CardComponent`, `CardHeaderComponent`,\n  `CardBodyComponent`, or `CardFooterComponent` aliases.\n- Project native heading elements with stable IDs. Prefer `ariaLabelledby` on\n  the card when it needs an accessible name.\n- The root is a native article. Do not add `role=\"region\"` to every card; use it\n  only for an important named landmark.\n- `cardClass` targets the native article.\n- `classes` is typed with `root`, `header`, `body`, and `footer` slots.\n- Section-level `headerClass`, `bodyClass`, and `footerClass` inputs are additive.\n- `unstyled` removes visual `*-base` classes but retains structural classes,\n  native semantics, ARIA, projection, and consumer classes.\n- Global `provideNeuralNg({ unstyled: true })` also affects Card.\n- Do not assume Neural Icons, Tailwind, or another styling library is installed.\n- Beta boundary: Card owns the semantic surface and section composition. It\n  intentionally has no title, subtitle, media, action, click, or layout API;\n  project real content and interactive components instead.\n\n## Canonical example\n\n```html\n<neural-card ariaLabelledby=\"settings-title\">\n  <neural-card-header>\n    <h2 id=\"settings-title\">Settings</h2>\n  </neural-card-header>\n  <neural-card-body>\n    <p>Update application preferences.</p>\n  </neural-card-body>\n  <neural-card-footer>\n    <neural-button>Save</neural-button>\n  </neural-card-footer>\n</neural-card>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/card-footer/contract",
      "readme": "neural://components/card-footer/readme",
      "llms": "neural://components/card-footer/llms"
    },
    "sourceDirectory": "libs/neural-ng/card",
    "readme": "# NeuralNg Card\n\nCard Beta is a composable, headless-capable content container. It uses native\n`article`, `header`, and `footer` elements while keeping visual ownership in CSS\nclasses and design tokens.\n\n## Import\n\n```ts\nimport { NeuralCard, NeuralCardBody, NeuralCardFooter, NeuralCardHeader } from '@neural-ng/core/card';\n```\n\n## Basic composition\n\n```html\n<neural-card ariaLabelledby=\"profile-card-title\">\n  <neural-card-header>\n    <h2 id=\"profile-card-title\">Profile</h2>\n  </neural-card-header>\n\n  <neural-card-body>\n    <p>Manage the public details shown on your account.</p>\n  </neural-card-body>\n\n  <neural-card-footer>\n    <neural-button>Save</neural-button>\n  </neural-card-footer>\n</neural-card>\n```\n\nThe root renders a native `<article>`. Use `role=\"region\"` only when the card is\nimportant enough to be a named landmark and provide `ariaLabel` or\n`ariaLabelledby`. Ordinary cards normally need no explicit role or accessible\nname.\n\nHeader, body, and footer are independent standalone components. They must be\nplaced inside `neural-card`; omit any section that is not needed. Project real\nheading elements instead of relying on presentational title inputs.\n\n## Inputs\n\n### `neural-card`\n\n| Input            | Type                                         | Default | Purpose                                      |\n| ---------------- | -------------------------------------------- | ------- | -------------------------------------------- |\n| `role`           | `article \\| region \\| group \\| presentation` | `null`  | Optional explicit role on the native article |\n| `ariaLabel`      | `string \\| null`                             | `null`  | Accessible name                              |\n| `ariaLabelledby` | `string \\| null`                             | `null`  | ID reference for the accessible name         |\n| `cardClass`      | `string`                                     | `''`    | Class applied to the native article          |\n| `classes`        | `NeuralCardClasses`                          | `{}`    | Typed root/header/body/footer class slots    |\n| `unstyled`       | `boolean`                                    | `false` | Remove NeuralNg visual classes               |\n\nSection components accept `headerClass`, `bodyClass`, and `footerClass`\nrespectively. Local section classes are additive to the matching `classes`\nslot.\n\n## Headless usage\n\n```html\n<neural-card\n  unstyled\n  cardClass=\"rounded-xl border border-slate-700 bg-slate-950\"\n  [classes]=\"{\n    header: 'p-5 border-b border-slate-700',\n    body: 'p-5 text-slate-300',\n    footer: 'flex gap-3 p-5'\n  }\"\n>\n  <neural-card-header><h2>Custom card</h2></neural-card-header>\n  <neural-card-body>Owned entirely by consumer classes.</neural-card-body>\n</neural-card>\n```\n\n`unstyled` removes only `*-base` visual classes. Structural hooks, projected\ncontent, native semantics, ARIA attributes, and consumer classes remain.\n`provideNeuralNg({ unstyled: true })` enables the same behavior globally.\n\n## Design tokens\n\nThe stable neutral theme defines `--neural-card-*` tokens for background,\nborder, radius, shadow, typography, section padding, alignment, gaps, and\noptional section borders. Glass, Mist, and Futuristic override only token values.\nConsumers can override tokens on any ancestor or use `unstyled` for full class\nownership.\n\nCard contains no browser-only APIs and is safe for SSR and hydration.\n\n## Compatibility aliases\n\n`CardComponent`, `CardHeaderComponent`, `CardBodyComponent`, and\n`CardFooterComponent` remain deprecated compatibility aliases. New code and AI\ngenerated code must use the canonical `NeuralCard*` symbols.\n",
    "llms": "# NeuralNg Card Beta\n\nImport Card only from `@neural-ng/core/card`. It is standalone; never create or\nimport an NgModule.\n\n## Rules\n\n- Use `neural-card` as the root.\n- Import `NeuralCard` and compose `NeuralCardHeader`, `NeuralCardBody`, and\n  `NeuralCardFooter` only when those sections are present.\n- Never generate the deprecated `CardComponent`, `CardHeaderComponent`,\n  `CardBodyComponent`, or `CardFooterComponent` aliases.\n- Project native heading elements with stable IDs. Prefer `ariaLabelledby` on\n  the card when it needs an accessible name.\n- The root is a native article. Do not add `role=\"region\"` to every card; use it\n  only for an important named landmark.\n- `cardClass` targets the native article.\n- `classes` is typed with `root`, `header`, `body`, and `footer` slots.\n- Section-level `headerClass`, `bodyClass`, and `footerClass` inputs are additive.\n- `unstyled` removes visual `*-base` classes but retains structural classes,\n  native semantics, ARIA, projection, and consumer classes.\n- Global `provideNeuralNg({ unstyled: true })` also affects Card.\n- Do not assume Neural Icons, Tailwind, or another styling library is installed.\n- Beta boundary: Card owns the semantic surface and section composition. It\n  intentionally has no title, subtitle, media, action, click, or layout API;\n  project real content and interactive components instead.\n\n## Canonical example\n\n```html\n<neural-card ariaLabelledby=\"settings-title\">\n  <neural-card-header>\n    <h2 id=\"settings-title\">Settings</h2>\n  </neural-card-header>\n  <neural-card-body>\n    <p>Update application preferences.</p>\n  </neural-card-body>\n  <neural-card-footer>\n    <neural-button>Save</neural-button>\n  </neural-card-footer>\n</neural-card>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/card-header/contract",
      "readme": "neural://components/card-header/readme",
      "llms": "neural://components/card-header/llms"
    },
    "sourceDirectory": "libs/neural-ng/card",
    "readme": "# NeuralNg Card\n\nCard Beta is a composable, headless-capable content container. It uses native\n`article`, `header`, and `footer` elements while keeping visual ownership in CSS\nclasses and design tokens.\n\n## Import\n\n```ts\nimport { NeuralCard, NeuralCardBody, NeuralCardFooter, NeuralCardHeader } from '@neural-ng/core/card';\n```\n\n## Basic composition\n\n```html\n<neural-card ariaLabelledby=\"profile-card-title\">\n  <neural-card-header>\n    <h2 id=\"profile-card-title\">Profile</h2>\n  </neural-card-header>\n\n  <neural-card-body>\n    <p>Manage the public details shown on your account.</p>\n  </neural-card-body>\n\n  <neural-card-footer>\n    <neural-button>Save</neural-button>\n  </neural-card-footer>\n</neural-card>\n```\n\nThe root renders a native `<article>`. Use `role=\"region\"` only when the card is\nimportant enough to be a named landmark and provide `ariaLabel` or\n`ariaLabelledby`. Ordinary cards normally need no explicit role or accessible\nname.\n\nHeader, body, and footer are independent standalone components. They must be\nplaced inside `neural-card`; omit any section that is not needed. Project real\nheading elements instead of relying on presentational title inputs.\n\n## Inputs\n\n### `neural-card`\n\n| Input            | Type                                         | Default | Purpose                                      |\n| ---------------- | -------------------------------------------- | ------- | -------------------------------------------- |\n| `role`           | `article \\| region \\| group \\| presentation` | `null`  | Optional explicit role on the native article |\n| `ariaLabel`      | `string \\| null`                             | `null`  | Accessible name                              |\n| `ariaLabelledby` | `string \\| null`                             | `null`  | ID reference for the accessible name         |\n| `cardClass`      | `string`                                     | `''`    | Class applied to the native article          |\n| `classes`        | `NeuralCardClasses`                          | `{}`    | Typed root/header/body/footer class slots    |\n| `unstyled`       | `boolean`                                    | `false` | Remove NeuralNg visual classes               |\n\nSection components accept `headerClass`, `bodyClass`, and `footerClass`\nrespectively. Local section classes are additive to the matching `classes`\nslot.\n\n## Headless usage\n\n```html\n<neural-card\n  unstyled\n  cardClass=\"rounded-xl border border-slate-700 bg-slate-950\"\n  [classes]=\"{\n    header: 'p-5 border-b border-slate-700',\n    body: 'p-5 text-slate-300',\n    footer: 'flex gap-3 p-5'\n  }\"\n>\n  <neural-card-header><h2>Custom card</h2></neural-card-header>\n  <neural-card-body>Owned entirely by consumer classes.</neural-card-body>\n</neural-card>\n```\n\n`unstyled` removes only `*-base` visual classes. Structural hooks, projected\ncontent, native semantics, ARIA attributes, and consumer classes remain.\n`provideNeuralNg({ unstyled: true })` enables the same behavior globally.\n\n## Design tokens\n\nThe stable neutral theme defines `--neural-card-*` tokens for background,\nborder, radius, shadow, typography, section padding, alignment, gaps, and\noptional section borders. Glass, Mist, and Futuristic override only token values.\nConsumers can override tokens on any ancestor or use `unstyled` for full class\nownership.\n\nCard contains no browser-only APIs and is safe for SSR and hydration.\n\n## Compatibility aliases\n\n`CardComponent`, `CardHeaderComponent`, `CardBodyComponent`, and\n`CardFooterComponent` remain deprecated compatibility aliases. New code and AI\ngenerated code must use the canonical `NeuralCard*` symbols.\n",
    "llms": "# NeuralNg Card Beta\n\nImport Card only from `@neural-ng/core/card`. It is standalone; never create or\nimport an NgModule.\n\n## Rules\n\n- Use `neural-card` as the root.\n- Import `NeuralCard` and compose `NeuralCardHeader`, `NeuralCardBody`, and\n  `NeuralCardFooter` only when those sections are present.\n- Never generate the deprecated `CardComponent`, `CardHeaderComponent`,\n  `CardBodyComponent`, or `CardFooterComponent` aliases.\n- Project native heading elements with stable IDs. Prefer `ariaLabelledby` on\n  the card when it needs an accessible name.\n- The root is a native article. Do not add `role=\"region\"` to every card; use it\n  only for an important named landmark.\n- `cardClass` targets the native article.\n- `classes` is typed with `root`, `header`, `body`, and `footer` slots.\n- Section-level `headerClass`, `bodyClass`, and `footerClass` inputs are additive.\n- `unstyled` removes visual `*-base` classes but retains structural classes,\n  native semantics, ARIA, projection, and consumer classes.\n- Global `provideNeuralNg({ unstyled: true })` also affects Card.\n- Do not assume Neural Icons, Tailwind, or another styling library is installed.\n- Beta boundary: Card owns the semantic surface and section composition. It\n  intentionally has no title, subtitle, media, action, click, or layout API;\n  project real content and interactive components instead.\n\n## Canonical example\n\n```html\n<neural-card ariaLabelledby=\"settings-title\">\n  <neural-card-header>\n    <h2 id=\"settings-title\">Settings</h2>\n  </neural-card-header>\n  <neural-card-body>\n    <p>Update application preferences.</p>\n  </neural-card-body>\n  <neural-card-footer>\n    <neural-button>Save</neural-button>\n  </neural-card-footer>\n</neural-card>\n```\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-button-group/contract",
      "readme": "neural://components/neural-button-group/readme",
      "llms": "neural://components/neural-button-group/llms"
    },
    "sourceDirectory": "libs/neural-ng/button",
    "readme": "# NeuralNg Button\n\n`NeuralButton` is a standalone, signal-based Angular 22+ component available\nfrom the `@neural-ng/core/button` secondary entry point. It renders a native\n`<button>` and supports themed, class-driven, and headless usage.\n\n## Setup\n\nInstall the package:\n\n```sh\nnpm install @neural-ng/core\n```\n\nImport the neutral reference theme once in the application's global stylesheet:\n\n```css\n@import '@neural-ng/core/themes/neutral.css';\n```\n\nImport the standalone component directly:\n\n```ts\nimport { Component } from '@angular/core';\nimport { NeuralButton, NeuralButtonGroup } from '@neural-ng/core/button';\n\n@Component({\n  standalone: true,\n  imports: [NeuralButton, NeuralButtonGroup],\n  template: ` <neural-button label=\"Save\" icon=\"nt nt-check\" (clicked)=\"save($event)\" /> `,\n})\nexport class SaveActionComponent {\n  save(event: MouseEvent): void {\n    console.log(event);\n  }\n}\n```\n\n### Experimental Themes\n\nGlass, Mist, and Futuristic are optional token-only presets. Import the desired\nstylesheets after the neutral theme and activate it on an application or subtree:\n\n```css\n@import '@neural-ng/core/themes/neutral.css';\n@import '@neural-ng/core/themes/experimental/glass.css';\n@import '@neural-ng/core/themes/experimental/mist.css';\n@import '@neural-ng/core/themes/experimental/futuristic.css';\n```\n\n```html\n<main data-neural-theme=\"glass\">\n  <neural-button>Glass button</neural-button>\n</main>\n\n<section data-neural-theme=\"mist\">\n  <neural-button>Mist button</neural-button>\n</section>\n\n<section data-neural-theme=\"futuristic\">\n  <neural-button>Futuristic button</neural-button>\n</section>\n```\n\nThese stylesheets define `--neural-button-*` values only. They do not add\ncomponent selectors, markup assumptions, or utility classes. Their values are\nexperimental and may change before a stable release.\n\nAll included themes support `data-neural-mode=\"light|dark\"`. Color mode is\nindependent from `data-neural-theme`; use the optional\n`@neural-ng/core/color-mode` controller or manage the namespaced attribute in\nthe application.\n\n## Public API\n\n### Inputs\n\n| Input              | Type                                     | Default     | Description                                                                        |\n| ------------------ | ---------------------------------------- | ----------- | ---------------------------------------------------------------------------------- |\n| `type`             | `'button' \\| 'submit' \\| 'reset'`        | `'button'`  | Native button type.                                                                |\n| `severity`         | `NeuralButtonSeverity`                   | `'neutral'` | Semantic intent: primary, secondary, neutral, info, success, warning, or error.    |\n| `disabled`         | `boolean`                                | `false`     | Applies native disabled semantics.                                                 |\n| `loading`          | `boolean`                                | `false`     | Prevents activation while keeping the button focusable.                            |\n| `loadingLabel`     | `string`                                 | `'Loading'` | Visible content and accessible name used while loading.                            |\n| `ariaLabel`        | `string \\| null`                         | `null`      | Accessible name for icon-only buttons. Prefer visible text when possible.          |\n| `ariaExpanded`     | `'true' \\| 'false' \\| null`              | `null`      | Disclosure state forwarded to the native button.                                   |\n| `ariaControls`     | `string \\| null`                         | `null`      | ID of the disclosure surface controlled by the button.                             |\n| `ariaKeyShortcuts` | `string \\| null`                         | `null`      | Keyboard shortcuts exposed by a composite control.                                 |\n| `title`            | `string`                                 | `''`        | Optional native title, normally supplementary to `ariaLabel`.                      |\n| `label`            | `string \\| null`                         | `null`      | Visible text. Supports literal and property binding; projection is the fallback.   |\n| `icon`             | `string \\| null`                         | `null`      | Icon class string, for example `nt nt-check`.                                      |\n| `iconPosition`     | `'start' \\| 'end'`                       | `'start'`   | Logical icon position around the label.                                            |\n| `size`             | `'small' \\| 'medium' \\| 'large'`         | `'medium'`  | Preset Button size.                                                                |\n| `iconSize`         | `'small' \\| 'medium' \\| 'large' \\| null` | `null`      | Icon size override. `null` follows the Button `size`.                              |\n| `outlined`         | `boolean`                                | `false`     | Uses a transparent, bordered treatment.                                            |\n| `raised`           | `boolean`                                | `false`     | Adds elevation and composes with solid, outlined, or text treatments.              |\n| `text`             | `boolean`                                | `false`     | Uses a transparent, borderless treatment.                                          |\n| `rounded`          | `boolean`                                | `false`     | Uses the pill-shaped Button radius.                                                |\n| `badge`            | `string \\| number \\| null`               | `null`      | Composes a Badge before or after the projected content.                            |\n| `badgePosition`    | `NeuralButtonBadgePosition`              | `'end'`     | Inline or logical-corner Badge position.                                           |\n| `badgeSeverity`    | `NeuralBadgeSeverity`                    | `'neutral'` | Badge semantic style.                                                              |\n| `badgeSize`        | `NeuralBadgeSize`                        | `'small'`   | Badge size.                                                                        |\n| `badgeMax`         | `number \\| null`                         | `null`      | Numeric visual cap; the real value remains accessible.                             |\n| `badgeAriaLabel`   | `string \\| null`                         | `null`      | Optional explicit accessible label forwarded to Badge.                             |\n| `badgeClass`       | `string`                                 | `''`        | Consumer classes applied to the Badge root.                                        |\n| `buttonClass`      | `string`                                 | `''`        | Classes applied to the inner native `<button>`.                                    |\n| `unstyled`         | `boolean`                                | `false`     | Removes the visual component class while retaining behavior and minimal structure. |\n\n### Outputs\n\n| Output          | Payload         | Description                                                   |\n| --------------- | --------------- | ------------------------------------------------------------- |\n| `clicked`       | `MouseEvent`    | Emits on activation unless the button is disabled or loading. |\n| `keyDown`       | `KeyboardEvent` | Native keyboard stream for composite-control integrations.    |\n| `pointerDown`   | `PointerEvent`  | Native pointer start for drag/resize integrations.            |\n| `pointerMove`   | `PointerEvent`  | Native pointer movement for composite controls.               |\n| `pointerUp`     | `PointerEvent`  | Native completed pointer interaction.                         |\n| `pointerCancel` | `PointerEvent`  | Native cancelled pointer interaction.                         |\n\n## Loading\n\n```html\n<neural-button [loading]=\"isSaving()\" loadingLabel=\"Saving\" (clicked)=\"save()\"> Save changes </neural-button>\n```\n\nWhile loading, the normal content is replaced by the spinner and\n`loadingLabel`. The native button remains in the keyboard focus order and has\n`aria-busy=\"true\"` and `aria-disabled=\"true\"`. Click and form submission are\nprevented until loading finishes.\n\n## Label, Icon, and Size\n\nLiteral attributes and Angular bindings use the same typed inputs:\n\n```html\n<neural-button label=\"Create project\" icon=\"nt nt-plus\" severity=\"primary\" />\n<neural-button [label]=\"submitLabel()\" [icon]=\"submitIcon()\" />\n<neural-button label=\"Continue\" icon=\"nt nt-arrow-right\" iconPosition=\"end\" />\n\n<neural-button label=\"Small\" size=\"small\" />\n<neural-button label=\"Default\" size=\"medium\" />\n<neural-button label=\"Large\" size=\"large\" />\n<neural-button label=\"Compact action\" icon=\"nt nt-check\" iconSize=\"small\" />\n```\n\nProjected content remains supported for rich labels. When `label` is present,\nit is the visible label and replaces projected content. `start` and `end` are\nlogical positions, so icon order follows the document direction.\n\nWhen `icon` is present and neither `label` nor projected content is supplied,\nthe styled Button automatically uses equal inline and block dimensions. Small,\nmedium, and large default to 2rem, 2.5rem, and 3rem. Customize them with\n`--neural-button-small-icon-only-size`, `--neural-button-icon-only-size`, and\n`--neural-button-large-icon-only-size`.\n\n`iconSize` controls only the icon glyph and accepts `small`, `medium`, or\n`large`. When omitted, it follows `size`; it never changes the Button's hit\ntarget or padding.\n\n## Visual Variants\n\n```html\n<neural-button severity=\"primary\" outlined>Outlined</neural-button>\n<neural-button severity=\"primary\" raised>Raised</neural-button>\n<neural-button severity=\"primary\" text>Text</neural-button>\n<neural-button severity=\"primary\" text raised>Text raised</neural-button>\n<neural-button severity=\"primary\" rounded>Rounded</neural-button>\n```\n\n`raised` and `rounded` are composable modifiers. `text` and `outlined` are\nalternative treatments; if both are supplied, `text` takes precedence.\n\n## Button Group\n\nImport and add `NeuralButtonGroup` beside `NeuralButton`, then project Buttons:\n\n```html\n<neural-button-group ariaLabel=\"Text alignment\">\n  <neural-button icon=\"nt nt-align-left\" ariaLabel=\"Align left\" />\n  <neural-button icon=\"nt nt-align-center\" ariaLabel=\"Align center\" />\n  <neural-button icon=\"nt nt-align-right\" ariaLabel=\"Align right\" />\n</neural-button-group>\n```\n\nThe group renders `role=\"group\"`, uses logical CSS for RTL, and merges adjacent\nborders and radii. Set `orientation=\"vertical\"` for a vertical group. Group\ninputs are `orientation`, `ariaLabel`, `groupClass`, and `unstyled`. Global\nunstyled configuration removes the visual grouping layer while preserving the\nsemantic group.\n\n## Badge\n\n```html\n<neural-button [badge]=\"128\" [badgeMax]=\"99\" badgePosition=\"start\" badgeSeverity=\"info\"> Inbox </neural-button>\n```\n\nButton delegates to the general `NeuralBadgeDirective`; it does not duplicate Badge\nstyling or accessibility behavior. `start` and `end` are logical positions.\nZero is a visible value. Normal content and its Badge are both replaced by\nloading feedback while `loading` is true. Button-level or global `unstyled`\nmode also removes the nested Badge visual layer.\n\nNotification-style corner positions are also available:\n\n```html\n<neural-button ariaLabel=\"Notifications, 8 unread\" [badge]=\"8\" badgePosition=\"top-end\" badgeSeverity=\"error\">\n  <i class=\"nt nt-bell\" aria-hidden=\"true\"></i>\n</neural-button>\n```\n\nValid positions are `start`, `end`, `top-start`, `top-end`, `bottom-start`,\nand `bottom-end`. Corner positions are absolute and do not change the button's\nlayout. For icon-only buttons, include meaningful Badge state in `ariaLabel`\nwhen that state must be announced.\n\n## Icon-only Button\n\n```html\n<neural-button icon=\"nt nt-x\" ariaLabel=\"Close dialog\" (clicked)=\"close()\" />\n```\n\n## Native Form Semantics\n\nThe default type is `button` to prevent accidental form submission. Set the\nnative type explicitly when needed:\n\n```html\n<form (submit)=\"submit($event)\">\n  <neural-button type=\"submit\">Submit</neural-button>\n</form>\n```\n\n## Styling Contract\n\nButton styling follows four layers:\n\n1. `.neural-btn-root` provides minimal structural layout and is always present.\n2. `.neural-btn-base` consumes Button design tokens and is removed by `unstyled`.\n3. Themes define `--neural-button-*` custom properties on `:root` or a theme scope.\n4. `buttonClass` applies consumer classes to the native button.\n\nInternal selectors use zero-specificity `:where()` rules, allowing ordinary CSS\nand utility classes to override NeuralNg without `!important`.\n\n```html\n<neural-button buttonClass=\"w-full rounded-xl\"> Continue </neural-button>\n\n<neural-button [unstyled]=\"true\" buttonClass=\"my-completely-custom-button\"> Fully custom </neural-button>\n```\n\nThe standard `class` attribute styles the `<neural-button>` host. Use\n`buttonClass` to style the inner native button.\n\nUse `provideNeuralNg({ unstyled: true })` from `@neural-ng/core` to remove the\nvisual layer application-wide. The local `unstyled` input remains available for\ncomponent-level control.\n\n## Button Tokens\n\n- `--neural-button-background`\n- `--neural-button-background-hover`\n- `--neural-button-background-active`\n- `--neural-button-color`\n- `--neural-button-color-hover`\n- `--neural-button-color-active`\n- `--neural-button-border-width`\n- `--neural-button-border-style`\n- `--neural-button-border-color`\n- `--neural-button-border-color-hover`\n- `--neural-button-border-color-active`\n- `--neural-button-radius`\n- `--neural-button-rounded-radius`\n- `--neural-button-group-radius`\n- `--neural-button-shadow`\n- `--neural-button-shadow-hover`\n- `--neural-button-shadow-active`\n- `--neural-button-raised-shadow`\n- `--neural-button-raised-shadow-hover`\n- `--neural-button-backdrop-filter`\n- `--neural-button-padding`\n- `--neural-button-gap`\n- `--neural-button-font-family`\n- `--neural-button-font-size`\n- `--neural-button-icon-size`\n- `--neural-button-small-padding`\n- `--neural-button-small-font-size`\n- `--neural-button-small-icon-size`\n- `--neural-button-large-padding`\n- `--neural-button-large-font-size`\n- `--neural-button-large-icon-size`\n- `--neural-button-font-weight`\n- `--neural-button-line-height`\n- `--neural-button-transition`\n- `--neural-button-focus-ring`\n- `--neural-button-focus-ring-offset`\n- `--neural-button-disabled-opacity`\n- `--neural-button-badge-overlay-offset`\n- `--neural-button-badge-z-index`\n\n## Accessibility\n\n- Uses a native `<button>` with native Enter and Space activation.\n- Native disabled buttons leave the keyboard focus order.\n- Loading buttons retain focus and expose busy and disabled ARIA states.\n- Visible content supplies the accessible name by default.\n- `ariaLabel` supports icon-only controls.\n- The spinner is hidden from assistive technologies.\n- Styled buttons provide a `:focus-visible` ring; unstyled buttons retain the\n  browser focus outline unless consumer CSS replaces it.\n\n## SSR\n\nButton does not access `window`, `document`, or other browser-only globals. It is\nsafe for Angular server rendering and hydration.\n\n## AI Context\n\nMachine-oriented usage rules are available in [llms.txt](./llms.txt).\n",
    "llms": "# NeuralNg Button\n\n> `NeuralButton` is a standalone Angular 22+ component that renders a native button and is imported only from `@neural-ng/core/button`.\n\nGeneration rules:\n\n- Import `NeuralButton` from `@neural-ng/core/button`.\n- Add `NeuralButton` directly to the consumer component's `imports` array.\n- Do not declare or export it through a consumer NgModule.\n- Render it with `<neural-button>...</neural-button>`.\n- Prefer `label=\"Save\"` for simple text and `[label]=\"saveLabel()\"` for bound text. Project content only when rich markup is required.\n- Prefer `icon=\"nt nt-check\"` over projecting a decorative `<i>` element. `icon` also accepts property binding.\n- Use `iconPosition=\"start|end\"`; these are logical positions and follow RTL.\n- Icon-only styled Buttons are square automatically. Do not add manual width or padding utility classes; always provide `ariaLabel`.\n- Use `size=\"small|medium|large\"`; the default is `medium`.\n- Use `iconSize=\"small|medium|large\"` only to override the glyph size. When omitted, the icon follows the Button `size`; it does not change the hit target.\n- Use `outlined` for the bordered transparent treatment and `text` for the borderless transparent treatment. If both are present, `text` takes precedence.\n- `raised` and `rounded` are composable boolean modifiers. `text raised` is a supported combination.\n- Import `NeuralButtonGroup` from the same entry point and add it to `imports` when generating `<neural-button-group>`.\n- Give Button groups a meaningful `ariaLabel`; use `orientation=\"vertical\"` only for vertical layouts.\n- Button groups preserve `role=\"group\"`, logical RTL borders, and structural hooks in unstyled mode.\n- Listen with `(clicked)`. Never generate `(onNeuralClick)`, `(buttonClick)`, or `(click)` as a replacement for the documented output.\n- Use `type=\"submit\"` only for intentional form submission; the default is `button`.\n- Use `severity` for semantic intent. Accepted values are `primary`, `secondary`, `neutral`, `info`, `success`, `warning`, and `error`.\n- Bind state with `[disabled]` and `[loading]`.\n- Supply a localized `loadingLabel` whenever the application language is not English.\n- Use `ariaLabel` only when projected content does not provide a meaningful visible label.\n- Composite controls may bind `ariaExpanded`, `ariaControls`,\n  `ariaKeyShortcuts`, `keyDown`, and `pointerDown`/`pointerMove`/`pointerUp`/\n  `pointerCancel`. Do not recreate a raw button merely to forward disclosure\n  or pointer state.\n- Use `badge` for a compact contextual value.\n- `badgePosition` accepts `start`, `end`, `top-start`, `top-end`, `bottom-start`, and `bottom-end`.\n- Use logical corner positions for notification Badges on icon-only buttons.\n- When an icon-only Button has meaningful Badge state, include that state in the Button `ariaLabel`.\n- Configure the Badge with `badgeSeverity`, `badgeSize`, `badgeMax`, `badgeAriaLabel`, and `badgeClass`; Button delegates these to the general `NeuralBadgeDirective`.\n- Zero is a valid Badge value. Do not hide it with truthy checks.\n- Do not project a second `<neural-badge>` when the Button Badge inputs are sufficient.\n- Loading replaces both projected content and the composed Badge.\n- Use `buttonClass` for the inner native button. A standard `class` targets the `neural-button` host.\n- Use `[unstyled]=\"true\"` to remove NeuralNg's visual component layer. Do not assume that `buttonClass` disables theme styles.\n- Use `provideNeuralNg({ unstyled: true })` for application-wide unstyled mode.\n- Import `@neural-ng/core/themes/neutral.css` once for the stable reference theme.\n- Use `data-neural-theme` for theme identity and `data-neural-mode=\"light|dark\"` for resolved color mode; they are independent.\n- Treat Glass, Mist, and Futuristic as optional experimental token presets; do not copy their values into component CSS.\n- Do not add manual keyboard handlers, `role=\"button\"`, or `tabindex` because the component uses native button semantics.\n- While loading, the component remains focusable, blocks activation, exposes `aria-busy=\"true\"` and `aria-disabled=\"true\"`, and displays `loadingLabel`.\n- The `clicked` payload is a `MouseEvent` and does not emit while disabled or loading.\n\nCanonical example:\n\n```ts\nimport { Component, signal } from '@angular/core';\nimport { NeuralButton } from '@neural-ng/core/button';\n\n@Component({\n  selector: 'app-save-action',\n  standalone: true,\n  imports: [NeuralButton],\n  template: `\n    <neural-button\n      label=\"Save\"\n      icon=\"nt nt-check\"\n      [loading]=\"isSaving()\"\n      loadingLabel=\"Saving\"\n      buttonClass=\"w-full\"\n      (clicked)=\"save($event)\"\n    />\n  `,\n})\nexport class SaveActionComponent {\n  readonly isSaving = signal(false);\n\n  save(event: MouseEvent): void {\n    console.log(event);\n  }\n}\n```\n\n## Documentation\n\n- [Button README](./README.md): Complete public API and usage guide.\n- [Package README](../README.md): Package setup and entry-point overview.\n- [Neutral theme](../themes/neutral.css): Reference values for every Button token.\n- [Experimental Glass theme](../themes/experimental/glass.css): Optional Glass token preset.\n- [Experimental Mist theme](../themes/experimental/mist.css): Optional calm blur-based token preset.\n- [Experimental Futuristic theme](../themes/experimental/futuristic.css): Optional Futuristic token preset.\n\n## Optional\n\n- [Package AI context](../llms.txt): NeuralNg-wide architecture and component index.\n- [llms.txt specification](https://llmstxt.org/): Format used by this file.\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-dialog-body/contract",
      "readme": "neural://components/neural-dialog-body/readme",
      "llms": "neural://components/neural-dialog-body/llms"
    },
    "sourceDirectory": "libs/neural-ng/dialog",
    "readme": "# NeuralNg Dialog\n\nDialog Beta is the native, Signals-first modal and non-modal composition\nprimitive for Angular 22+.\n\n## Import\n\n```ts\nimport { NeuralDialog, NeuralDialogBody, NeuralDialogFooter, NeuralDialogHeader, NeuralDialogInitialFocus } from '@neural-ng/core/dialog';\n```\n\n## Basic usage\n\n```html\n<neural-button (clicked)=\"accountDialog.show()\">Edit account</neural-button>\n\n<neural-dialog #accountDialog ariaLabelledby=\"account-dialog-title\" ariaDescribedby=\"account-dialog-description\" (closed)=\"lastCloseReason.set($event.reason)\">\n  <neural-dialog-header>\n    <h2 id=\"account-dialog-title\">Edit account</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <p id=\"account-dialog-description\">Update the public account name.</p>\n    <input neuralDialogInitialFocus aria-label=\"Account name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"accountDialog.close()\">Cancel</button>\n    <button type=\"button\" (click)=\"accountDialog.close('api', 'saved')\">Save</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n\n`open` is a model input, so `[(open)]` is also supported. `show()` and\n`close()` are concise imperative conveniences for trigger-driven interfaces.\n\nAll public runtime declarations use canonical `NeuralDialog*` names. The old\n`DialogComponent`, `DialogHeaderComponent`, `DialogBodyComponent`,\n`DialogFooterComponent`, and `DialogInitialFocusDirective` names remain only as\ndeprecated compatibility aliases.\n\n## Inputs and outputs\n\n- `open`: Signal model, default `false`.\n- `modal`: uses native `showModal()` when true and `show()` when false. Default\n  `true`.\n- `closable`: renders the localized close button. Default `true`.\n- `closeOnEscape`: controls Escape dismissal. Default `true`.\n- `dismissibleBackdrop`: controls pointer dismissal outside a modal dialog.\n  Default `true`.\n- `fluid`: expands to the viewport-safe width.\n- `full`: fills the entire dynamic viewport with square, borderless edges.\n- `showFullScreenButton`: renders a localized maximize/minimize toggle directly\n  before the close action. User changes emit `fullChange`.\n- `ariaLabel`, `ariaLabelledby`, `ariaDescribedby`: accessible naming and\n  description.\n- `closeLabel`: overrides the localized common close label.\n- `unstyled`, `dialogClass`, `classes`: visual-class ownership.\n- `opened`: fires after the native dialog opens.\n- `closed`: emits `NeuralDialogClose` with `reason`, `returnValue`, and the\n  originating native event.\n\nClose reasons are `api`, `escape`, `backdrop`, `close-button`, and `native`.\n`native` covers a close initiated directly by native dialog behavior, such as a\nprojected `form method=\"dialog\"`.\n\n## Focus and accessibility\n\nThe component renders a real `<dialog>`. Modal dialogs therefore use the\nbrowser top layer and make the rest of the document inert. Give every dialog an\naccessible name with either `ariaLabel` or `ariaLabelledby`. Add\n`neuralDialogInitialFocus` to the most useful first control. The element that\nopened the dialog is focused again after closing.\n\nEscape is intercepted so a blocked dismissal stays open and every accepted\ndismissal has a deterministic close reason. The component does not install a\nglobal keyboard listener.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural hooks and\nnative behavior. Application-wide headless mode from\n`provideNeuralNg({ unstyled: true })` is also respected.\n\n```ts\nconst classes: NeuralDialogClasses = {\n  root: 'app-dialog',\n  header: 'app-dialog__header',\n  body: 'app-dialog__body',\n  footer: 'app-dialog__footer',\n  closeButton: 'app-dialog__close',\n  closeIcon: 'app-dialog__close-icon',\n};\n```\n\nSection-local `headerClass`, `bodyClass`, and `footerClass` inputs are merged\nafter typed slot classes.\n\n## SSR and hydration\n\nServer rendering outputs a closed native `<dialog>`. `showModal()`, `show()`,\nfocus, and active-element reads run only in the browser. When `open` starts\ntrue, the dialog opens after hydration without requiring browser globals on the\nserver.\n\n## Beta boundary\n\nDialog Beta includes native modal and non-modal behavior, controlled Signals,\ndeterministic close reasons, focus restoration, localized controls, responsive\nfluid sizing, typed class slots, global/local unstyled mode, SSR safety, and\ncomplete theme tokens and an optional full-screen toggle. Confirmation\nworkflows belong to ConfirmDialog; dragging and resizing remain outside this\nbase primitive.\n",
    "llms": "# @neural-ng/core/dialog\n\nImport `NeuralDialog`, `NeuralDialogHeader`, `NeuralDialogBody`,\n`NeuralDialogFooter`, and `NeuralDialogInitialFocus` only from\n`@neural-ng/core/dialog`. Never generate their deprecated `Dialog*` aliases,\nan NgModule, or a div-based replacement.\n\nUse `neural-dialog` with optional `neural-dialog-header`,\n`neural-dialog-body`, and `neural-dialog-footer`. Give every dialog an\naccessible name through `ariaLabelledby` pointing to a real heading, or through\n`ariaLabel`. Prefer `neuralDialogInitialFocus` on the first meaningful\ninteractive control.\n\nBind `[(open)]` for declarative state or call `show()` and `close()` from a\ntemplate reference. The optional `closed` output returns a\n`NeuralDialogClose`; normal open-state binding does not require importing this\ntype. Do not invent `onHide` or `visibleChange` outputs.\n\n`modal`, `closable`, `closeOnEscape`, and `dismissibleBackdrop` default to\ntrue. Do not disable dismissal paths unless the product flow supplies an\nobvious accessible alternative.\n\nUse `fluid` for viewport-safe width and `full` only for a complete\n`100vw × 100dvh` application surface. `full` takes visual precedence over\n`fluid`.\n\nSet `showFullScreenButton` to render the localized maximize/minimize action\nimmediately before close. Observe `fullChange` when application state must\ntrack user toggles. Use `enterFullScreenLabel` and `exitFullScreenLabel` only\nto override locale messages.\n\nFor headless rendering, set `unstyled` and pass typed `classes`. Structural\nclasses remain. Do not assume Neural Icons is installed.\n\nCanonical example:\n\n```html\n<neural-button (clicked)=\"dialog.show()\">Open settings</neural-button>\n<neural-dialog #dialog ariaLabelledby=\"settings-title\">\n  <neural-dialog-header>\n    <h2 id=\"settings-title\">Settings</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <input neuralDialogInitialFocus aria-label=\"Workspace name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"dialog.close()\">Done</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-dialog-footer/contract",
      "readme": "neural://components/neural-dialog-footer/readme",
      "llms": "neural://components/neural-dialog-footer/llms"
    },
    "sourceDirectory": "libs/neural-ng/dialog",
    "readme": "# NeuralNg Dialog\n\nDialog Beta is the native, Signals-first modal and non-modal composition\nprimitive for Angular 22+.\n\n## Import\n\n```ts\nimport { NeuralDialog, NeuralDialogBody, NeuralDialogFooter, NeuralDialogHeader, NeuralDialogInitialFocus } from '@neural-ng/core/dialog';\n```\n\n## Basic usage\n\n```html\n<neural-button (clicked)=\"accountDialog.show()\">Edit account</neural-button>\n\n<neural-dialog #accountDialog ariaLabelledby=\"account-dialog-title\" ariaDescribedby=\"account-dialog-description\" (closed)=\"lastCloseReason.set($event.reason)\">\n  <neural-dialog-header>\n    <h2 id=\"account-dialog-title\">Edit account</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <p id=\"account-dialog-description\">Update the public account name.</p>\n    <input neuralDialogInitialFocus aria-label=\"Account name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"accountDialog.close()\">Cancel</button>\n    <button type=\"button\" (click)=\"accountDialog.close('api', 'saved')\">Save</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n\n`open` is a model input, so `[(open)]` is also supported. `show()` and\n`close()` are concise imperative conveniences for trigger-driven interfaces.\n\nAll public runtime declarations use canonical `NeuralDialog*` names. The old\n`DialogComponent`, `DialogHeaderComponent`, `DialogBodyComponent`,\n`DialogFooterComponent`, and `DialogInitialFocusDirective` names remain only as\ndeprecated compatibility aliases.\n\n## Inputs and outputs\n\n- `open`: Signal model, default `false`.\n- `modal`: uses native `showModal()` when true and `show()` when false. Default\n  `true`.\n- `closable`: renders the localized close button. Default `true`.\n- `closeOnEscape`: controls Escape dismissal. Default `true`.\n- `dismissibleBackdrop`: controls pointer dismissal outside a modal dialog.\n  Default `true`.\n- `fluid`: expands to the viewport-safe width.\n- `full`: fills the entire dynamic viewport with square, borderless edges.\n- `showFullScreenButton`: renders a localized maximize/minimize toggle directly\n  before the close action. User changes emit `fullChange`.\n- `ariaLabel`, `ariaLabelledby`, `ariaDescribedby`: accessible naming and\n  description.\n- `closeLabel`: overrides the localized common close label.\n- `unstyled`, `dialogClass`, `classes`: visual-class ownership.\n- `opened`: fires after the native dialog opens.\n- `closed`: emits `NeuralDialogClose` with `reason`, `returnValue`, and the\n  originating native event.\n\nClose reasons are `api`, `escape`, `backdrop`, `close-button`, and `native`.\n`native` covers a close initiated directly by native dialog behavior, such as a\nprojected `form method=\"dialog\"`.\n\n## Focus and accessibility\n\nThe component renders a real `<dialog>`. Modal dialogs therefore use the\nbrowser top layer and make the rest of the document inert. Give every dialog an\naccessible name with either `ariaLabel` or `ariaLabelledby`. Add\n`neuralDialogInitialFocus` to the most useful first control. The element that\nopened the dialog is focused again after closing.\n\nEscape is intercepted so a blocked dismissal stays open and every accepted\ndismissal has a deterministic close reason. The component does not install a\nglobal keyboard listener.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural hooks and\nnative behavior. Application-wide headless mode from\n`provideNeuralNg({ unstyled: true })` is also respected.\n\n```ts\nconst classes: NeuralDialogClasses = {\n  root: 'app-dialog',\n  header: 'app-dialog__header',\n  body: 'app-dialog__body',\n  footer: 'app-dialog__footer',\n  closeButton: 'app-dialog__close',\n  closeIcon: 'app-dialog__close-icon',\n};\n```\n\nSection-local `headerClass`, `bodyClass`, and `footerClass` inputs are merged\nafter typed slot classes.\n\n## SSR and hydration\n\nServer rendering outputs a closed native `<dialog>`. `showModal()`, `show()`,\nfocus, and active-element reads run only in the browser. When `open` starts\ntrue, the dialog opens after hydration without requiring browser globals on the\nserver.\n\n## Beta boundary\n\nDialog Beta includes native modal and non-modal behavior, controlled Signals,\ndeterministic close reasons, focus restoration, localized controls, responsive\nfluid sizing, typed class slots, global/local unstyled mode, SSR safety, and\ncomplete theme tokens and an optional full-screen toggle. Confirmation\nworkflows belong to ConfirmDialog; dragging and resizing remain outside this\nbase primitive.\n",
    "llms": "# @neural-ng/core/dialog\n\nImport `NeuralDialog`, `NeuralDialogHeader`, `NeuralDialogBody`,\n`NeuralDialogFooter`, and `NeuralDialogInitialFocus` only from\n`@neural-ng/core/dialog`. Never generate their deprecated `Dialog*` aliases,\nan NgModule, or a div-based replacement.\n\nUse `neural-dialog` with optional `neural-dialog-header`,\n`neural-dialog-body`, and `neural-dialog-footer`. Give every dialog an\naccessible name through `ariaLabelledby` pointing to a real heading, or through\n`ariaLabel`. Prefer `neuralDialogInitialFocus` on the first meaningful\ninteractive control.\n\nBind `[(open)]` for declarative state or call `show()` and `close()` from a\ntemplate reference. The optional `closed` output returns a\n`NeuralDialogClose`; normal open-state binding does not require importing this\ntype. Do not invent `onHide` or `visibleChange` outputs.\n\n`modal`, `closable`, `closeOnEscape`, and `dismissibleBackdrop` default to\ntrue. Do not disable dismissal paths unless the product flow supplies an\nobvious accessible alternative.\n\nUse `fluid` for viewport-safe width and `full` only for a complete\n`100vw × 100dvh` application surface. `full` takes visual precedence over\n`fluid`.\n\nSet `showFullScreenButton` to render the localized maximize/minimize action\nimmediately before close. Observe `fullChange` when application state must\ntrack user toggles. Use `enterFullScreenLabel` and `exitFullScreenLabel` only\nto override locale messages.\n\nFor headless rendering, set `unstyled` and pass typed `classes`. Structural\nclasses remain. Do not assume Neural Icons is installed.\n\nCanonical example:\n\n```html\n<neural-button (clicked)=\"dialog.show()\">Open settings</neural-button>\n<neural-dialog #dialog ariaLabelledby=\"settings-title\">\n  <neural-dialog-header>\n    <h2 id=\"settings-title\">Settings</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <input neuralDialogInitialFocus aria-label=\"Workspace name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"dialog.close()\">Done</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-dialog-header/contract",
      "readme": "neural://components/neural-dialog-header/readme",
      "llms": "neural://components/neural-dialog-header/llms"
    },
    "sourceDirectory": "libs/neural-ng/dialog",
    "readme": "# NeuralNg Dialog\n\nDialog Beta is the native, Signals-first modal and non-modal composition\nprimitive for Angular 22+.\n\n## Import\n\n```ts\nimport { NeuralDialog, NeuralDialogBody, NeuralDialogFooter, NeuralDialogHeader, NeuralDialogInitialFocus } from '@neural-ng/core/dialog';\n```\n\n## Basic usage\n\n```html\n<neural-button (clicked)=\"accountDialog.show()\">Edit account</neural-button>\n\n<neural-dialog #accountDialog ariaLabelledby=\"account-dialog-title\" ariaDescribedby=\"account-dialog-description\" (closed)=\"lastCloseReason.set($event.reason)\">\n  <neural-dialog-header>\n    <h2 id=\"account-dialog-title\">Edit account</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <p id=\"account-dialog-description\">Update the public account name.</p>\n    <input neuralDialogInitialFocus aria-label=\"Account name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"accountDialog.close()\">Cancel</button>\n    <button type=\"button\" (click)=\"accountDialog.close('api', 'saved')\">Save</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n\n`open` is a model input, so `[(open)]` is also supported. `show()` and\n`close()` are concise imperative conveniences for trigger-driven interfaces.\n\nAll public runtime declarations use canonical `NeuralDialog*` names. The old\n`DialogComponent`, `DialogHeaderComponent`, `DialogBodyComponent`,\n`DialogFooterComponent`, and `DialogInitialFocusDirective` names remain only as\ndeprecated compatibility aliases.\n\n## Inputs and outputs\n\n- `open`: Signal model, default `false`.\n- `modal`: uses native `showModal()` when true and `show()` when false. Default\n  `true`.\n- `closable`: renders the localized close button. Default `true`.\n- `closeOnEscape`: controls Escape dismissal. Default `true`.\n- `dismissibleBackdrop`: controls pointer dismissal outside a modal dialog.\n  Default `true`.\n- `fluid`: expands to the viewport-safe width.\n- `full`: fills the entire dynamic viewport with square, borderless edges.\n- `showFullScreenButton`: renders a localized maximize/minimize toggle directly\n  before the close action. User changes emit `fullChange`.\n- `ariaLabel`, `ariaLabelledby`, `ariaDescribedby`: accessible naming and\n  description.\n- `closeLabel`: overrides the localized common close label.\n- `unstyled`, `dialogClass`, `classes`: visual-class ownership.\n- `opened`: fires after the native dialog opens.\n- `closed`: emits `NeuralDialogClose` with `reason`, `returnValue`, and the\n  originating native event.\n\nClose reasons are `api`, `escape`, `backdrop`, `close-button`, and `native`.\n`native` covers a close initiated directly by native dialog behavior, such as a\nprojected `form method=\"dialog\"`.\n\n## Focus and accessibility\n\nThe component renders a real `<dialog>`. Modal dialogs therefore use the\nbrowser top layer and make the rest of the document inert. Give every dialog an\naccessible name with either `ariaLabel` or `ariaLabelledby`. Add\n`neuralDialogInitialFocus` to the most useful first control. The element that\nopened the dialog is focused again after closing.\n\nEscape is intercepted so a blocked dismissal stays open and every accepted\ndismissal has a deterministic close reason. The component does not install a\nglobal keyboard listener.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural hooks and\nnative behavior. Application-wide headless mode from\n`provideNeuralNg({ unstyled: true })` is also respected.\n\n```ts\nconst classes: NeuralDialogClasses = {\n  root: 'app-dialog',\n  header: 'app-dialog__header',\n  body: 'app-dialog__body',\n  footer: 'app-dialog__footer',\n  closeButton: 'app-dialog__close',\n  closeIcon: 'app-dialog__close-icon',\n};\n```\n\nSection-local `headerClass`, `bodyClass`, and `footerClass` inputs are merged\nafter typed slot classes.\n\n## SSR and hydration\n\nServer rendering outputs a closed native `<dialog>`. `showModal()`, `show()`,\nfocus, and active-element reads run only in the browser. When `open` starts\ntrue, the dialog opens after hydration without requiring browser globals on the\nserver.\n\n## Beta boundary\n\nDialog Beta includes native modal and non-modal behavior, controlled Signals,\ndeterministic close reasons, focus restoration, localized controls, responsive\nfluid sizing, typed class slots, global/local unstyled mode, SSR safety, and\ncomplete theme tokens and an optional full-screen toggle. Confirmation\nworkflows belong to ConfirmDialog; dragging and resizing remain outside this\nbase primitive.\n",
    "llms": "# @neural-ng/core/dialog\n\nImport `NeuralDialog`, `NeuralDialogHeader`, `NeuralDialogBody`,\n`NeuralDialogFooter`, and `NeuralDialogInitialFocus` only from\n`@neural-ng/core/dialog`. Never generate their deprecated `Dialog*` aliases,\nan NgModule, or a div-based replacement.\n\nUse `neural-dialog` with optional `neural-dialog-header`,\n`neural-dialog-body`, and `neural-dialog-footer`. Give every dialog an\naccessible name through `ariaLabelledby` pointing to a real heading, or through\n`ariaLabel`. Prefer `neuralDialogInitialFocus` on the first meaningful\ninteractive control.\n\nBind `[(open)]` for declarative state or call `show()` and `close()` from a\ntemplate reference. The optional `closed` output returns a\n`NeuralDialogClose`; normal open-state binding does not require importing this\ntype. Do not invent `onHide` or `visibleChange` outputs.\n\n`modal`, `closable`, `closeOnEscape`, and `dismissibleBackdrop` default to\ntrue. Do not disable dismissal paths unless the product flow supplies an\nobvious accessible alternative.\n\nUse `fluid` for viewport-safe width and `full` only for a complete\n`100vw × 100dvh` application surface. `full` takes visual precedence over\n`fluid`.\n\nSet `showFullScreenButton` to render the localized maximize/minimize action\nimmediately before close. Observe `fullChange` when application state must\ntrack user toggles. Use `enterFullScreenLabel` and `exitFullScreenLabel` only\nto override locale messages.\n\nFor headless rendering, set `unstyled` and pass typed `classes`. Structural\nclasses remain. Do not assume Neural Icons is installed.\n\nCanonical example:\n\n```html\n<neural-button (clicked)=\"dialog.show()\">Open settings</neural-button>\n<neural-dialog #dialog ariaLabelledby=\"settings-title\">\n  <neural-dialog-header>\n    <h2 id=\"settings-title\">Settings</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <input neuralDialogInitialFocus aria-label=\"Workspace name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"dialog.close()\">Done</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-dialog-initial-focus/contract",
      "readme": "neural://components/neural-dialog-initial-focus/readme",
      "llms": "neural://components/neural-dialog-initial-focus/llms"
    },
    "sourceDirectory": "libs/neural-ng/dialog",
    "readme": "# NeuralNg Dialog\n\nDialog Beta is the native, Signals-first modal and non-modal composition\nprimitive for Angular 22+.\n\n## Import\n\n```ts\nimport { NeuralDialog, NeuralDialogBody, NeuralDialogFooter, NeuralDialogHeader, NeuralDialogInitialFocus } from '@neural-ng/core/dialog';\n```\n\n## Basic usage\n\n```html\n<neural-button (clicked)=\"accountDialog.show()\">Edit account</neural-button>\n\n<neural-dialog #accountDialog ariaLabelledby=\"account-dialog-title\" ariaDescribedby=\"account-dialog-description\" (closed)=\"lastCloseReason.set($event.reason)\">\n  <neural-dialog-header>\n    <h2 id=\"account-dialog-title\">Edit account</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <p id=\"account-dialog-description\">Update the public account name.</p>\n    <input neuralDialogInitialFocus aria-label=\"Account name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"accountDialog.close()\">Cancel</button>\n    <button type=\"button\" (click)=\"accountDialog.close('api', 'saved')\">Save</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n\n`open` is a model input, so `[(open)]` is also supported. `show()` and\n`close()` are concise imperative conveniences for trigger-driven interfaces.\n\nAll public runtime declarations use canonical `NeuralDialog*` names. The old\n`DialogComponent`, `DialogHeaderComponent`, `DialogBodyComponent`,\n`DialogFooterComponent`, and `DialogInitialFocusDirective` names remain only as\ndeprecated compatibility aliases.\n\n## Inputs and outputs\n\n- `open`: Signal model, default `false`.\n- `modal`: uses native `showModal()` when true and `show()` when false. Default\n  `true`.\n- `closable`: renders the localized close button. Default `true`.\n- `closeOnEscape`: controls Escape dismissal. Default `true`.\n- `dismissibleBackdrop`: controls pointer dismissal outside a modal dialog.\n  Default `true`.\n- `fluid`: expands to the viewport-safe width.\n- `full`: fills the entire dynamic viewport with square, borderless edges.\n- `showFullScreenButton`: renders a localized maximize/minimize toggle directly\n  before the close action. User changes emit `fullChange`.\n- `ariaLabel`, `ariaLabelledby`, `ariaDescribedby`: accessible naming and\n  description.\n- `closeLabel`: overrides the localized common close label.\n- `unstyled`, `dialogClass`, `classes`: visual-class ownership.\n- `opened`: fires after the native dialog opens.\n- `closed`: emits `NeuralDialogClose` with `reason`, `returnValue`, and the\n  originating native event.\n\nClose reasons are `api`, `escape`, `backdrop`, `close-button`, and `native`.\n`native` covers a close initiated directly by native dialog behavior, such as a\nprojected `form method=\"dialog\"`.\n\n## Focus and accessibility\n\nThe component renders a real `<dialog>`. Modal dialogs therefore use the\nbrowser top layer and make the rest of the document inert. Give every dialog an\naccessible name with either `ariaLabel` or `ariaLabelledby`. Add\n`neuralDialogInitialFocus` to the most useful first control. The element that\nopened the dialog is focused again after closing.\n\nEscape is intercepted so a blocked dismissal stays open and every accepted\ndismissal has a deterministic close reason. The component does not install a\nglobal keyboard listener.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural hooks and\nnative behavior. Application-wide headless mode from\n`provideNeuralNg({ unstyled: true })` is also respected.\n\n```ts\nconst classes: NeuralDialogClasses = {\n  root: 'app-dialog',\n  header: 'app-dialog__header',\n  body: 'app-dialog__body',\n  footer: 'app-dialog__footer',\n  closeButton: 'app-dialog__close',\n  closeIcon: 'app-dialog__close-icon',\n};\n```\n\nSection-local `headerClass`, `bodyClass`, and `footerClass` inputs are merged\nafter typed slot classes.\n\n## SSR and hydration\n\nServer rendering outputs a closed native `<dialog>`. `showModal()`, `show()`,\nfocus, and active-element reads run only in the browser. When `open` starts\ntrue, the dialog opens after hydration without requiring browser globals on the\nserver.\n\n## Beta boundary\n\nDialog Beta includes native modal and non-modal behavior, controlled Signals,\ndeterministic close reasons, focus restoration, localized controls, responsive\nfluid sizing, typed class slots, global/local unstyled mode, SSR safety, and\ncomplete theme tokens and an optional full-screen toggle. Confirmation\nworkflows belong to ConfirmDialog; dragging and resizing remain outside this\nbase primitive.\n",
    "llms": "# @neural-ng/core/dialog\n\nImport `NeuralDialog`, `NeuralDialogHeader`, `NeuralDialogBody`,\n`NeuralDialogFooter`, and `NeuralDialogInitialFocus` only from\n`@neural-ng/core/dialog`. Never generate their deprecated `Dialog*` aliases,\nan NgModule, or a div-based replacement.\n\nUse `neural-dialog` with optional `neural-dialog-header`,\n`neural-dialog-body`, and `neural-dialog-footer`. Give every dialog an\naccessible name through `ariaLabelledby` pointing to a real heading, or through\n`ariaLabel`. Prefer `neuralDialogInitialFocus` on the first meaningful\ninteractive control.\n\nBind `[(open)]` for declarative state or call `show()` and `close()` from a\ntemplate reference. The optional `closed` output returns a\n`NeuralDialogClose`; normal open-state binding does not require importing this\ntype. Do not invent `onHide` or `visibleChange` outputs.\n\n`modal`, `closable`, `closeOnEscape`, and `dismissibleBackdrop` default to\ntrue. Do not disable dismissal paths unless the product flow supplies an\nobvious accessible alternative.\n\nUse `fluid` for viewport-safe width and `full` only for a complete\n`100vw × 100dvh` application surface. `full` takes visual precedence over\n`fluid`.\n\nSet `showFullScreenButton` to render the localized maximize/minimize action\nimmediately before close. Observe `fullChange` when application state must\ntrack user toggles. Use `enterFullScreenLabel` and `exitFullScreenLabel` only\nto override locale messages.\n\nFor headless rendering, set `unstyled` and pass typed `classes`. Structural\nclasses remain. Do not assume Neural Icons is installed.\n\nCanonical example:\n\n```html\n<neural-button (clicked)=\"dialog.show()\">Open settings</neural-button>\n<neural-dialog #dialog ariaLabelledby=\"settings-title\">\n  <neural-dialog-header>\n    <h2 id=\"settings-title\">Settings</h2>\n  </neural-dialog-header>\n  <neural-dialog-body>\n    <input neuralDialogInitialFocus aria-label=\"Workspace name\" />\n  </neural-dialog-body>\n  <neural-dialog-footer>\n    <button type=\"button\" (click)=\"dialog.close()\">Done</button>\n  </neural-dialog-footer>\n</neural-dialog>\n```\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/neural-divider/readme",
      "llms": "neural://components/neural-divider/llms"
    },
    "sourceDirectory": "libs/neural-ng/divider",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-drawer/contract",
      "readme": "neural://components/neural-drawer/readme",
      "llms": "neural://components/neural-drawer/llms"
    },
    "sourceDirectory": "libs/neural-ng/drawer",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-drawer-body/contract",
      "readme": "neural://components/neural-drawer-body/readme",
      "llms": "neural://components/neural-drawer-body/llms"
    },
    "sourceDirectory": "libs/neural-ng/drawer",
    "readme": "# Drawer\n\nNative top-layer, Signal-first edge panels for Angular 22+.\n\n```ts\nimport { NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody, NeuralDrawerFooter, NeuralDrawerInitialFocus } from '@neural-ng/core/drawer';\n```\n\n```html\n<neural-drawer #drawer position=\"end\" ariaLabelledby=\"settings-title\">\n  <neural-drawer-header><h2 id=\"settings-title\">Settings</h2></neural-drawer-header>\n  <neural-drawer-body>Content</neural-drawer-body>\n  <neural-drawer-footer>Actions</neural-drawer-footer>\n</neural-drawer>\n```\n\n`position` accepts logical `start`, `end`, `top`, or `bottom`. Start and end\nfollow document direction. `open` is a Signal model; `show()`, `toggle()`, and\n`close()` provide imperative control. Modal drawers use native dialog focus\ncontainment and top-layer behavior.\n\nNon-modal drawers use the browser Popover top layer when available, so they\nremain above application chrome without making the document inert or trapping\nfocus. Browsers without Popover support fall back to native `dialog.show()`.\n\nClose events report `api`, `escape`, `backdrop`, `close-button`, or `native`.\nUse `closeOnEscape` and `dismissibleBackdrop` to control dismissal. The opener\nregains focus after close and `neuralDrawerInitialFocus` selects initial focus.\n\nSet `unstyled` locally or through `provideNeuralNg`. Structural hooks, dialog\nsemantics, focus behavior, and logical placement remain while typed `classes`\nslots own the visual layer.\n\nAll public runtime declarations use canonical `NeuralDrawer*` names. The old\n`DrawerComponent`, section component, and initial-focus directive names remain\nonly as deprecated compatibility aliases.\n",
    "llms": "# NeuralNg Drawer\n\n- Import NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody,\n  NeuralDrawerFooter, and NeuralDrawerInitialFocus from\n  @neural-ng/core/drawer. Never generate their deprecated Drawer* aliases.\n- Use position=\"start|end|top|bottom\". Start/end are logical and RTL-aware.\n- Bind [(open)] or call show(), toggle(), and close().\n- Native dialog provides modal top-layer behavior and focus containment without a global overlay container.\n- Non-modal mode uses the Popover top layer when available, stays above\n  application chrome, and leaves background content interactive.\n- Use ariaLabel or ariaLabelledby. Prefer a visible heading referenced by ariaLabelledby.\n- closeOnEscape and dismissibleBackdrop default to true. closed reports api, escape, backdrop, close-button, or native.\n- neuralDrawerInitialFocus moves initial focus. Focus returns to the opener after close.\n- Header, body, and footer section components keep the body independently scrollable.\n- unstyled removes visual base classes but retains structural hooks, semantics, placement, and behavior.\n- classes provides typed root, header, body, footer, closeButton, and closeIcon slots.\n- The default close icon uses Neural Icons nt nt-x.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-drawer-footer/contract",
      "readme": "neural://components/neural-drawer-footer/readme",
      "llms": "neural://components/neural-drawer-footer/llms"
    },
    "sourceDirectory": "libs/neural-ng/drawer",
    "readme": "# Drawer\n\nNative top-layer, Signal-first edge panels for Angular 22+.\n\n```ts\nimport { NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody, NeuralDrawerFooter, NeuralDrawerInitialFocus } from '@neural-ng/core/drawer';\n```\n\n```html\n<neural-drawer #drawer position=\"end\" ariaLabelledby=\"settings-title\">\n  <neural-drawer-header><h2 id=\"settings-title\">Settings</h2></neural-drawer-header>\n  <neural-drawer-body>Content</neural-drawer-body>\n  <neural-drawer-footer>Actions</neural-drawer-footer>\n</neural-drawer>\n```\n\n`position` accepts logical `start`, `end`, `top`, or `bottom`. Start and end\nfollow document direction. `open` is a Signal model; `show()`, `toggle()`, and\n`close()` provide imperative control. Modal drawers use native dialog focus\ncontainment and top-layer behavior.\n\nNon-modal drawers use the browser Popover top layer when available, so they\nremain above application chrome without making the document inert or trapping\nfocus. Browsers without Popover support fall back to native `dialog.show()`.\n\nClose events report `api`, `escape`, `backdrop`, `close-button`, or `native`.\nUse `closeOnEscape` and `dismissibleBackdrop` to control dismissal. The opener\nregains focus after close and `neuralDrawerInitialFocus` selects initial focus.\n\nSet `unstyled` locally or through `provideNeuralNg`. Structural hooks, dialog\nsemantics, focus behavior, and logical placement remain while typed `classes`\nslots own the visual layer.\n\nAll public runtime declarations use canonical `NeuralDrawer*` names. The old\n`DrawerComponent`, section component, and initial-focus directive names remain\nonly as deprecated compatibility aliases.\n",
    "llms": "# NeuralNg Drawer\n\n- Import NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody,\n  NeuralDrawerFooter, and NeuralDrawerInitialFocus from\n  @neural-ng/core/drawer. Never generate their deprecated Drawer* aliases.\n- Use position=\"start|end|top|bottom\". Start/end are logical and RTL-aware.\n- Bind [(open)] or call show(), toggle(), and close().\n- Native dialog provides modal top-layer behavior and focus containment without a global overlay container.\n- Non-modal mode uses the Popover top layer when available, stays above\n  application chrome, and leaves background content interactive.\n- Use ariaLabel or ariaLabelledby. Prefer a visible heading referenced by ariaLabelledby.\n- closeOnEscape and dismissibleBackdrop default to true. closed reports api, escape, backdrop, close-button, or native.\n- neuralDrawerInitialFocus moves initial focus. Focus returns to the opener after close.\n- Header, body, and footer section components keep the body independently scrollable.\n- unstyled removes visual base classes but retains structural hooks, semantics, placement, and behavior.\n- classes provides typed root, header, body, footer, closeButton, and closeIcon slots.\n- The default close icon uses Neural Icons nt nt-x.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-drawer-header/contract",
      "readme": "neural://components/neural-drawer-header/readme",
      "llms": "neural://components/neural-drawer-header/llms"
    },
    "sourceDirectory": "libs/neural-ng/drawer",
    "readme": "# Drawer\n\nNative top-layer, Signal-first edge panels for Angular 22+.\n\n```ts\nimport { NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody, NeuralDrawerFooter, NeuralDrawerInitialFocus } from '@neural-ng/core/drawer';\n```\n\n```html\n<neural-drawer #drawer position=\"end\" ariaLabelledby=\"settings-title\">\n  <neural-drawer-header><h2 id=\"settings-title\">Settings</h2></neural-drawer-header>\n  <neural-drawer-body>Content</neural-drawer-body>\n  <neural-drawer-footer>Actions</neural-drawer-footer>\n</neural-drawer>\n```\n\n`position` accepts logical `start`, `end`, `top`, or `bottom`. Start and end\nfollow document direction. `open` is a Signal model; `show()`, `toggle()`, and\n`close()` provide imperative control. Modal drawers use native dialog focus\ncontainment and top-layer behavior.\n\nNon-modal drawers use the browser Popover top layer when available, so they\nremain above application chrome without making the document inert or trapping\nfocus. Browsers without Popover support fall back to native `dialog.show()`.\n\nClose events report `api`, `escape`, `backdrop`, `close-button`, or `native`.\nUse `closeOnEscape` and `dismissibleBackdrop` to control dismissal. The opener\nregains focus after close and `neuralDrawerInitialFocus` selects initial focus.\n\nSet `unstyled` locally or through `provideNeuralNg`. Structural hooks, dialog\nsemantics, focus behavior, and logical placement remain while typed `classes`\nslots own the visual layer.\n\nAll public runtime declarations use canonical `NeuralDrawer*` names. The old\n`DrawerComponent`, section component, and initial-focus directive names remain\nonly as deprecated compatibility aliases.\n",
    "llms": "# NeuralNg Drawer\n\n- Import NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody,\n  NeuralDrawerFooter, and NeuralDrawerInitialFocus from\n  @neural-ng/core/drawer. Never generate their deprecated Drawer* aliases.\n- Use position=\"start|end|top|bottom\". Start/end are logical and RTL-aware.\n- Bind [(open)] or call show(), toggle(), and close().\n- Native dialog provides modal top-layer behavior and focus containment without a global overlay container.\n- Non-modal mode uses the Popover top layer when available, stays above\n  application chrome, and leaves background content interactive.\n- Use ariaLabel or ariaLabelledby. Prefer a visible heading referenced by ariaLabelledby.\n- closeOnEscape and dismissibleBackdrop default to true. closed reports api, escape, backdrop, close-button, or native.\n- neuralDrawerInitialFocus moves initial focus. Focus returns to the opener after close.\n- Header, body, and footer section components keep the body independently scrollable.\n- unstyled removes visual base classes but retains structural hooks, semantics, placement, and behavior.\n- classes provides typed root, header, body, footer, closeButton, and closeIcon slots.\n- The default close icon uses Neural Icons nt nt-x.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-drawer-initial-focus/contract",
      "readme": "neural://components/neural-drawer-initial-focus/readme",
      "llms": "neural://components/neural-drawer-initial-focus/llms"
    },
    "sourceDirectory": "libs/neural-ng/drawer",
    "readme": "# Drawer\n\nNative top-layer, Signal-first edge panels for Angular 22+.\n\n```ts\nimport { NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody, NeuralDrawerFooter, NeuralDrawerInitialFocus } from '@neural-ng/core/drawer';\n```\n\n```html\n<neural-drawer #drawer position=\"end\" ariaLabelledby=\"settings-title\">\n  <neural-drawer-header><h2 id=\"settings-title\">Settings</h2></neural-drawer-header>\n  <neural-drawer-body>Content</neural-drawer-body>\n  <neural-drawer-footer>Actions</neural-drawer-footer>\n</neural-drawer>\n```\n\n`position` accepts logical `start`, `end`, `top`, or `bottom`. Start and end\nfollow document direction. `open` is a Signal model; `show()`, `toggle()`, and\n`close()` provide imperative control. Modal drawers use native dialog focus\ncontainment and top-layer behavior.\n\nNon-modal drawers use the browser Popover top layer when available, so they\nremain above application chrome without making the document inert or trapping\nfocus. Browsers without Popover support fall back to native `dialog.show()`.\n\nClose events report `api`, `escape`, `backdrop`, `close-button`, or `native`.\nUse `closeOnEscape` and `dismissibleBackdrop` to control dismissal. The opener\nregains focus after close and `neuralDrawerInitialFocus` selects initial focus.\n\nSet `unstyled` locally or through `provideNeuralNg`. Structural hooks, dialog\nsemantics, focus behavior, and logical placement remain while typed `classes`\nslots own the visual layer.\n\nAll public runtime declarations use canonical `NeuralDrawer*` names. The old\n`DrawerComponent`, section component, and initial-focus directive names remain\nonly as deprecated compatibility aliases.\n",
    "llms": "# NeuralNg Drawer\n\n- Import NeuralDrawer, NeuralDrawerHeader, NeuralDrawerBody,\n  NeuralDrawerFooter, and NeuralDrawerInitialFocus from\n  @neural-ng/core/drawer. Never generate their deprecated Drawer* aliases.\n- Use position=\"start|end|top|bottom\". Start/end are logical and RTL-aware.\n- Bind [(open)] or call show(), toggle(), and close().\n- Native dialog provides modal top-layer behavior and focus containment without a global overlay container.\n- Non-modal mode uses the Popover top layer when available, stays above\n  application chrome, and leaves background content interactive.\n- Use ariaLabel or ariaLabelledby. Prefer a visible heading referenced by ariaLabelledby.\n- closeOnEscape and dismissibleBackdrop default to true. closed reports api, escape, backdrop, close-button, or native.\n- neuralDrawerInitialFocus moves initial focus. Focus returns to the opener after close.\n- Header, body, and footer section components keep the body independently scrollable.\n- unstyled removes visual base classes but retains structural hooks, semantics, placement, and behavior.\n- classes provides typed root, header, body, footer, closeButton, and closeIcon slots.\n- The default close icon uses Neural Icons nt nt-x.\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-field-control/contract",
      "readme": "neural://components/neural-field-control/readme",
      "llms": "neural://components/neural-field-control/llms"
    },
    "sourceDirectory": "libs/neural-ng/field",
    "readme": "# NeuralNg Field\n\nComposable, form-agnostic field accessibility infrastructure for Angular 22+.\n\nCurrent component maturity: **beta**.\n\n## Import\n\n```ts\nimport { NeuralField, NeuralFieldControl, NeuralFieldError, NeuralFieldHint, NeuralFieldLabel } from '@neural-ng/core/field';\n```\n\nImport `NeuralInput` separately when the control uses `neuralInput`.\n\n## Canonical Signal Forms example\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input neuralInput type=\"email\" autocomplete=\"email\" [formField]=\"accountForm.email\" />\n  <small neuralFieldHint>Use your work address.</small>\n\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n  <small neuralFieldError> {{ accountForm.email().errors()[0]?.message }} </small>\n  }\n</neural-field>\n```\n\nField assigns the label's `for`, the control's `id`, and deterministic hint and\nerror IDs from `controlId`. It keeps the control's `aria-describedby` synchronized\nas conditional hint and error content enters or leaves the composition.\n\n`controlId` is required in the beta API. Explicit IDs keep server rendering and\nhydration deterministic and make application markup easy to inspect.\n\n## Responsibility boundary\n\nField handles relationships and presentation state. It does not:\n\n- own the control value;\n- execute validation;\n- choose when errors become visible;\n- translate or invent error messages;\n- replace Angular Signal, Reactive, Template-driven, or native forms.\n\nKeep validation in the form schema. The recommended Signal Forms presentation\nrule is `touched() && invalid()`.\n\n## Native and custom controls\n\n`neuralInput` consumes Field context automatically. Apply\n`neuralFieldControl` when the projected element is another native control or a\ncustom control that accepts the standard attributes:\n\n```html\n<neural-field controlId=\"profile-note\">\n  <label neuralFieldLabel>Profile note</label>\n  <textarea neuralFieldControl></textarea>\n  <small neuralFieldHint>Maximum 500 characters.</small>\n</neural-field>\n```\n\nThe bridge supplies `id`, `aria-describedby`, `aria-invalid`, `aria-busy`,\n`aria-required`, and the native `required`, `disabled`, and `readonly`\nattributes from Field state.\n\n## Multiple descriptions\n\nMore than one hint or error is supported. The first IDs are\n`{controlId}-hint` and `{controlId}-error`; subsequent slots receive stable\nnumeric suffixes. Add application-owned description IDs with `describedBy`:\n\n```html\n<neural-field controlId=\"slug\" describedBy=\"slug-policy\">\n  <!-- field content -->\n</neural-field>\n<p id=\"slug-policy\">Workspace slugs are public.</p>\n```\n\nDuplicates are removed from the resulting `aria-describedby` value.\n\n## Error announcements\n\n`neuralFieldError` defaults to `aria-live=\"polite\"`. Set `live=\"assertive\"` only\nfor feedback that genuinely requires immediate announcement, or `live=\"off\"`\nwhen another application-level notification announces the error.\n\nField does not add `role=\"alert\"` by default.\n\n## State and styling\n\nField exposes state independently through structural classes and data\nattributes:\n\n```text\nneural-field-root\nneural-field--invalid\nneural-field--required\nneural-field--disabled\nneural-field--readonly\nneural-field--pending\n```\n\nSlot hooks remain stable:\n\n```text\nneural-field__label\nneural-field__control\nneural-field__hint\nneural-field__error\n```\n\nUse the normal `class` attribute on `neural-field` and every projected element.\nThere is no class-object input because consumers already own these hosts.\n\n`unstyled` removes Field and participating Input visual classes while preserving\nstructural hooks, state classes, IDs, ARIA, and native behavior. Global\n`provideNeuralNg({ unstyled: true })` is also respected.\n\nReference themes expose `--neural-field-*` tokens for spacing, typography,\nlabel, required marker, hint, error, disabled, and pending presentation.\n\n## Public API\n\n| Input         | Default  | Purpose                                  |\n| ------------- | -------- | ---------------------------------------- |\n| `controlId`   | required | Deterministic control and slot ID prefix |\n| `describedBy` | `''`     | Additional external description IDs      |\n| `invalid`     | `false`  | Expose invalid state and `aria-invalid`  |\n| `required`    | `false`  | Mark and require the projected control   |\n| `disabled`    | `false`  | Disable the projected control            |\n| `readonly`    | `false`  | Make the projected control readonly      |\n| `pending`     | `false`  | Expose pending state and `aria-busy`     |\n| `fluid`       | `false`  | Fill the available width in styled mode  |\n| `unstyled`    | `false`  | Remove participating visual classes      |\n\n`neuralFieldError` additionally accepts `live: 'off' | 'polite' | 'assertive'`.\n\nFloating labels, input groups, automatic error translation, and form-level\nerror summaries are intentionally outside this primitive.\n\nThe former `FieldComponent` and `Field*Directive` runtime names remain as\ndeprecated compatibility aliases. New code and generated output must use the\ncanonical `NeuralField*` names.\n",
    "llms": "# NeuralNg Field\n\n> Accessible Angular 22+ field composition at `@neural-ng/core/field`.\n\n## Rules\n\n- Import `NeuralField`, `NeuralFieldLabel`, `NeuralFieldHint`,\n  `NeuralFieldError`, and `NeuralFieldControl` from\n  `@neural-ng/core/field`. Never generate the deprecated `FieldComponent` or\n  `Field*Directive` aliases.\n- Generate `<neural-field controlId=\"stable-id\">`; `controlId` is required.\n- Use `<label neuralFieldLabel>` for the visible native label.\n- Use `[neuralFieldHint]` for instructions and `[neuralFieldError]` for\n  correction messages.\n- Do not manually add `for`, control `id`, or generated hint/error IDs in a\n  normal Field composition. Field derives them from `controlId`.\n- `neuralInput` consumes Field context automatically.\n- Apply `neuralFieldControl` to another native or compatible custom control.\n- Keep validation rules in the form schema. Field displays state; it does not\n  validate or own values.\n- For Signal Forms, normally bind Field `invalid` to\n  `field().touched() && field().invalid()`.\n- Bind `pending`, `required`, `disabled`, and `readonly` from the same source of\n  truth as the control.\n- Use `describedBy` only for additional description IDs outside Field.\n- `neuralFieldError` uses `aria-live=\"polite\"` by default. Use assertive\n  announcements sparingly.\n- Use native `class` attributes directly. Do not invent `fieldClass`,\n  `labelClass`, `hintClass`, or `errorClass` inputs.\n- `unstyled` removes visual classes but must preserve structural hooks, state\n  classes, native semantics, IDs, and ARIA relationships.\n- Do not add validation logic, translated error maps, floating-label behavior,\n  prefix/suffix controls, or form summaries to this primitive.\n\n## Canonical example\n\n```ts\nimport { FormField, email, form, required } from '@angular/forms/signals';\nimport {\n  NeuralField,\n  NeuralFieldError,\n  NeuralFieldHint,\n  NeuralFieldLabel,\n} from '@neural-ng/core/field';\nimport { NeuralInput } from '@neural-ng/core/input';\n```\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input\n    neuralInput\n    type=\"email\"\n    autocomplete=\"email\"\n    [formField]=\"accountForm.email\"\n  />\n  <small neuralFieldHint>Use your work address.</small>\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n    <small neuralFieldError>\n      {{ accountForm.email().errors()[0]?.message }}\n    </small>\n  }\n</neural-field>\n```\n\nThe rendered input receives `id=\"account-email\"`. The label receives\n`for=\"account-email\"`, the hint receives `id=\"account-email-hint\"`, and the\nconditional error receives `id=\"account-email-error\"`. Field keeps\n`aria-describedby` synchronized.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-field-error/contract",
      "readme": "neural://components/neural-field-error/readme",
      "llms": "neural://components/neural-field-error/llms"
    },
    "sourceDirectory": "libs/neural-ng/field",
    "readme": "# NeuralNg Field\n\nComposable, form-agnostic field accessibility infrastructure for Angular 22+.\n\nCurrent component maturity: **beta**.\n\n## Import\n\n```ts\nimport { NeuralField, NeuralFieldControl, NeuralFieldError, NeuralFieldHint, NeuralFieldLabel } from '@neural-ng/core/field';\n```\n\nImport `NeuralInput` separately when the control uses `neuralInput`.\n\n## Canonical Signal Forms example\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input neuralInput type=\"email\" autocomplete=\"email\" [formField]=\"accountForm.email\" />\n  <small neuralFieldHint>Use your work address.</small>\n\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n  <small neuralFieldError> {{ accountForm.email().errors()[0]?.message }} </small>\n  }\n</neural-field>\n```\n\nField assigns the label's `for`, the control's `id`, and deterministic hint and\nerror IDs from `controlId`. It keeps the control's `aria-describedby` synchronized\nas conditional hint and error content enters or leaves the composition.\n\n`controlId` is required in the beta API. Explicit IDs keep server rendering and\nhydration deterministic and make application markup easy to inspect.\n\n## Responsibility boundary\n\nField handles relationships and presentation state. It does not:\n\n- own the control value;\n- execute validation;\n- choose when errors become visible;\n- translate or invent error messages;\n- replace Angular Signal, Reactive, Template-driven, or native forms.\n\nKeep validation in the form schema. The recommended Signal Forms presentation\nrule is `touched() && invalid()`.\n\n## Native and custom controls\n\n`neuralInput` consumes Field context automatically. Apply\n`neuralFieldControl` when the projected element is another native control or a\ncustom control that accepts the standard attributes:\n\n```html\n<neural-field controlId=\"profile-note\">\n  <label neuralFieldLabel>Profile note</label>\n  <textarea neuralFieldControl></textarea>\n  <small neuralFieldHint>Maximum 500 characters.</small>\n</neural-field>\n```\n\nThe bridge supplies `id`, `aria-describedby`, `aria-invalid`, `aria-busy`,\n`aria-required`, and the native `required`, `disabled`, and `readonly`\nattributes from Field state.\n\n## Multiple descriptions\n\nMore than one hint or error is supported. The first IDs are\n`{controlId}-hint` and `{controlId}-error`; subsequent slots receive stable\nnumeric suffixes. Add application-owned description IDs with `describedBy`:\n\n```html\n<neural-field controlId=\"slug\" describedBy=\"slug-policy\">\n  <!-- field content -->\n</neural-field>\n<p id=\"slug-policy\">Workspace slugs are public.</p>\n```\n\nDuplicates are removed from the resulting `aria-describedby` value.\n\n## Error announcements\n\n`neuralFieldError` defaults to `aria-live=\"polite\"`. Set `live=\"assertive\"` only\nfor feedback that genuinely requires immediate announcement, or `live=\"off\"`\nwhen another application-level notification announces the error.\n\nField does not add `role=\"alert\"` by default.\n\n## State and styling\n\nField exposes state independently through structural classes and data\nattributes:\n\n```text\nneural-field-root\nneural-field--invalid\nneural-field--required\nneural-field--disabled\nneural-field--readonly\nneural-field--pending\n```\n\nSlot hooks remain stable:\n\n```text\nneural-field__label\nneural-field__control\nneural-field__hint\nneural-field__error\n```\n\nUse the normal `class` attribute on `neural-field` and every projected element.\nThere is no class-object input because consumers already own these hosts.\n\n`unstyled` removes Field and participating Input visual classes while preserving\nstructural hooks, state classes, IDs, ARIA, and native behavior. Global\n`provideNeuralNg({ unstyled: true })` is also respected.\n\nReference themes expose `--neural-field-*` tokens for spacing, typography,\nlabel, required marker, hint, error, disabled, and pending presentation.\n\n## Public API\n\n| Input         | Default  | Purpose                                  |\n| ------------- | -------- | ---------------------------------------- |\n| `controlId`   | required | Deterministic control and slot ID prefix |\n| `describedBy` | `''`     | Additional external description IDs      |\n| `invalid`     | `false`  | Expose invalid state and `aria-invalid`  |\n| `required`    | `false`  | Mark and require the projected control   |\n| `disabled`    | `false`  | Disable the projected control            |\n| `readonly`    | `false`  | Make the projected control readonly      |\n| `pending`     | `false`  | Expose pending state and `aria-busy`     |\n| `fluid`       | `false`  | Fill the available width in styled mode  |\n| `unstyled`    | `false`  | Remove participating visual classes      |\n\n`neuralFieldError` additionally accepts `live: 'off' | 'polite' | 'assertive'`.\n\nFloating labels, input groups, automatic error translation, and form-level\nerror summaries are intentionally outside this primitive.\n\nThe former `FieldComponent` and `Field*Directive` runtime names remain as\ndeprecated compatibility aliases. New code and generated output must use the\ncanonical `NeuralField*` names.\n",
    "llms": "# NeuralNg Field\n\n> Accessible Angular 22+ field composition at `@neural-ng/core/field`.\n\n## Rules\n\n- Import `NeuralField`, `NeuralFieldLabel`, `NeuralFieldHint`,\n  `NeuralFieldError`, and `NeuralFieldControl` from\n  `@neural-ng/core/field`. Never generate the deprecated `FieldComponent` or\n  `Field*Directive` aliases.\n- Generate `<neural-field controlId=\"stable-id\">`; `controlId` is required.\n- Use `<label neuralFieldLabel>` for the visible native label.\n- Use `[neuralFieldHint]` for instructions and `[neuralFieldError]` for\n  correction messages.\n- Do not manually add `for`, control `id`, or generated hint/error IDs in a\n  normal Field composition. Field derives them from `controlId`.\n- `neuralInput` consumes Field context automatically.\n- Apply `neuralFieldControl` to another native or compatible custom control.\n- Keep validation rules in the form schema. Field displays state; it does not\n  validate or own values.\n- For Signal Forms, normally bind Field `invalid` to\n  `field().touched() && field().invalid()`.\n- Bind `pending`, `required`, `disabled`, and `readonly` from the same source of\n  truth as the control.\n- Use `describedBy` only for additional description IDs outside Field.\n- `neuralFieldError` uses `aria-live=\"polite\"` by default. Use assertive\n  announcements sparingly.\n- Use native `class` attributes directly. Do not invent `fieldClass`,\n  `labelClass`, `hintClass`, or `errorClass` inputs.\n- `unstyled` removes visual classes but must preserve structural hooks, state\n  classes, native semantics, IDs, and ARIA relationships.\n- Do not add validation logic, translated error maps, floating-label behavior,\n  prefix/suffix controls, or form summaries to this primitive.\n\n## Canonical example\n\n```ts\nimport { FormField, email, form, required } from '@angular/forms/signals';\nimport {\n  NeuralField,\n  NeuralFieldError,\n  NeuralFieldHint,\n  NeuralFieldLabel,\n} from '@neural-ng/core/field';\nimport { NeuralInput } from '@neural-ng/core/input';\n```\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input\n    neuralInput\n    type=\"email\"\n    autocomplete=\"email\"\n    [formField]=\"accountForm.email\"\n  />\n  <small neuralFieldHint>Use your work address.</small>\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n    <small neuralFieldError>\n      {{ accountForm.email().errors()[0]?.message }}\n    </small>\n  }\n</neural-field>\n```\n\nThe rendered input receives `id=\"account-email\"`. The label receives\n`for=\"account-email\"`, the hint receives `id=\"account-email-hint\"`, and the\nconditional error receives `id=\"account-email-error\"`. Field keeps\n`aria-describedby` synchronized.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-field-hint/contract",
      "readme": "neural://components/neural-field-hint/readme",
      "llms": "neural://components/neural-field-hint/llms"
    },
    "sourceDirectory": "libs/neural-ng/field",
    "readme": "# NeuralNg Field\n\nComposable, form-agnostic field accessibility infrastructure for Angular 22+.\n\nCurrent component maturity: **beta**.\n\n## Import\n\n```ts\nimport { NeuralField, NeuralFieldControl, NeuralFieldError, NeuralFieldHint, NeuralFieldLabel } from '@neural-ng/core/field';\n```\n\nImport `NeuralInput` separately when the control uses `neuralInput`.\n\n## Canonical Signal Forms example\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input neuralInput type=\"email\" autocomplete=\"email\" [formField]=\"accountForm.email\" />\n  <small neuralFieldHint>Use your work address.</small>\n\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n  <small neuralFieldError> {{ accountForm.email().errors()[0]?.message }} </small>\n  }\n</neural-field>\n```\n\nField assigns the label's `for`, the control's `id`, and deterministic hint and\nerror IDs from `controlId`. It keeps the control's `aria-describedby` synchronized\nas conditional hint and error content enters or leaves the composition.\n\n`controlId` is required in the beta API. Explicit IDs keep server rendering and\nhydration deterministic and make application markup easy to inspect.\n\n## Responsibility boundary\n\nField handles relationships and presentation state. It does not:\n\n- own the control value;\n- execute validation;\n- choose when errors become visible;\n- translate or invent error messages;\n- replace Angular Signal, Reactive, Template-driven, or native forms.\n\nKeep validation in the form schema. The recommended Signal Forms presentation\nrule is `touched() && invalid()`.\n\n## Native and custom controls\n\n`neuralInput` consumes Field context automatically. Apply\n`neuralFieldControl` when the projected element is another native control or a\ncustom control that accepts the standard attributes:\n\n```html\n<neural-field controlId=\"profile-note\">\n  <label neuralFieldLabel>Profile note</label>\n  <textarea neuralFieldControl></textarea>\n  <small neuralFieldHint>Maximum 500 characters.</small>\n</neural-field>\n```\n\nThe bridge supplies `id`, `aria-describedby`, `aria-invalid`, `aria-busy`,\n`aria-required`, and the native `required`, `disabled`, and `readonly`\nattributes from Field state.\n\n## Multiple descriptions\n\nMore than one hint or error is supported. The first IDs are\n`{controlId}-hint` and `{controlId}-error`; subsequent slots receive stable\nnumeric suffixes. Add application-owned description IDs with `describedBy`:\n\n```html\n<neural-field controlId=\"slug\" describedBy=\"slug-policy\">\n  <!-- field content -->\n</neural-field>\n<p id=\"slug-policy\">Workspace slugs are public.</p>\n```\n\nDuplicates are removed from the resulting `aria-describedby` value.\n\n## Error announcements\n\n`neuralFieldError` defaults to `aria-live=\"polite\"`. Set `live=\"assertive\"` only\nfor feedback that genuinely requires immediate announcement, or `live=\"off\"`\nwhen another application-level notification announces the error.\n\nField does not add `role=\"alert\"` by default.\n\n## State and styling\n\nField exposes state independently through structural classes and data\nattributes:\n\n```text\nneural-field-root\nneural-field--invalid\nneural-field--required\nneural-field--disabled\nneural-field--readonly\nneural-field--pending\n```\n\nSlot hooks remain stable:\n\n```text\nneural-field__label\nneural-field__control\nneural-field__hint\nneural-field__error\n```\n\nUse the normal `class` attribute on `neural-field` and every projected element.\nThere is no class-object input because consumers already own these hosts.\n\n`unstyled` removes Field and participating Input visual classes while preserving\nstructural hooks, state classes, IDs, ARIA, and native behavior. Global\n`provideNeuralNg({ unstyled: true })` is also respected.\n\nReference themes expose `--neural-field-*` tokens for spacing, typography,\nlabel, required marker, hint, error, disabled, and pending presentation.\n\n## Public API\n\n| Input         | Default  | Purpose                                  |\n| ------------- | -------- | ---------------------------------------- |\n| `controlId`   | required | Deterministic control and slot ID prefix |\n| `describedBy` | `''`     | Additional external description IDs      |\n| `invalid`     | `false`  | Expose invalid state and `aria-invalid`  |\n| `required`    | `false`  | Mark and require the projected control   |\n| `disabled`    | `false`  | Disable the projected control            |\n| `readonly`    | `false`  | Make the projected control readonly      |\n| `pending`     | `false`  | Expose pending state and `aria-busy`     |\n| `fluid`       | `false`  | Fill the available width in styled mode  |\n| `unstyled`    | `false`  | Remove participating visual classes      |\n\n`neuralFieldError` additionally accepts `live: 'off' | 'polite' | 'assertive'`.\n\nFloating labels, input groups, automatic error translation, and form-level\nerror summaries are intentionally outside this primitive.\n\nThe former `FieldComponent` and `Field*Directive` runtime names remain as\ndeprecated compatibility aliases. New code and generated output must use the\ncanonical `NeuralField*` names.\n",
    "llms": "# NeuralNg Field\n\n> Accessible Angular 22+ field composition at `@neural-ng/core/field`.\n\n## Rules\n\n- Import `NeuralField`, `NeuralFieldLabel`, `NeuralFieldHint`,\n  `NeuralFieldError`, and `NeuralFieldControl` from\n  `@neural-ng/core/field`. Never generate the deprecated `FieldComponent` or\n  `Field*Directive` aliases.\n- Generate `<neural-field controlId=\"stable-id\">`; `controlId` is required.\n- Use `<label neuralFieldLabel>` for the visible native label.\n- Use `[neuralFieldHint]` for instructions and `[neuralFieldError]` for\n  correction messages.\n- Do not manually add `for`, control `id`, or generated hint/error IDs in a\n  normal Field composition. Field derives them from `controlId`.\n- `neuralInput` consumes Field context automatically.\n- Apply `neuralFieldControl` to another native or compatible custom control.\n- Keep validation rules in the form schema. Field displays state; it does not\n  validate or own values.\n- For Signal Forms, normally bind Field `invalid` to\n  `field().touched() && field().invalid()`.\n- Bind `pending`, `required`, `disabled`, and `readonly` from the same source of\n  truth as the control.\n- Use `describedBy` only for additional description IDs outside Field.\n- `neuralFieldError` uses `aria-live=\"polite\"` by default. Use assertive\n  announcements sparingly.\n- Use native `class` attributes directly. Do not invent `fieldClass`,\n  `labelClass`, `hintClass`, or `errorClass` inputs.\n- `unstyled` removes visual classes but must preserve structural hooks, state\n  classes, native semantics, IDs, and ARIA relationships.\n- Do not add validation logic, translated error maps, floating-label behavior,\n  prefix/suffix controls, or form summaries to this primitive.\n\n## Canonical example\n\n```ts\nimport { FormField, email, form, required } from '@angular/forms/signals';\nimport {\n  NeuralField,\n  NeuralFieldError,\n  NeuralFieldHint,\n  NeuralFieldLabel,\n} from '@neural-ng/core/field';\nimport { NeuralInput } from '@neural-ng/core/input';\n```\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input\n    neuralInput\n    type=\"email\"\n    autocomplete=\"email\"\n    [formField]=\"accountForm.email\"\n  />\n  <small neuralFieldHint>Use your work address.</small>\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n    <small neuralFieldError>\n      {{ accountForm.email().errors()[0]?.message }}\n    </small>\n  }\n</neural-field>\n```\n\nThe rendered input receives `id=\"account-email\"`. The label receives\n`for=\"account-email\"`, the hint receives `id=\"account-email-hint\"`, and the\nconditional error receives `id=\"account-email-error\"`. Field keeps\n`aria-describedby` synchronized.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-field-label/contract",
      "readme": "neural://components/neural-field-label/readme",
      "llms": "neural://components/neural-field-label/llms"
    },
    "sourceDirectory": "libs/neural-ng/field",
    "readme": "# NeuralNg Field\n\nComposable, form-agnostic field accessibility infrastructure for Angular 22+.\n\nCurrent component maturity: **beta**.\n\n## Import\n\n```ts\nimport { NeuralField, NeuralFieldControl, NeuralFieldError, NeuralFieldHint, NeuralFieldLabel } from '@neural-ng/core/field';\n```\n\nImport `NeuralInput` separately when the control uses `neuralInput`.\n\n## Canonical Signal Forms example\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input neuralInput type=\"email\" autocomplete=\"email\" [formField]=\"accountForm.email\" />\n  <small neuralFieldHint>Use your work address.</small>\n\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n  <small neuralFieldError> {{ accountForm.email().errors()[0]?.message }} </small>\n  }\n</neural-field>\n```\n\nField assigns the label's `for`, the control's `id`, and deterministic hint and\nerror IDs from `controlId`. It keeps the control's `aria-describedby` synchronized\nas conditional hint and error content enters or leaves the composition.\n\n`controlId` is required in the beta API. Explicit IDs keep server rendering and\nhydration deterministic and make application markup easy to inspect.\n\n## Responsibility boundary\n\nField handles relationships and presentation state. It does not:\n\n- own the control value;\n- execute validation;\n- choose when errors become visible;\n- translate or invent error messages;\n- replace Angular Signal, Reactive, Template-driven, or native forms.\n\nKeep validation in the form schema. The recommended Signal Forms presentation\nrule is `touched() && invalid()`.\n\n## Native and custom controls\n\n`neuralInput` consumes Field context automatically. Apply\n`neuralFieldControl` when the projected element is another native control or a\ncustom control that accepts the standard attributes:\n\n```html\n<neural-field controlId=\"profile-note\">\n  <label neuralFieldLabel>Profile note</label>\n  <textarea neuralFieldControl></textarea>\n  <small neuralFieldHint>Maximum 500 characters.</small>\n</neural-field>\n```\n\nThe bridge supplies `id`, `aria-describedby`, `aria-invalid`, `aria-busy`,\n`aria-required`, and the native `required`, `disabled`, and `readonly`\nattributes from Field state.\n\n## Multiple descriptions\n\nMore than one hint or error is supported. The first IDs are\n`{controlId}-hint` and `{controlId}-error`; subsequent slots receive stable\nnumeric suffixes. Add application-owned description IDs with `describedBy`:\n\n```html\n<neural-field controlId=\"slug\" describedBy=\"slug-policy\">\n  <!-- field content -->\n</neural-field>\n<p id=\"slug-policy\">Workspace slugs are public.</p>\n```\n\nDuplicates are removed from the resulting `aria-describedby` value.\n\n## Error announcements\n\n`neuralFieldError` defaults to `aria-live=\"polite\"`. Set `live=\"assertive\"` only\nfor feedback that genuinely requires immediate announcement, or `live=\"off\"`\nwhen another application-level notification announces the error.\n\nField does not add `role=\"alert\"` by default.\n\n## State and styling\n\nField exposes state independently through structural classes and data\nattributes:\n\n```text\nneural-field-root\nneural-field--invalid\nneural-field--required\nneural-field--disabled\nneural-field--readonly\nneural-field--pending\n```\n\nSlot hooks remain stable:\n\n```text\nneural-field__label\nneural-field__control\nneural-field__hint\nneural-field__error\n```\n\nUse the normal `class` attribute on `neural-field` and every projected element.\nThere is no class-object input because consumers already own these hosts.\n\n`unstyled` removes Field and participating Input visual classes while preserving\nstructural hooks, state classes, IDs, ARIA, and native behavior. Global\n`provideNeuralNg({ unstyled: true })` is also respected.\n\nReference themes expose `--neural-field-*` tokens for spacing, typography,\nlabel, required marker, hint, error, disabled, and pending presentation.\n\n## Public API\n\n| Input         | Default  | Purpose                                  |\n| ------------- | -------- | ---------------------------------------- |\n| `controlId`   | required | Deterministic control and slot ID prefix |\n| `describedBy` | `''`     | Additional external description IDs      |\n| `invalid`     | `false`  | Expose invalid state and `aria-invalid`  |\n| `required`    | `false`  | Mark and require the projected control   |\n| `disabled`    | `false`  | Disable the projected control            |\n| `readonly`    | `false`  | Make the projected control readonly      |\n| `pending`     | `false`  | Expose pending state and `aria-busy`     |\n| `fluid`       | `false`  | Fill the available width in styled mode  |\n| `unstyled`    | `false`  | Remove participating visual classes      |\n\n`neuralFieldError` additionally accepts `live: 'off' | 'polite' | 'assertive'`.\n\nFloating labels, input groups, automatic error translation, and form-level\nerror summaries are intentionally outside this primitive.\n\nThe former `FieldComponent` and `Field*Directive` runtime names remain as\ndeprecated compatibility aliases. New code and generated output must use the\ncanonical `NeuralField*` names.\n",
    "llms": "# NeuralNg Field\n\n> Accessible Angular 22+ field composition at `@neural-ng/core/field`.\n\n## Rules\n\n- Import `NeuralField`, `NeuralFieldLabel`, `NeuralFieldHint`,\n  `NeuralFieldError`, and `NeuralFieldControl` from\n  `@neural-ng/core/field`. Never generate the deprecated `FieldComponent` or\n  `Field*Directive` aliases.\n- Generate `<neural-field controlId=\"stable-id\">`; `controlId` is required.\n- Use `<label neuralFieldLabel>` for the visible native label.\n- Use `[neuralFieldHint]` for instructions and `[neuralFieldError]` for\n  correction messages.\n- Do not manually add `for`, control `id`, or generated hint/error IDs in a\n  normal Field composition. Field derives them from `controlId`.\n- `neuralInput` consumes Field context automatically.\n- Apply `neuralFieldControl` to another native or compatible custom control.\n- Keep validation rules in the form schema. Field displays state; it does not\n  validate or own values.\n- For Signal Forms, normally bind Field `invalid` to\n  `field().touched() && field().invalid()`.\n- Bind `pending`, `required`, `disabled`, and `readonly` from the same source of\n  truth as the control.\n- Use `describedBy` only for additional description IDs outside Field.\n- `neuralFieldError` uses `aria-live=\"polite\"` by default. Use assertive\n  announcements sparingly.\n- Use native `class` attributes directly. Do not invent `fieldClass`,\n  `labelClass`, `hintClass`, or `errorClass` inputs.\n- `unstyled` removes visual classes but must preserve structural hooks, state\n  classes, native semantics, IDs, and ARIA relationships.\n- Do not add validation logic, translated error maps, floating-label behavior,\n  prefix/suffix controls, or form summaries to this primitive.\n\n## Canonical example\n\n```ts\nimport { FormField, email, form, required } from '@angular/forms/signals';\nimport {\n  NeuralField,\n  NeuralFieldError,\n  NeuralFieldHint,\n  NeuralFieldLabel,\n} from '@neural-ng/core/field';\nimport { NeuralInput } from '@neural-ng/core/input';\n```\n\n```html\n<neural-field\n  controlId=\"account-email\"\n  fluid\n  required\n  [invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n  \"\n  [pending]=\"accountForm.email().pending()\"\n>\n  <label neuralFieldLabel>Email</label>\n  <input\n    neuralInput\n    type=\"email\"\n    autocomplete=\"email\"\n    [formField]=\"accountForm.email\"\n  />\n  <small neuralFieldHint>Use your work address.</small>\n  @if (accountForm.email().touched() && accountForm.email().invalid()) {\n    <small neuralFieldError>\n      {{ accountForm.email().errors()[0]?.message }}\n    </small>\n  }\n</neural-field>\n```\n\nThe rendered input receives `id=\"account-email\"`. The label receives\n`for=\"account-email\"`, the hint receives `id=\"account-email-hint\"`, and the\nconditional error receives `id=\"account-email-error\"`. Field keeps\n`aria-describedby` synchronized.\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/neural-file-upload/readme",
      "llms": "neural://components/neural-file-upload/llms"
    },
    "sourceDirectory": "libs/neural-ng/file-upload",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-input-group/contract",
      "readme": "neural://components/neural-input-group/readme",
      "llms": "neural://components/neural-input-group/llms"
    },
    "sourceDirectory": "libs/neural-ng/input",
    "readme": "# NeuralNg Input\n\nNative, Signal Forms-ready text input enhancement for Angular 22+.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralInput, NeuralInputGroup } from '@neural-ng/core/input';\n```\n\nAdd `NeuralInput` to the consumer component's `imports` array, then apply\n`neuralInput` to a native input:\n\n```html\n<label for=\"email\">Email</label> <input neuralInput id=\"email\" name=\"email\" type=\"email\" autocomplete=\"email\" />\n```\n\nDespite its Angular class name, Input does not render a custom element or an\ninner wrapper. The host remains the real native `<input>`.\n\n## Why a native enhancer\n\nNative input attributes, browser validation, autofill, password managers,\nmobile keyboards, labels, form submission, and accessibility semantics remain\navailable without a forwarding API. Use it with text-like input types such as\n`text`, `email`, `password`, `search`, `tel`, and `url`.\n\nCheckbox, radio, range, color, file, date/time, and numeric controls have\ndifferent interaction and styling contracts and will receive dedicated\nNeuralNg APIs where appropriate.\n\n## Angular Signal Forms\n\nAngular's stable v22 Signal Forms directive binds directly to the native host:\n\n```ts\nimport { FormField, email, form, required } from '@angular/forms/signals';\n\nreadonly model = signal({ email: '' });\nreadonly accountForm = form(this.model, (path) => {\n  required(path.email, { message: 'Email is required.' });\n  email(path.email, { message: 'Enter a valid email address.' });\n});\n```\n\n```html\n<label for=\"account-email\">Email</label>\n<input\n  neuralInput\n  id=\"account-email\"\n  type=\"email\"\n  [formField]=\"accountForm.email\"\n  [attr.aria-invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n      ? 'true'\n      : null\n  \"\n/>\n```\n\nImport `FormField` in the consuming component. NeuralNg does not wrap or\nreimplement it. Because the host is native, Reactive Forms, Template-driven\nForms, and plain HTML forms also keep their normal binding behavior.\n\nSignal Forms exposes field state but does not author the application's error\nannouncement. Bind `aria-invalid` when the field should be presented as\ninvalid, render a correction message, and include that message ID in\n`aria-describedby`.\n\nFor automatic label, hint, error, and state wiring, compose Input inside\n`FieldComponent` from `@neural-ng/core/field`. A Field supplies Input's `id`,\nARIA relationships, state, fluid width, and inherited unstyled mode without\nchanging the native host.\n\n## Template-driven and Reactive Forms\n\nTemplate-driven Forms uses Angular's native input value accessor. Import\n`FormsModule` and bind `ngModel` normally:\n\n```ts\nimport { FormsModule } from '@angular/forms';\nimport { NeuralInput } from '@neural-ng/core/input';\n\n@Component({ imports: [FormsModule, NeuralInput] })\nexport class ProfileForm {\n  displayName = '';\n}\n```\n\n```html\n<input neuralInput name=\"displayName\" [(ngModel)]=\"displayName\" />\n```\n\nReactive Forms works through the same native host and does not require a\nNeuralNg ControlValueAccessor:\n\n```ts\nimport { FormControl, ReactiveFormsModule } from '@angular/forms';\nimport { NeuralInput } from '@neural-ng/core/input';\n\n@Component({ imports: [ReactiveFormsModule, NeuralInput] })\nexport class ProfileForm {\n  readonly displayName = new FormControl('', { nonNullable: true });\n}\n```\n\n```html\n<input neuralInput [formControl]=\"displayName\" />\n```\n\n## Fluid width\n\nThe default width follows native inline sizing. Add `fluid` for full container\nwidth:\n\n```html\n<input neuralInput fluid type=\"search\" />\n```\n\n## Start and end icons\n\nCompose the native input inside `NeuralInputGroup`. Logical start/end positions\nfollow LTR and RTL without changing native Forms, autofill, or accessibility\nbehavior:\n\n```ts\nimport { NeuralInput, NeuralInputGroup } from '@neural-ng/core/input';\n\n@Component({ imports: [NeuralInput, NeuralInputGroup] })\nexport class SearchField {}\n```\n\n```html\n<neural-input-group startIcon=\"nt nt-search\" endIcon=\"nt nt-user\" fluid>\n  <input neuralInput aria-label=\"Search users\" />\n</neural-input-group>\n```\n\nThe decorative icons are hidden from assistive technology. Keep the accessible\nname on the native input. `iconClass` adds a class to both icons;\n`inputGroupClass` targets the group root. Local and global `unstyled` modes\nretain only structural hooks.\n\n## Sizes and variants\n\n`inputSize` changes visual density without consuming the native HTML `size`\nattribute. The native attribute remains available for its standard character\nwidth behavior.\n\n```html\n<input neuralInput inputSize=\"small\" size=\"20\" aria-label=\"Small search\" />\n<input neuralInput inputSize=\"medium\" aria-label=\"Default search\" />\n<input neuralInput inputSize=\"large\" aria-label=\"Large search\" />\n```\n\nThe default `outlined` variant uses the standard bordered surface. Use\n`variant=\"filled\"` for a quieter filled surface:\n\n```html\n<input neuralInput variant=\"filled\" placeholder=\"Filled input\" />\n```\n\n## Accessibility and errors\n\nInput does not invent a label. Use a native `<label for>` or a valid accessible\nname. A placeholder is not a replacement for a label.\n\nConnect instructions and error text with `aria-describedby`. Set\n`aria-invalid=\"true\"` only when the field is actually invalid; this activates\nthe theme's invalid state without replacing the error description:\n\n```html\n<label for=\"username\">Username</label>\n<input neuralInput id=\"username\" aria-invalid=\"true\" aria-describedby=\"username-error\" />\n<small id=\"username-error\">Use at least three characters.</small>\n```\n\n`disabled` and `readonly` remain distinct native states. Use `readonly` when a\nvalue should remain visible and submitted but not editable.\n\n## Classes, tokens, and unstyled mode\n\nThere is no `inputClass` input because the component host is the native input.\nUse Angular's normal class APIs directly:\n\n```html\n<input neuralInput class=\"account-field\" [class.compact]=\"compact()\" />\n```\n\n`unstyled` removes visual `neural-input-base` and fluid classes while retaining\nthe structural `neural-input-root` hook and native behavior. Global\n`provideNeuralNg({ unstyled: true })` is also respected.\n\n```html\n<input neuralInput unstyled class=\"my-complete-input\" />\n```\n\nReference themes expose `--neural-input-*` tokens for dimensions, typography,\nplaceholder, background, border, shadow, hover/focus/invalid/readonly/disabled\nstates, and motion. `prefers-reduced-motion: reduce` makes transitions\neffectively immediate.\n\n## Public API\n\n| Input       | Type                             | Default      | Purpose                                               |\n| ----------- | -------------------------------- | ------------ | ----------------------------------------------------- |\n| `inputSize` | `'small' \\| 'medium' \\| 'large'` | `'medium'`   | Select visual density without hijacking native `size` |\n| `variant`   | `'outlined' \\| 'filled'`         | `'outlined'` | Select the token-driven visual treatment              |\n| `fluid`     | `boolean`                        | `false`      | Use full container width in styled mode               |\n| `unstyled`  | `boolean`                        | `false`      | Remove NeuralNg visual and fluid classes              |\n\nThe exported component instance also provides `focus(options?)` and `select()`\nmethods that delegate to the native input. Native DOM properties and events\nremain available on the element itself.\n\nThe entry point also exports `NeuralInputSize` and `NeuralInputVariant`.\n\n`NeuralInputGroup` exports `startIcon`, `endIcon`, `fluid`, `unstyled`,\n`inputGroupClass`, and `iconClass` inputs. Clear buttons, masks, and password\nvisibility controls remain specialized component responsibilities.\n",
    "llms": "# NeuralNg Input\n\n> Native Angular 22+ text input enhancement at `@neural-ng/core/input`.\n\n## Rules\n\n- Import `NeuralInput` from `@neural-ng/core/input` and add it to standalone\n  component imports.\n- Generate `<input neuralInput>`, not `<neural-input>` and not a wrapper div.\n- Keep native attributes such as `type`, `name`, `autocomplete`, `required`,\n  `disabled`, `readonly`, `minlength`, and `maxlength` on the input.\n- Use Input for text-like types: text, email, password, search, tel, and url.\n- Do not use this primitive to style checkbox, radio, range, color, file,\n  date/time, or numeric interaction models.\n- Use a native `<label for>` or another valid accessible name. Placeholder text\n  is not a label.\n- Associate help and error content through `aria-describedby`.\n- Apply `aria-invalid=\"true\"` only when a validation error exists and provide a\n  human-readable correction message.\n- For Angular Signal Forms, import `FormField` from `@angular/forms/signals`\n  and bind `[formField]` directly to the same native input.\n- For template-driven Forms, import `FormsModule` and use `[(ngModel)]` on the\n  native input. Keep `name` when the input participates in a form.\n- For Reactive Forms, import `ReactiveFormsModule` and use `[formControl]` or\n  `formControlName` directly on the native input.\n- Signal Forms exposes invalid/touched state; explicitly bind `aria-invalid`\n  and connect the rendered error message with `aria-describedby`.\n- When Input is inside `neural-field`, let Field supply its ID, ARIA\n  relationships, state, fluid width, and inherited unstyled mode.\n- Do not create a ControlValueAccessor for this component; its host is already\n  a native form control.\n- Use the normal `class` or `[class.*]` APIs directly. There is no `inputClass`\n  input because no internal input element exists.\n- Use `inputSize=\"small|medium|large\"` for visual sizing. Do not replace the\n  native HTML `size` attribute; both APIs can coexist.\n- Use `variant=\"outlined|filled\"` for the visual treatment. The default is\n  `outlined`.\n- `fluid` applies full width only in styled mode.\n- `unstyled` removes visual and fluid classes while preserving the structural\n  hook and all native behavior.\n- For logical start/end icons, import `NeuralInputGroup` and compose\n  `<neural-input-group startIcon=\"nt nt-search\"><input neuralInput /></neural-input-group>`.\n  Keep the accessible name on the native input; group icons are decorative.\n- Do not invent clear, mask, or password-toggle inputs on this primitive.\n\n## Canonical example\n\n```ts\nimport { FormField, email, form, required } from '@angular/forms/signals';\nimport { NeuralInput } from '@neural-ng/core/input';\n\nreadonly model = signal({ email: '' });\nreadonly accountForm = form(this.model, (path) => {\n  required(path.email, { message: 'Email is required.' });\n  email(path.email, { message: 'Enter a valid email address.' });\n});\n```\n\n```html\n<label for=\"account-email\">Email</label>\n<input\n  neuralInput\n  fluid\n  id=\"account-email\"\n  name=\"email\"\n  type=\"email\"\n  autocomplete=\"email\"\n  [formField]=\"accountForm.email\"\n  [attr.aria-invalid]=\"\n    accountForm.email().touched() && accountForm.email().invalid()\n      ? 'true'\n      : null\n  \"\n/>\n```\n\nThe rendered control is the original native input. Preserve that semantic and\nform behavior when generating surrounding layout or validation UI.\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/neural-input-mask/readme",
      "llms": "neural://components/neural-input-mask/llms"
    },
    "sourceDirectory": "libs/neural-ng/input-mask",
  ...
  },
  {
    ...
    "relatedComponents": [],
    "resources": {
      "contract": "neural://components/neural-input-number/contract",
      "readme": "neural://components/neural-input-number/readme",
      "llms": "neural://components/neural-input-number/llms"
    },
    "sourceDirectory": "libs/neural-ng/input-number",
  ...
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/neural-input-otp/readme",
      "llms": "neural://components/neural-input-otp/llms"
    },
    "sourceDirectory": "libs/neural-ng/input-otp",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-loading-overlay/contract",
      "readme": "neural://components/neural-loading-overlay/readme",
      "llms": "neural://components/neural-loading-overlay/llms"
    },
    "sourceDirectory": "libs/neural-ng/loading-overlay",
    "readme": "# NeuralNg LoadingOverlay\n\nAccessible container and viewport loading blockers for Angular 22+.\n\n```ts\nimport { NeuralLoadingIndicator, NeuralLoadingOverlay, type NeuralLoadingOverlayClasses } from '@neural-ng/core/loading-overlay';\n```\n\n## Container loading\n\n```html\n<neural-loading-overlay [active]=\"loading()\" label=\"Loading products\">\n  <product-list />\n</neural-loading-overlay>\n```\n\nContainer scope is the default. While active, projected content receives\n`aria-busy=\"true\"`. With the default `blockInteraction`, the content also\nbecomes inert and the overlay captures pointer interaction. The default\nindicator is `NeuralProgressSpinner`.\n\n## Viewport loading\n\n```html\n<neural-loading-overlay [active]=\"saving()\" scope=\"viewport\" label=\"Saving changes\" lockScroll />\n```\n\nViewport scope uses native modal `<dialog>` top-layer behavior, so the overlay\nstays above fixed headers and transformed ancestors. It restores the previous\nfocus target and safely reference-counts document scroll locks when multiple\nviewport loaders overlap. Escape cannot dismiss an active loading operation.\n\n## Timing and interaction\n\n- `delay`: wait before rendering; defaults to `150` milliseconds\n- `minimumDuration`: once visible, remain visible for at least `300`\n  milliseconds\n- `blockInteraction`: defaults to `true`\n- `backdrop`: defaults to `true`\n- `lockScroll`: defaults to `true` for blocking viewport usage\n- `shown` and `hidden`: emit when the rendered overlay actually changes\n\nThe busy state starts immediately, even during the visual delay. A request that\nfinishes before `delay` never flashes an overlay.\n\nSet `blockInteraction=\"false\"` only for background work where continued\ninteraction is safe. The content still exposes `aria-busy`.\n\n## Labels and spinner\n\n`label` falls back to the active `NeuralLocaleService` common loading message.\n`showLabel` controls visible text. The built-in spinner can be adjusted with\n`spinnerSize` and `spinnerSeverity`.\n\n```html\n<neural-loading-overlay [active]=\"syncing()\" spinnerSize=\"large\" spinnerSeverity=\"success\" label=\"Syncing workspace\" />\n```\n\n## Custom indicator\n\n```html\n<neural-loading-overlay [active]=\"thinking()\" label=\"AI is thinking\">\n  <workspace-view />\n\n  <ng-template neuralLoadingIndicator>\n    <div class=\"ai-loader\">NN</div>\n  </ng-template>\n</neural-loading-overlay>\n```\n\nThe custom indicator panel receives polite status semantics. Do not add a\nsecond live region unless the custom content needs a distinct announcement.\n\n## Headless mode\n\n```html\n<neural-loading-overlay\n  [active]=\"loading()\"\n  unstyled\n  overlayClass=\"my-loader\"\n  [classes]=\"{\n    content: 'my-loader__content',\n    backdrop: 'my-loader__backdrop',\n    panel: 'my-loader__panel',\n    indicator: 'my-loader__indicator',\n    label: 'my-loader__label'\n  }\"\n>\n  <app-content />\n</neural-loading-overlay>\n```\n\n`unstyled` removes NeuralNg visual classes while retaining blocking behavior,\nnative semantics, structural positioning, and timing. Global headless mode is\navailable through `provideNeuralNg({ unstyled: true })`.\n\nTyped slots are `root`, `content`, `backdrop`, `panel`, `indicator`, and\n`label`. Theme tokens use the `--neural-loading-overlay-*` prefix.\n\n`LoadingOverlayComponent` and `LoadingIndicatorDirective` remain deprecated\ncompatibility aliases. New code should use `NeuralLoadingOverlay` and\n`NeuralLoadingIndicator`.\n",
    "llms": "NeuralNg LoadingOverlay rules\n\n- Import canonical `NeuralLoadingOverlay` only from `@neural-ng/core/loading-overlay`; `LoadingOverlayComponent` is a deprecated alias.\n- Import canonical `NeuralLoadingIndicator` from the same entry point only when a custom indicator template is used; `LoadingIndicatorDirective` is a deprecated alias.\n- Add imported standalone declarations directly to component imports.\n- LoadingOverlay owns blocking, backdrop, timing, focus, and scroll behavior; ProgressSpinner owns only the visual indeterminate indicator.\n- Container scope wraps and blocks only projected content.\n- Viewport scope uses native dialog top-layer behavior and can lock document scroll.\n- Bind active to application state; do not imperatively remove overlay DOM.\n- Provide a task-specific label when \"Loading\" is not sufficient.\n- The label defaults to the active locale common loading message.\n- delay defaults to 150ms and prevents short-operation flashes.\n- minimumDuration defaults to 300ms and prevents visible flicker.\n- aria-busy begins immediately, even while visual rendering is delayed.\n- blockInteraction defaults to true. Set it false only when continued interaction is safe.\n- Escape never dismisses a loading operation.\n- Do not create a close button or dismissible backdrop.\n- Use spinnerSize and spinnerSeverity for the built-in ProgressSpinner.\n- Use `<ng-template neuralLoadingIndicator>` for a custom indicator.\n- Custom indicators receive polite status semantics; avoid duplicate live regions.\n- `unstyled` removes visual classes while blocking and structural behavior remain.\n- Slots: root, content, backdrop, panel, indicator, label.\n- Global unstyled mode is `provideNeuralNg({ unstyled: true })`.\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-menu-group/contract",
      "readme": "neural://components/neural-menu-group/readme",
      "llms": "neural://components/neural-menu-group/llms"
    },
    "sourceDirectory": "libs/neural-ng/menu",
    "readme": "# NeuralNg Menu\n\nStatus: **Beta**. Canonical standalone exports are `NeuralMenu`,\n`NeuralMenuItem`, `NeuralMenuGroup`, `NeuralMenuSeparatorItem`, and\n`NeuralMenuTrigger`; legacy\n`*Component` and `*Directive` names remain deprecated compatibility aliases.\n\nAccessible inline and popup command menus for Angular 22+ applications.\nMenu actions remain flat by design. Non-interactive category groups may label\nrelated actions; nested navigation belongs to PanelMenu or a future TieredMenu.\n\n## Import\n\n```ts\nimport { NeuralButton } from '@neural-ng/core/button';\nimport { NeuralMenu, NeuralMenuGroup, NeuralMenuItem, NeuralMenuSeparatorItem, NeuralMenuTrigger, type NeuralMenuEntry, type NeuralMenuSelect } from '@neural-ng/core/menu';\n```\n\nAdd only the primitives used by the consuming standalone component to its\n`imports` array.\n\n## Data-driven inline menu\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  { key: 'profile', label: 'Profile', iconClass: 'nt-user' },\n  { key: 'notifications', label: 'Notifications', badge: 4 },\n  { separator: true },\n  { key: 'logout', label: 'Log out', shortcut: 'Ctrl L' },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Account actions\" [items]=\"items\" (itemSelect)=\"run($event)\" />\n```\n\n## Popup trigger\n\n```html\n<neural-button label=\"Account\" [neuralMenuTriggerFor]=\"accountMenu\" />\n\n<neural-menu #accountMenu=\"neuralMenu\" popup [items]=\"items\" [(open)]=\"menuOpen\" (itemSelect)=\"run($event)\" />\n```\n\n`neuralMenuTriggerFor` adds `aria-haspopup`, `aria-controls`, and\n`aria-expanded`. Click, Enter, Space, ArrowDown, and ArrowUp open the popup.\nEscape closes it and restores focus. Outside pointer interaction, Tab, and item\nselection dismiss it without trapping focus.\n\n`menuPosition` accepts the shared logical Overlay placements. The default is\n`bottom-start`; positioning flips or clamps inside the viewport.\n\n## Category groups\n\nGroups add a visible, non-interactive label without creating a nested menu.\nThe label is skipped by focus and typeahead while its actions remain part of\nthe root Menu's ArrowUp/ArrowDown sequence.\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'projects',\n    label: 'Projects',\n    items: [\n      { key: 'overview', label: 'Overview', routerLink: '/projects' },\n      { key: 'activity', label: 'Activity', routerLink: '/projects/activity' },\n    ],\n  },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Workspace navigation\">\n  <neural-menu-group key=\"projects\" label=\"Projects\">\n    <neural-menu-item key=\"overview\" label=\"Overview\" routerLink=\"/projects\" />\n    <neural-menu-item key=\"activity\" label=\"Activity\" routerLink=\"/projects/activity\" />\n  </neural-menu-group>\n</neural-menu>\n```\n\n## Projected items\n\n```html\n<neural-menu ariaLabel=\"File actions\">\n  <neural-menu-item key=\"rename\" label=\"Rename\" iconClass=\"nt-edit\" />\n  <neural-menu-separator />\n  <neural-menu-item key=\"delete\" label=\"Delete\" disabled />\n</neural-menu>\n```\n\nUse either `[items]` or projected children. When both are supplied, `[items]`\nwins. Every action requires a stable, unique `key`.\n\n## Navigation actions\n\nUse `routerLink` for Angular SPA navigation and `href` for native document or\nexternal navigation. Both data-driven and projected items support the same\ncontract:\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'settings',\n    label: 'Settings',\n    routerLink: ['/workspace', 'settings'],\n    queryParams: { tab: 'profile' },\n  },\n  { key: 'help', label: 'Help', href: 'https://example.com/help', target: '_blank', rel: 'noopener' },\n];\n```\n\nRouter actions also accept `fragment`, `queryParamsHandling`,\n`preserveFragment`, `skipLocationChange`, `replaceUrl`, `state`, and `target`.\n`itemSelect` still emits before navigation so analytics and command state can\nshare one event contract.\n\n## State and events\n\n- `open` is a Signal model and therefore exposes `openChange`.\n- `itemSelect` emits `key`, the typed item, interaction `source`, and the\n  original DOM event.\n- `closeOnSelect` defaults to `true` for popup menus.\n- `disabled` disables the complete menu.\n\n## Accessibility\n\nMenu uses `menu`, `group`, `menuitem`, and `separator` roles. Group containers\nare labelled by their visible category headings. ArrowUp/ArrowDown wrap,\nHome/End move to the edges, typeahead focuses matching enabled items, and\ndisabled items are skipped.\n\n## Headless styling\n\nSet `unstyled` to retain semantics, behavior, positioning, and structural hooks\nwhile removing NeuralNg visual classes. `menuClass`, item-level `itemClass`,\nand the typed `classes` slots remain available. Global unstyled configuration\nis honored.\n\nNeutral, experimental Glass, and experimental Futuristic themes all define\nMenu tokens.\n",
    "llms": "# NeuralNg Menu AI Context\n\nImport canonical `NeuralMenu`, `NeuralMenuGroup`, `NeuralMenuItem`,\n`NeuralMenuSeparatorItem`, and `NeuralMenuTrigger` only from\n`@neural-ng/core/menu`. Legacy `*Component` and\n`*Directive` exports are deprecated compatibility aliases.\n\nUse `<neural-menu [items]=\"items\">` for a flat inline command list. Use\n`<neural-menu #menu=\"neuralMenu\" popup>` with\n`[neuralMenuTriggerFor]=\"menu\"` for a popup command list.\nPrefer attaching the trigger to `NeuralButton`; the directive resolves its\ninner native button so ARIA and focus restoration stay on the interactive node.\n\nRules:\n\n- Every action needs a stable unique `key` and a `label`.\n- Use either `[items]` or projected `neural-menu-item` children, not both.\n- Use `{ separator: true }` or `<neural-menu-separator />` for separators.\n- Use `{ key, label, items }` or `<neural-menu-group key=\"...\" label=\"...\">`\n  for non-interactive category headings. Group headings never receive focus.\n- Handle commands through `(itemSelect)`; do not invent `onMenuClick`.\n- Prefer `routerLink` for Angular SPA navigation and `href` for native or external navigation. Router items support queryParams, fragment, queryParamsHandling, preserveFragment, skipLocationChange, replaceUrl, state, and target.\n- `[(open)]` is optional controlled popup state and produces `openChange`.\n- `menuPosition` belongs on the trigger directive and defaults to\n  `bottom-start`.\n- Do not create a trigger for an inline Menu.\n- Do not generate nested groups or submenus. A Menu group only categorizes a\n  flat action sequence. Use PanelMenu for inline hierarchy and\n  reserve popup nesting for the future TieredMenu.\n- Prefer `iconClass=\"nt-user\"`; NeuralNg adds the `nt` base class.\n- `unstyled` removes visual classes while preserving behavior and structural\n  hooks. Use typed `classes` slots for consumer styling.\n- Popup Menu uses the shared Overlay positioner and browser Popover top layer.\n- Preserve menu/menuitem semantics and built-in keyboard behavior.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-menu-item/contract",
      "readme": "neural://components/neural-menu-item/readme",
      "llms": "neural://components/neural-menu-item/llms"
    },
    "sourceDirectory": "libs/neural-ng/menu",
    "readme": "# NeuralNg Menu\n\nStatus: **Beta**. Canonical standalone exports are `NeuralMenu`,\n`NeuralMenuItem`, `NeuralMenuGroup`, `NeuralMenuSeparatorItem`, and\n`NeuralMenuTrigger`; legacy\n`*Component` and `*Directive` names remain deprecated compatibility aliases.\n\nAccessible inline and popup command menus for Angular 22+ applications.\nMenu actions remain flat by design. Non-interactive category groups may label\nrelated actions; nested navigation belongs to PanelMenu or a future TieredMenu.\n\n## Import\n\n```ts\nimport { NeuralButton } from '@neural-ng/core/button';\nimport { NeuralMenu, NeuralMenuGroup, NeuralMenuItem, NeuralMenuSeparatorItem, NeuralMenuTrigger, type NeuralMenuEntry, type NeuralMenuSelect } from '@neural-ng/core/menu';\n```\n\nAdd only the primitives used by the consuming standalone component to its\n`imports` array.\n\n## Data-driven inline menu\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  { key: 'profile', label: 'Profile', iconClass: 'nt-user' },\n  { key: 'notifications', label: 'Notifications', badge: 4 },\n  { separator: true },\n  { key: 'logout', label: 'Log out', shortcut: 'Ctrl L' },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Account actions\" [items]=\"items\" (itemSelect)=\"run($event)\" />\n```\n\n## Popup trigger\n\n```html\n<neural-button label=\"Account\" [neuralMenuTriggerFor]=\"accountMenu\" />\n\n<neural-menu #accountMenu=\"neuralMenu\" popup [items]=\"items\" [(open)]=\"menuOpen\" (itemSelect)=\"run($event)\" />\n```\n\n`neuralMenuTriggerFor` adds `aria-haspopup`, `aria-controls`, and\n`aria-expanded`. Click, Enter, Space, ArrowDown, and ArrowUp open the popup.\nEscape closes it and restores focus. Outside pointer interaction, Tab, and item\nselection dismiss it without trapping focus.\n\n`menuPosition` accepts the shared logical Overlay placements. The default is\n`bottom-start`; positioning flips or clamps inside the viewport.\n\n## Category groups\n\nGroups add a visible, non-interactive label without creating a nested menu.\nThe label is skipped by focus and typeahead while its actions remain part of\nthe root Menu's ArrowUp/ArrowDown sequence.\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'projects',\n    label: 'Projects',\n    items: [\n      { key: 'overview', label: 'Overview', routerLink: '/projects' },\n      { key: 'activity', label: 'Activity', routerLink: '/projects/activity' },\n    ],\n  },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Workspace navigation\">\n  <neural-menu-group key=\"projects\" label=\"Projects\">\n    <neural-menu-item key=\"overview\" label=\"Overview\" routerLink=\"/projects\" />\n    <neural-menu-item key=\"activity\" label=\"Activity\" routerLink=\"/projects/activity\" />\n  </neural-menu-group>\n</neural-menu>\n```\n\n## Projected items\n\n```html\n<neural-menu ariaLabel=\"File actions\">\n  <neural-menu-item key=\"rename\" label=\"Rename\" iconClass=\"nt-edit\" />\n  <neural-menu-separator />\n  <neural-menu-item key=\"delete\" label=\"Delete\" disabled />\n</neural-menu>\n```\n\nUse either `[items]` or projected children. When both are supplied, `[items]`\nwins. Every action requires a stable, unique `key`.\n\n## Navigation actions\n\nUse `routerLink` for Angular SPA navigation and `href` for native document or\nexternal navigation. Both data-driven and projected items support the same\ncontract:\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'settings',\n    label: 'Settings',\n    routerLink: ['/workspace', 'settings'],\n    queryParams: { tab: 'profile' },\n  },\n  { key: 'help', label: 'Help', href: 'https://example.com/help', target: '_blank', rel: 'noopener' },\n];\n```\n\nRouter actions also accept `fragment`, `queryParamsHandling`,\n`preserveFragment`, `skipLocationChange`, `replaceUrl`, `state`, and `target`.\n`itemSelect` still emits before navigation so analytics and command state can\nshare one event contract.\n\n## State and events\n\n- `open` is a Signal model and therefore exposes `openChange`.\n- `itemSelect` emits `key`, the typed item, interaction `source`, and the\n  original DOM event.\n- `closeOnSelect` defaults to `true` for popup menus.\n- `disabled` disables the complete menu.\n\n## Accessibility\n\nMenu uses `menu`, `group`, `menuitem`, and `separator` roles. Group containers\nare labelled by their visible category headings. ArrowUp/ArrowDown wrap,\nHome/End move to the edges, typeahead focuses matching enabled items, and\ndisabled items are skipped.\n\n## Headless styling\n\nSet `unstyled` to retain semantics, behavior, positioning, and structural hooks\nwhile removing NeuralNg visual classes. `menuClass`, item-level `itemClass`,\nand the typed `classes` slots remain available. Global unstyled configuration\nis honored.\n\nNeutral, experimental Glass, and experimental Futuristic themes all define\nMenu tokens.\n",
    "llms": "# NeuralNg Menu AI Context\n\nImport canonical `NeuralMenu`, `NeuralMenuGroup`, `NeuralMenuItem`,\n`NeuralMenuSeparatorItem`, and `NeuralMenuTrigger` only from\n`@neural-ng/core/menu`. Legacy `*Component` and\n`*Directive` exports are deprecated compatibility aliases.\n\nUse `<neural-menu [items]=\"items\">` for a flat inline command list. Use\n`<neural-menu #menu=\"neuralMenu\" popup>` with\n`[neuralMenuTriggerFor]=\"menu\"` for a popup command list.\nPrefer attaching the trigger to `NeuralButton`; the directive resolves its\ninner native button so ARIA and focus restoration stay on the interactive node.\n\nRules:\n\n- Every action needs a stable unique `key` and a `label`.\n- Use either `[items]` or projected `neural-menu-item` children, not both.\n- Use `{ separator: true }` or `<neural-menu-separator />` for separators.\n- Use `{ key, label, items }` or `<neural-menu-group key=\"...\" label=\"...\">`\n  for non-interactive category headings. Group headings never receive focus.\n- Handle commands through `(itemSelect)`; do not invent `onMenuClick`.\n- Prefer `routerLink` for Angular SPA navigation and `href` for native or external navigation. Router items support queryParams, fragment, queryParamsHandling, preserveFragment, skipLocationChange, replaceUrl, state, and target.\n- `[(open)]` is optional controlled popup state and produces `openChange`.\n- `menuPosition` belongs on the trigger directive and defaults to\n  `bottom-start`.\n- Do not create a trigger for an inline Menu.\n- Do not generate nested groups or submenus. A Menu group only categorizes a\n  flat action sequence. Use PanelMenu for inline hierarchy and\n  reserve popup nesting for the future TieredMenu.\n- Prefer `iconClass=\"nt-user\"`; NeuralNg adds the `nt` base class.\n- `unstyled` removes visual classes while preserving behavior and structural\n  hooks. Use typed `classes` slots for consumer styling.\n- Popup Menu uses the shared Overlay positioner and browser Popover top layer.\n- Preserve menu/menuitem semantics and built-in keyboard behavior.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-menu-separator-item/contract",
      "readme": "neural://components/neural-menu-separator-item/readme",
      "llms": "neural://components/neural-menu-separator-item/llms"
    },
    "sourceDirectory": "libs/neural-ng/menu",
    "readme": "# NeuralNg Menu\n\nStatus: **Beta**. Canonical standalone exports are `NeuralMenu`,\n`NeuralMenuItem`, `NeuralMenuGroup`, `NeuralMenuSeparatorItem`, and\n`NeuralMenuTrigger`; legacy\n`*Component` and `*Directive` names remain deprecated compatibility aliases.\n\nAccessible inline and popup command menus for Angular 22+ applications.\nMenu actions remain flat by design. Non-interactive category groups may label\nrelated actions; nested navigation belongs to PanelMenu or a future TieredMenu.\n\n## Import\n\n```ts\nimport { NeuralButton } from '@neural-ng/core/button';\nimport { NeuralMenu, NeuralMenuGroup, NeuralMenuItem, NeuralMenuSeparatorItem, NeuralMenuTrigger, type NeuralMenuEntry, type NeuralMenuSelect } from '@neural-ng/core/menu';\n```\n\nAdd only the primitives used by the consuming standalone component to its\n`imports` array.\n\n## Data-driven inline menu\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  { key: 'profile', label: 'Profile', iconClass: 'nt-user' },\n  { key: 'notifications', label: 'Notifications', badge: 4 },\n  { separator: true },\n  { key: 'logout', label: 'Log out', shortcut: 'Ctrl L' },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Account actions\" [items]=\"items\" (itemSelect)=\"run($event)\" />\n```\n\n## Popup trigger\n\n```html\n<neural-button label=\"Account\" [neuralMenuTriggerFor]=\"accountMenu\" />\n\n<neural-menu #accountMenu=\"neuralMenu\" popup [items]=\"items\" [(open)]=\"menuOpen\" (itemSelect)=\"run($event)\" />\n```\n\n`neuralMenuTriggerFor` adds `aria-haspopup`, `aria-controls`, and\n`aria-expanded`. Click, Enter, Space, ArrowDown, and ArrowUp open the popup.\nEscape closes it and restores focus. Outside pointer interaction, Tab, and item\nselection dismiss it without trapping focus.\n\n`menuPosition` accepts the shared logical Overlay placements. The default is\n`bottom-start`; positioning flips or clamps inside the viewport.\n\n## Category groups\n\nGroups add a visible, non-interactive label without creating a nested menu.\nThe label is skipped by focus and typeahead while its actions remain part of\nthe root Menu's ArrowUp/ArrowDown sequence.\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'projects',\n    label: 'Projects',\n    items: [\n      { key: 'overview', label: 'Overview', routerLink: '/projects' },\n      { key: 'activity', label: 'Activity', routerLink: '/projects/activity' },\n    ],\n  },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Workspace navigation\">\n  <neural-menu-group key=\"projects\" label=\"Projects\">\n    <neural-menu-item key=\"overview\" label=\"Overview\" routerLink=\"/projects\" />\n    <neural-menu-item key=\"activity\" label=\"Activity\" routerLink=\"/projects/activity\" />\n  </neural-menu-group>\n</neural-menu>\n```\n\n## Projected items\n\n```html\n<neural-menu ariaLabel=\"File actions\">\n  <neural-menu-item key=\"rename\" label=\"Rename\" iconClass=\"nt-edit\" />\n  <neural-menu-separator />\n  <neural-menu-item key=\"delete\" label=\"Delete\" disabled />\n</neural-menu>\n```\n\nUse either `[items]` or projected children. When both are supplied, `[items]`\nwins. Every action requires a stable, unique `key`.\n\n## Navigation actions\n\nUse `routerLink` for Angular SPA navigation and `href` for native document or\nexternal navigation. Both data-driven and projected items support the same\ncontract:\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'settings',\n    label: 'Settings',\n    routerLink: ['/workspace', 'settings'],\n    queryParams: { tab: 'profile' },\n  },\n  { key: 'help', label: 'Help', href: 'https://example.com/help', target: '_blank', rel: 'noopener' },\n];\n```\n\nRouter actions also accept `fragment`, `queryParamsHandling`,\n`preserveFragment`, `skipLocationChange`, `replaceUrl`, `state`, and `target`.\n`itemSelect` still emits before navigation so analytics and command state can\nshare one event contract.\n\n## State and events\n\n- `open` is a Signal model and therefore exposes `openChange`.\n- `itemSelect` emits `key`, the typed item, interaction `source`, and the\n  original DOM event.\n- `closeOnSelect` defaults to `true` for popup menus.\n- `disabled` disables the complete menu.\n\n## Accessibility\n\nMenu uses `menu`, `group`, `menuitem`, and `separator` roles. Group containers\nare labelled by their visible category headings. ArrowUp/ArrowDown wrap,\nHome/End move to the edges, typeahead focuses matching enabled items, and\ndisabled items are skipped.\n\n## Headless styling\n\nSet `unstyled` to retain semantics, behavior, positioning, and structural hooks\nwhile removing NeuralNg visual classes. `menuClass`, item-level `itemClass`,\nand the typed `classes` slots remain available. Global unstyled configuration\nis honored.\n\nNeutral, experimental Glass, and experimental Futuristic themes all define\nMenu tokens.\n",
    "llms": "# NeuralNg Menu AI Context\n\nImport canonical `NeuralMenu`, `NeuralMenuGroup`, `NeuralMenuItem`,\n`NeuralMenuSeparatorItem`, and `NeuralMenuTrigger` only from\n`@neural-ng/core/menu`. Legacy `*Component` and\n`*Directive` exports are deprecated compatibility aliases.\n\nUse `<neural-menu [items]=\"items\">` for a flat inline command list. Use\n`<neural-menu #menu=\"neuralMenu\" popup>` with\n`[neuralMenuTriggerFor]=\"menu\"` for a popup command list.\nPrefer attaching the trigger to `NeuralButton`; the directive resolves its\ninner native button so ARIA and focus restoration stay on the interactive node.\n\nRules:\n\n- Every action needs a stable unique `key` and a `label`.\n- Use either `[items]` or projected `neural-menu-item` children, not both.\n- Use `{ separator: true }` or `<neural-menu-separator />` for separators.\n- Use `{ key, label, items }` or `<neural-menu-group key=\"...\" label=\"...\">`\n  for non-interactive category headings. Group headings never receive focus.\n- Handle commands through `(itemSelect)`; do not invent `onMenuClick`.\n- Prefer `routerLink` for Angular SPA navigation and `href` for native or external navigation. Router items support queryParams, fragment, queryParamsHandling, preserveFragment, skipLocationChange, replaceUrl, state, and target.\n- `[(open)]` is optional controlled popup state and produces `openChange`.\n- `menuPosition` belongs on the trigger directive and defaults to\n  `bottom-start`.\n- Do not create a trigger for an inline Menu.\n- Do not generate nested groups or submenus. A Menu group only categorizes a\n  flat action sequence. Use PanelMenu for inline hierarchy and\n  reserve popup nesting for the future TieredMenu.\n- Prefer `iconClass=\"nt-user\"`; NeuralNg adds the `nt` base class.\n- `unstyled` removes visual classes while preserving behavior and structural\n  hooks. Use typed `classes` slots for consumer styling.\n- Popup Menu uses the shared Overlay positioner and browser Popover top layer.\n- Preserve menu/menuitem semantics and built-in keyboard behavior.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-menu-trigger/contract",
      "readme": "neural://components/neural-menu-trigger/readme",
      "llms": "neural://components/neural-menu-trigger/llms"
    },
    "sourceDirectory": "libs/neural-ng/menu",
    "readme": "# NeuralNg Menu\n\nStatus: **Beta**. Canonical standalone exports are `NeuralMenu`,\n`NeuralMenuItem`, `NeuralMenuGroup`, `NeuralMenuSeparatorItem`, and\n`NeuralMenuTrigger`; legacy\n`*Component` and `*Directive` names remain deprecated compatibility aliases.\n\nAccessible inline and popup command menus for Angular 22+ applications.\nMenu actions remain flat by design. Non-interactive category groups may label\nrelated actions; nested navigation belongs to PanelMenu or a future TieredMenu.\n\n## Import\n\n```ts\nimport { NeuralButton } from '@neural-ng/core/button';\nimport { NeuralMenu, NeuralMenuGroup, NeuralMenuItem, NeuralMenuSeparatorItem, NeuralMenuTrigger, type NeuralMenuEntry, type NeuralMenuSelect } from '@neural-ng/core/menu';\n```\n\nAdd only the primitives used by the consuming standalone component to its\n`imports` array.\n\n## Data-driven inline menu\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  { key: 'profile', label: 'Profile', iconClass: 'nt-user' },\n  { key: 'notifications', label: 'Notifications', badge: 4 },\n  { separator: true },\n  { key: 'logout', label: 'Log out', shortcut: 'Ctrl L' },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Account actions\" [items]=\"items\" (itemSelect)=\"run($event)\" />\n```\n\n## Popup trigger\n\n```html\n<neural-button label=\"Account\" [neuralMenuTriggerFor]=\"accountMenu\" />\n\n<neural-menu #accountMenu=\"neuralMenu\" popup [items]=\"items\" [(open)]=\"menuOpen\" (itemSelect)=\"run($event)\" />\n```\n\n`neuralMenuTriggerFor` adds `aria-haspopup`, `aria-controls`, and\n`aria-expanded`. Click, Enter, Space, ArrowDown, and ArrowUp open the popup.\nEscape closes it and restores focus. Outside pointer interaction, Tab, and item\nselection dismiss it without trapping focus.\n\n`menuPosition` accepts the shared logical Overlay placements. The default is\n`bottom-start`; positioning flips or clamps inside the viewport.\n\n## Category groups\n\nGroups add a visible, non-interactive label without creating a nested menu.\nThe label is skipped by focus and typeahead while its actions remain part of\nthe root Menu's ArrowUp/ArrowDown sequence.\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'projects',\n    label: 'Projects',\n    items: [\n      { key: 'overview', label: 'Overview', routerLink: '/projects' },\n      { key: 'activity', label: 'Activity', routerLink: '/projects/activity' },\n    ],\n  },\n];\n```\n\n```html\n<neural-menu ariaLabel=\"Workspace navigation\">\n  <neural-menu-group key=\"projects\" label=\"Projects\">\n    <neural-menu-item key=\"overview\" label=\"Overview\" routerLink=\"/projects\" />\n    <neural-menu-item key=\"activity\" label=\"Activity\" routerLink=\"/projects/activity\" />\n  </neural-menu-group>\n</neural-menu>\n```\n\n## Projected items\n\n```html\n<neural-menu ariaLabel=\"File actions\">\n  <neural-menu-item key=\"rename\" label=\"Rename\" iconClass=\"nt-edit\" />\n  <neural-menu-separator />\n  <neural-menu-item key=\"delete\" label=\"Delete\" disabled />\n</neural-menu>\n```\n\nUse either `[items]` or projected children. When both are supplied, `[items]`\nwins. Every action requires a stable, unique `key`.\n\n## Navigation actions\n\nUse `routerLink` for Angular SPA navigation and `href` for native document or\nexternal navigation. Both data-driven and projected items support the same\ncontract:\n\n```ts\nreadonly items: readonly NeuralMenuEntry[] = [\n  {\n    key: 'settings',\n    label: 'Settings',\n    routerLink: ['/workspace', 'settings'],\n    queryParams: { tab: 'profile' },\n  },\n  { key: 'help', label: 'Help', href: 'https://example.com/help', target: '_blank', rel: 'noopener' },\n];\n```\n\nRouter actions also accept `fragment`, `queryParamsHandling`,\n`preserveFragment`, `skipLocationChange`, `replaceUrl`, `state`, and `target`.\n`itemSelect` still emits before navigation so analytics and command state can\nshare one event contract.\n\n## State and events\n\n- `open` is a Signal model and therefore exposes `openChange`.\n- `itemSelect` emits `key`, the typed item, interaction `source`, and the\n  original DOM event.\n- `closeOnSelect` defaults to `true` for popup menus.\n- `disabled` disables the complete menu.\n\n## Accessibility\n\nMenu uses `menu`, `group`, `menuitem`, and `separator` roles. Group containers\nare labelled by their visible category headings. ArrowUp/ArrowDown wrap,\nHome/End move to the edges, typeahead focuses matching enabled items, and\ndisabled items are skipped.\n\n## Headless styling\n\nSet `unstyled` to retain semantics, behavior, positioning, and structural hooks\nwhile removing NeuralNg visual classes. `menuClass`, item-level `itemClass`,\nand the typed `classes` slots remain available. Global unstyled configuration\nis honored.\n\nNeutral, experimental Glass, and experimental Futuristic themes all define\nMenu tokens.\n",
    "llms": "# NeuralNg Menu AI Context\n\nImport canonical `NeuralMenu`, `NeuralMenuGroup`, `NeuralMenuItem`,\n`NeuralMenuSeparatorItem`, and `NeuralMenuTrigger` only from\n`@neural-ng/core/menu`. Legacy `*Component` and\n`*Directive` exports are deprecated compatibility aliases.\n\nUse `<neural-menu [items]=\"items\">` for a flat inline command list. Use\n`<neural-menu #menu=\"neuralMenu\" popup>` with\n`[neuralMenuTriggerFor]=\"menu\"` for a popup command list.\nPrefer attaching the trigger to `NeuralButton`; the directive resolves its\ninner native button so ARIA and focus restoration stay on the interactive node.\n\nRules:\n\n- Every action needs a stable unique `key` and a `label`.\n- Use either `[items]` or projected `neural-menu-item` children, not both.\n- Use `{ separator: true }` or `<neural-menu-separator />` for separators.\n- Use `{ key, label, items }` or `<neural-menu-group key=\"...\" label=\"...\">`\n  for non-interactive category headings. Group headings never receive focus.\n- Handle commands through `(itemSelect)`; do not invent `onMenuClick`.\n- Prefer `routerLink` for Angular SPA navigation and `href` for native or external navigation. Router items support queryParams, fragment, queryParamsHandling, preserveFragment, skipLocationChange, replaceUrl, state, and target.\n- `[(open)]` is optional controlled popup state and produces `openChange`.\n- `menuPosition` belongs on the trigger directive and defaults to\n  `bottom-start`.\n- Do not create a trigger for an inline Menu.\n- Do not generate nested groups or submenus. A Menu group only categorizes a\n  flat action sequence. Use PanelMenu for inline hierarchy and\n  reserve popup nesting for the future TieredMenu.\n- Prefer `iconClass=\"nt-user\"`; NeuralNg adds the `nt` base class.\n- `unstyled` removes visual classes while preserving behavior and structural\n  hooks. Use typed `classes` slots for consumer styling.\n- Popup Menu uses the shared Overlay positioner and browser Popover top layer.\n- Preserve menu/menuitem semantics and built-in keyboard behavior.\n"
  ...
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/neural-meter-group/readme",
      "llms": "neural://components/neural-meter-group/llms"
    },
    "sourceDirectory": "libs/neural-ng/meter-group",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-panel-menu/contract",
      "readme": "neural://components/neural-panel-menu/readme",
      "llms": "neural://components/neural-panel-menu/llms"
    },
    "sourceDirectory": "libs/neural-ng/panel-menu",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-panel-menu-item/contract",
      "readme": "neural://components/neural-panel-menu-item/readme",
      "llms": "neural://components/neural-panel-menu-item/llms"
    },
    "sourceDirectory": "libs/neural-ng/panel-menu",
    "readme": "# PanelMenu\n\nSignals-first hierarchical navigation and command panels for Angular 22+.\nPanelMenu is an inline Accordion + Tree pattern. It is not a Sidebar/Drawer and\ndoes not require a popup trigger.\n\n## Import\n\n```ts\nimport { NeuralPanelMenu, type NeuralPanelMenuEntry } from '@neural-ng/core/panel-menu';\n```\n\n```ts\n@Component({ imports: [NeuralPanelMenu] })\nexport class WorkspaceNavigation {}\n```\n\nThe legacy `PanelMenuComponent` export remains as a compatibility alias.\n\n## Data-driven usage\n\n```ts\nreadonly items: readonly NeuralPanelMenuEntry[] = [\n  {\n    key: 'files',\n    label: 'Files',\n    iconClass: 'nt nt-folder',\n    items: [\n      { key: 'documents', label: 'Documents' },\n      { key: 'images', label: 'Images', badge: 4 },\n    ],\n  },\n  { separator: true },\n  {\n    key: 'settings',\n    label: 'Settings',\n    shortcut: '⌘ ,',\n  },\n];\n```\n\n```html\n<neural-panel-menu ariaLabel=\"Workspace\" [items]=\"items\" [(expandedKeys)]=\"expandedKeys\" (itemSelect)=\"handleSelection($event)\" />\n```\n\nEvery action requires a unique, stable `key`. `expandedKeys` is a Signal model\ncontaining expanded branch keys. Root branches are exclusive by default; add\n`multiple` to keep several roots open.\n\n## Projected structure\n\n```html\n<neural-panel-menu ariaLabel=\"Account navigation\">\n  <neural-panel-menu-item key=\"account\" label=\"Account\" iconClass=\"nt nt-user\">\n    <neural-panel-menu-item key=\"profile\" label=\"Profile\" />\n    <neural-panel-menu-separator />\n    <neural-panel-menu-item key=\"billing\" label=\"Billing\" disabled />\n  </neural-panel-menu-item>\n</neural-panel-menu>\n```\n\nUse either `[items]` or projected items, never both. Use `href`, `target`, and\n`rel` for native links or `routerLink` for Angular SPA navigation. Router\nentries also accept `queryParams`, `fragment`, `queryParamsHandling`,\n`preserveFragment`, `skipLocationChange`, `replaceUrl`, and `state`.\n\n```ts\nreadonly items: readonly NeuralPanelMenuEntry[] = [\n  {\n    key: 'profile',\n    label: 'Profile',\n    routerLink: ['/account', 'profile'],\n    queryParams: { source: 'panel' },\n  },\n];\n```\n\n## Events\n\n- `itemSelect`: emitted only when an enabled leaf action is activated.\n- `itemToggle`: emitted only when a branch opens or closes. It includes the\n  previous and next expanded key arrays and the pointer/keyboard source.\n\nNormal `[(expandedKeys)]` binding does not require importing event interfaces.\n\n## Accessibility and keyboard\n\nThe root uses `role=\"tree\"`, branches and leaves use `role=\"treeitem\"`, and\nnested collections use `role=\"group\"`. Branches expose `aria-expanded` and\n`aria-controls`; collapsed groups are inert.\n\n- Arrow Down / Arrow Up: next or previous visible enabled item.\n- Arrow Right: expand a branch or enter its first child.\n- Arrow Left: collapse a branch or return to its parent.\n- Home / End: first or last visible enabled item.\n- Enter / Space: toggle a branch or activate a leaf.\n- Typing: moves focus to the next matching visible label.\n\nProvide either `ariaLabel` or `ariaLabelledby`.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural classes,\ntree behavior, animation structure, and ARIA. Global\n`provideNeuralNg({ unstyled: true })` is also respected.\n\nTyped slots include `root`, `list`, `itemContainer`, `item`, `expandedItem`,\n`disabledItem`, `icon`, `label`, `meta`, `badge`, `shortcut`, `indicator`,\n`group`, `groupInner`, and `separator`.\n\n## Component boundary\n\n- PanelMenu: inline expandable hierarchy.\n- Menu: flat/grouped command list; popup mode belongs to a future Menu package.\n- Sidebar/Drawer: layout container that may contain PanelMenu.\n\nPopup triggers, overlay positioning, nested flyout menus, checkbox/radio\nitems, and lazy remote loading are outside this beta.\n",
    "llms": "# NeuralNg PanelMenu\n\nImport `NeuralPanelMenu`, `NeuralPanelMenuItem`, and\n`NeuralPanelMenuSeparator` from `@neural-ng/core/panel-menu`. Use standalone\nimports. Legacy `*Component` names are compatibility aliases only.\n\nPanelMenu is an inline Accordion + Tree hierarchy. It is not a Sidebar/Drawer\nand it is not a popup Menu. Do not generate a trigger button, popup input, or\nOverlay integration for PanelMenu.\n\nPrefer `[items]` for data and projected `neural-panel-menu-item` children for a\ndeclarative hierarchy. Never combine both sources. Every item requires a\nunique stable `key`.\n\nBind `[(expandedKeys)]` as `readonly string[]`. Root expansion is exclusive by\ndefault; add `multiple` when multiple roots may remain open.\n\nUse `itemSelect` for enabled leaf actions and `itemToggle` for branch state.\nDo not run a leaf command when a branch is toggled. Do not invent `onNodeClick`\nor `activeIndex`.\n\nItems support label, iconClass, badge, shortcut, disabled, href, routerLink,\nqueryParams, fragment, queryParamsHandling, preserveFragment,\nskipLocationChange, replaceUrl, state, target, rel, itemClass, and recursive\nitems. Use `href` for native navigation and `routerLink` for Angular SPA\nnavigation. Separators use `{ separator: true }`.\n\nKeep the built-in tree/treeitem/group semantics and keyboard behavior. Provide\nariaLabel or ariaLabelledby. Use `unstyled` and typed `classes` for headless\nrendering.\n\nCanonical example:\n\n```html\n<neural-panel-menu\n  ariaLabel=\"Workspace\"\n  [items]=\"items\"\n  [(expandedKeys)]=\"expandedKeys\"\n  (itemSelect)=\"run($event.key)\"\n/>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-panel-menu-separator/contract",
      "readme": "neural://components/neural-panel-menu-separator/readme",
      "llms": "neural://components/neural-panel-menu-separator/llms"
    },
    "sourceDirectory": "libs/neural-ng/panel-menu",
    "readme": "# PanelMenu\n\nSignals-first hierarchical navigation and command panels for Angular 22+.\nPanelMenu is an inline Accordion + Tree pattern. It is not a Sidebar/Drawer and\ndoes not require a popup trigger.\n\n## Import\n\n```ts\nimport { NeuralPanelMenu, type NeuralPanelMenuEntry } from '@neural-ng/core/panel-menu';\n```\n\n```ts\n@Component({ imports: [NeuralPanelMenu] })\nexport class WorkspaceNavigation {}\n```\n\nThe legacy `PanelMenuComponent` export remains as a compatibility alias.\n\n## Data-driven usage\n\n```ts\nreadonly items: readonly NeuralPanelMenuEntry[] = [\n  {\n    key: 'files',\n    label: 'Files',\n    iconClass: 'nt nt-folder',\n    items: [\n      { key: 'documents', label: 'Documents' },\n      { key: 'images', label: 'Images', badge: 4 },\n    ],\n  },\n  { separator: true },\n  {\n    key: 'settings',\n    label: 'Settings',\n    shortcut: '⌘ ,',\n  },\n];\n```\n\n```html\n<neural-panel-menu ariaLabel=\"Workspace\" [items]=\"items\" [(expandedKeys)]=\"expandedKeys\" (itemSelect)=\"handleSelection($event)\" />\n```\n\nEvery action requires a unique, stable `key`. `expandedKeys` is a Signal model\ncontaining expanded branch keys. Root branches are exclusive by default; add\n`multiple` to keep several roots open.\n\n## Projected structure\n\n```html\n<neural-panel-menu ariaLabel=\"Account navigation\">\n  <neural-panel-menu-item key=\"account\" label=\"Account\" iconClass=\"nt nt-user\">\n    <neural-panel-menu-item key=\"profile\" label=\"Profile\" />\n    <neural-panel-menu-separator />\n    <neural-panel-menu-item key=\"billing\" label=\"Billing\" disabled />\n  </neural-panel-menu-item>\n</neural-panel-menu>\n```\n\nUse either `[items]` or projected items, never both. Use `href`, `target`, and\n`rel` for native links or `routerLink` for Angular SPA navigation. Router\nentries also accept `queryParams`, `fragment`, `queryParamsHandling`,\n`preserveFragment`, `skipLocationChange`, `replaceUrl`, and `state`.\n\n```ts\nreadonly items: readonly NeuralPanelMenuEntry[] = [\n  {\n    key: 'profile',\n    label: 'Profile',\n    routerLink: ['/account', 'profile'],\n    queryParams: { source: 'panel' },\n  },\n];\n```\n\n## Events\n\n- `itemSelect`: emitted only when an enabled leaf action is activated.\n- `itemToggle`: emitted only when a branch opens or closes. It includes the\n  previous and next expanded key arrays and the pointer/keyboard source.\n\nNormal `[(expandedKeys)]` binding does not require importing event interfaces.\n\n## Accessibility and keyboard\n\nThe root uses `role=\"tree\"`, branches and leaves use `role=\"treeitem\"`, and\nnested collections use `role=\"group\"`. Branches expose `aria-expanded` and\n`aria-controls`; collapsed groups are inert.\n\n- Arrow Down / Arrow Up: next or previous visible enabled item.\n- Arrow Right: expand a branch or enter its first child.\n- Arrow Left: collapse a branch or return to its parent.\n- Home / End: first or last visible enabled item.\n- Enter / Space: toggle a branch or activate a leaf.\n- Typing: moves focus to the next matching visible label.\n\nProvide either `ariaLabel` or `ariaLabelledby`.\n\n## Headless classes\n\n`unstyled` removes NeuralNg visual classes while retaining structural classes,\ntree behavior, animation structure, and ARIA. Global\n`provideNeuralNg({ unstyled: true })` is also respected.\n\nTyped slots include `root`, `list`, `itemContainer`, `item`, `expandedItem`,\n`disabledItem`, `icon`, `label`, `meta`, `badge`, `shortcut`, `indicator`,\n`group`, `groupInner`, and `separator`.\n\n## Component boundary\n\n- PanelMenu: inline expandable hierarchy.\n- Menu: flat/grouped command list; popup mode belongs to a future Menu package.\n- Sidebar/Drawer: layout container that may contain PanelMenu.\n\nPopup triggers, overlay positioning, nested flyout menus, checkbox/radio\nitems, and lazy remote loading are outside this beta.\n",
    "llms": "# NeuralNg PanelMenu\n\nImport `NeuralPanelMenu`, `NeuralPanelMenuItem`, and\n`NeuralPanelMenuSeparator` from `@neural-ng/core/panel-menu`. Use standalone\nimports. Legacy `*Component` names are compatibility aliases only.\n\nPanelMenu is an inline Accordion + Tree hierarchy. It is not a Sidebar/Drawer\nand it is not a popup Menu. Do not generate a trigger button, popup input, or\nOverlay integration for PanelMenu.\n\nPrefer `[items]` for data and projected `neural-panel-menu-item` children for a\ndeclarative hierarchy. Never combine both sources. Every item requires a\nunique stable `key`.\n\nBind `[(expandedKeys)]` as `readonly string[]`. Root expansion is exclusive by\ndefault; add `multiple` when multiple roots may remain open.\n\nUse `itemSelect` for enabled leaf actions and `itemToggle` for branch state.\nDo not run a leaf command when a branch is toggled. Do not invent `onNodeClick`\nor `activeIndex`.\n\nItems support label, iconClass, badge, shortcut, disabled, href, routerLink,\nqueryParams, fragment, queryParamsHandling, preserveFragment,\nskipLocationChange, replaceUrl, state, target, rel, itemClass, and recursive\nitems. Use `href` for native navigation and `routerLink` for Angular SPA\nnavigation. Separators use `{ separator: true }`.\n\nKeep the built-in tree/treeitem/group semantics and keyboard behavior. Provide\nariaLabel or ariaLabelledby. Use `unstyled` and typed `classes` for headless\nrendering.\n\nCanonical example:\n\n```html\n<neural-panel-menu\n  ariaLabel=\"Workspace\"\n  [items]=\"items\"\n  [(expandedKeys)]=\"expandedKeys\"\n  (itemSelect)=\"run($event.key)\"\n/>\n```\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/neural-password/readme",
      "llms": "neural://components/neural-password/llms"
    },
    "sourceDirectory": "libs/neural-ng/password",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-content/contract",
      "readme": "neural://components/neural-sidebar-content/readme",
      "llms": "neural://components/neural-sidebar-content/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-footer/contract",
      "readme": "neural://components/neural-sidebar-footer/readme",
      "llms": "neural://components/neural-sidebar-footer/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-header/contract",
      "readme": "neural://components/neural-sidebar-header/readme",
      "llms": "neural://components/neural-sidebar-header/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-initial-focus/contract",
      "readme": "neural://components/neural-sidebar-initial-focus/readme",
      "llms": "neural://components/neural-sidebar-initial-focus/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-label/contract",
      "readme": "neural://components/neural-sidebar-label/readme",
      "llms": "neural://components/neural-sidebar-label/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-layout/contract",
      "readme": "neural://components/neural-sidebar-layout/readme",
      "llms": "neural://components/neural-sidebar-layout/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-main/contract",
      "readme": "neural://components/neural-sidebar-main/readme",
      "llms": "neural://components/neural-sidebar-main/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/neural-sidebar-trigger/contract",
      "readme": "neural://components/neural-sidebar-trigger/readme",
      "llms": "neural://components/neural-sidebar-trigger/llms"
    },
    "sourceDirectory": "libs/neural-ng/sidebar",
    "readme": "# NeuralNg Sidebar\n\nResponsive application-shell navigation that composes with `NeuralMenu` and `NeuralPanelMenu`.\n\n```ts\nimport { NeuralMenu } from '@neural-ng/core/menu';\nimport { NeuralPanelMenu } from '@neural-ng/core/panel-menu';\nimport { NeuralSidebar, NeuralSidebarContent, NeuralSidebarHeader, NeuralSidebarInitialFocus, NeuralSidebarLabel, NeuralSidebarLayout, NeuralSidebarMain, NeuralSidebarTrigger } from '@neural-ng/core/sidebar';\n```\n\n```html\n<neural-sidebar-layout>\n  <neural-sidebar id=\"navigation\" [(open)]=\"open\" side=\"start\" variant=\"inset\" collapseMode=\"icon\" openOnHover breakpoint=\"64rem\" mobileMode=\"offcanvas\">\n    <neural-sidebar-header><span neuralSidebarLabel>Workspace</span></neural-sidebar-header>\n    <neural-sidebar-content>\n      <neural-menu ariaLabel=\"Quick navigation\" [items]=\"quickItems\" />\n      <neural-panel-menu ariaLabel=\"Workspace navigation\" [items]=\"treeItems\" />\n    </neural-sidebar-content>\n  </neural-sidebar>\n  <main neuralSidebarMain>\n    <button #trigger=\"neuralSidebarTrigger\" [neuralSidebarTrigger]=\"'navigation'\" [attr.aria-label]=\"trigger.expanded() ? 'Collapse navigation' : 'Expand navigation'\">\n      <i class=\"nt\" [class.nt-layout-sidebar-left-collapse]=\"trigger.expanded()\" [class.nt-layout-sidebar-left-expand]=\"!trigger.expanded()\"></i>\n    </button>\n  </main>\n</neural-sidebar-layout>\n```\n\n`NeuralPanelMenu` automatically adopts a flush Sidebar presentation. In `icon` mode its labels, metadata, indicators, and separators collapse into a centered icon rail. Activating a parent icon opens its children in a logical-side flyout; after that explicit disclosure, hovering a nested parent opens its next flyout after `hoverOpenDelay`. Deeper branches cascade sideways instead of expanding the first panel vertically. Closing or replacing a root flyout clears every descendant expansion, so reopening the root starts from a clean state. The same PanelMenu state and keyboard model remain active across every level. Escape, outside pointer interaction, and Angular navigation close the flyout. Set `iconMenu=\"hidden\"` when child navigation must not be available in the collapsed state. Use `neuralSidebarLabel` for custom header and footer labels.\n\n`NeuralMenu` also adopts the flush Sidebar surface. In collapsed `icon` mode,\nits action labels, metadata, group headings, and separators reduce to centered\ntop-level icons; hover and keyboard focus expose each action label beside the\nrail. Import `NeuralMenu` independently from `@neural-ng/core/menu` and project\nit into `neural-sidebar-content` exactly like `NeuralPanelMenu`. Both menus may\nshare the same content region: they use one width, menu gap, collapse state,\nhover expansion and responsive transition. Popup NeuralMenu instances remain\nindependent and never inherit icon-rail clipping or label-hiding rules.\n\nSet `openOnHover` to temporarily expand a collapsed desktop icon rail without changing the controlled `open` model. `hoverOpenDelay` defaults to `100`ms and `hoverCloseDelay` to `180`ms. Focused content remains expanded until focus leaves, touch pointers are ignored, and `hoverChange` reports the temporary state. When hover expansion is disabled, focused or hovered rail items expose their label beside the rail; parent icons can still open their child flyout.\n\n`start` and `end` follow document direction. Offcanvas mode supplies backdrop dismissal, Escape handling, focus containment, background scroll locking, navigation dismissal, and focus restoration. `showBackdrop=\"false\"` removes only the visual backdrop without changing overlay positioning; `modal` and `blockScroll` remain independent policies. Apply `neuralSidebarInitialFocus` to the preferred first control. Set `blockScroll=\"false\"`, `closeOnNavigation=\"false\"`, or `closeOnMobile=\"false\"` to opt out of those policies. `unstyled` removes visual classes while retaining structural hooks.\n",
    "llms": "# @neural-ng/core/sidebar\n\n- Import standalone symbols from `@neural-ng/core/sidebar`.\n- Sidebar owns application layout and responsive state; use Drawer for transient arbitrary panels.\n- Compose navigation with `NeuralMenu` or `NeuralPanelMenu`; Sidebar does not duplicate menu item APIs.\n- `NeuralPanelMenu` becomes visually flush inside a styled Sidebar and automatically reduces to centered top-level icons in a collapsed icon rail.\n- `NeuralMenu` receives the same flush treatment and collapses flat actions into centered rail icons; import it separately from `@neural-ng/core/menu`.\n- `NeuralMenu` and `NeuralPanelMenu` may be projected together in one `neural-sidebar-content`; both follow the same expanded, collapsed, hover-expanded, responsive and RTL shell state.\n- Sidebar icon-rail styling applies only to inline `NeuralMenu`. A popup `NeuralMenu` projected anywhere inside Sidebar keeps its full overlay labels, metadata and geometry.\n- `iconMenu=\"flyout\"` is the default: activating a parent rail icon opens its children beside the rail. Once the root flyout is open, hovering a nested parent opens the next logical-side flyout after `hoverOpenDelay`; deeper branches never expand the first panel vertically.\n- Closing or replacing a root flyout clears all descendant expansion keys. Reopening it starts collapsed rather than restoring stale nested flyouts. Escape, outside pointer interaction, or Angular navigation closes and resets the hierarchy.\n- `openOnHover` temporarily expands a collapsed desktop icon rail without mutating `open`. Tune `hoverOpenDelay` (100ms) and `hoverCloseDelay` (180ms); use `hoverChange` only for observing this temporary state.\n- Hover expansion ignores touch pointers and does not collapse while keyboard focus remains inside the Sidebar.\n- Without hover expansion, a top-level rail item exposes its `data-label` visually on hover or keyboard focus; parent icons continue to use the accessible child flyout.\n- Add `neuralSidebarLabel` to custom header/footer text that must disappear in icon mode; never hide the associated icon.\n- Use logical `side=\"start|end\"` for RTL safety.\n- `collapseMode`: `icon`, `offcanvas`, or `none`. `mobileMode` defaults to `offcanvas` below `breakpoint=\"64rem\"`.\n- Bind state with `[(open)]`; connect controls using `[neuralSidebarTrigger]=\"sidebarId\"`.\n- Export the trigger as `#trigger=\"neuralSidebarTrigger\"` and read `trigger.expanded()` when the control icon or label must reflect state.\n- `closeOnMobile` defaults to true so an expanded desktop shell does not become an open modal on narrow screens.\n- Open offcanvas navigation closes after Angular Router navigation by default; opt out with `closeOnNavigation=\"false\"`.\n- Modal offcanvas mode locks background scrolling, traps focus, supports Escape/backdrop dismissal, and restores trigger focus. Set `blockScroll=\"false\"` only for intentionally non-blocking overlays.\n- `showBackdrop` controls backdrop rendering only; `overlay`, `modal`, and `blockScroll` remain independent positioning, focus, and scrolling policies.\n- Apply `neuralSidebarInitialFocus` to the preferred first interactive control inside an offcanvas Sidebar.\n- `unstyled` and global unstyled retain structural classes. `classes` provides typed additive slots.\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/neural-skeleton/readme",
      "llms": "neural://components/neural-skeleton/llms"
    },
    "sourceDirectory": "libs/neural-ng/skeleton",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/popover-close/contract",
      "readme": "neural://components/popover-close/readme",
      "llms": "neural://components/popover-close/llms"
    },
    "sourceDirectory": "libs/neural-ng/popover",
    "readme": "# NeuralNg Popover\n\n`@neural-ng/core/popover` renders arbitrary Angular content in a non-modal,\ntrigger-anchored top-layer panel. It composes the shared Overlay positioner and\ndoes not impose Menu item or Dialog layout semantics.\n\n## Basic usage\n\n```ts\nimport { NeuralPopover, NeuralPopoverClose, NeuralPopoverTrigger } from '@neural-ng/core/popover';\n\n@Component({\n  imports: [NeuralPopover, NeuralPopoverClose, NeuralPopoverTrigger],\n  template: `\n    <button type=\"button\" [neuralPopoverTriggerFor]=\"account\" popoverPosition=\"bottom-end\">Account</button>\n\n    <neural-popover #account ariaLabel=\"Account panel\">\n      <h2>Neural Admin</h2>\n      <button type=\"button\" neuralPopoverClose>Close</button>\n    </neural-popover>\n  `,\n})\nexport class AccountPanel {}\n```\n\nUse an interactive native element such as `button` for the trigger. The\ndirective synchronizes `aria-controls` and `aria-expanded`.\n\n## Positioning and top layer\n\nAvailable logical placements are `top`, `top-start`, `top-end`, `bottom`,\n`bottom-start`, `bottom-end`, `left`, and `right`. Start and end follow the\ntrigger's writing direction.\n\n```html\n<button [neuralPopoverTriggerFor]=\"panel\" popoverPosition=\"bottom-end\" [popoverOffset]=\"10\" [popoverViewportPadding]=\"12\">Open</button>\n```\n\nPopover uses the native HTML Popover top layer where available. It therefore\ndoes not need an `appendTo=\"body\"` API and is not clipped by an ancestor's\noverflow or stacking context. `NeuralOverlayPositioner` supplies CSS Anchor\nPositioning or a viewport-aware fixed-position fallback with flip, clamp,\nscroll, resize, and RTL behavior.\n\n## Controlled and imperative state\n\n```html\n<neural-popover #panel [(open)]=\"open\" />\n```\n\n```ts\npanel.showFor(trigger, { position: 'bottom-end' });\npanel.toggleFor(trigger);\npanel.hide();\n```\n\n`opened` emits the trigger and requested position. `closed` reports one of\n`trigger`, `outside`, `escape`, `close-directive`, `api`, or `native`.\n\n## Focus and semantics\n\nPopover is non-modal and does not trap focus. Focus remains on the disclosure\ntrigger by default:\n\n```html\n<neural-popover focusOnOpen=\"none\" />\n```\n\nFor an interactive panel, explicitly request initial focus:\n\n```html\n<button [neuralPopoverTriggerFor]=\"profile\" popoverFocusOnOpen=\"first\">Edit profile</button>\n\n<neural-popover #profile role=\"dialog\" ariaLabel=\"Edit profile\">\n  <input neuralPopoverInitialFocus />\n</neural-popover>\n```\n\nEscape closes the topmost Popover and restores the trigger focus. Outside\npointer dismissal does not steal focus from the newly selected target.\n`role=\"dialog\"` and `role=\"region\"` are opt-in because arbitrary disclosure\ncontent does not always have dialog semantics. Label either role with\n`ariaLabel` or `ariaLabelledby`.\n\nUse Dialog when content must be modal or focus must remain trapped. Use Menu\nfor a flat command collection with menu keyboard semantics.\n\n## Inputs\n\n| Input               | Default        | Purpose                                    |\n| ------------------- | -------------- | ------------------------------------------ |\n| `open`              | `false`        | Controlled Signal model                    |\n| `position`          | `bottom-start` | Component-level fallback placement         |\n| `offset`            | `8`            | Trigger gap in pixels                      |\n| `viewportPadding`   | `8`            | Minimum viewport edge distance             |\n| `focusOnOpen`       | `none`         | `none` or first focusable control          |\n| `dismissible`       | `true`         | Close on outside pointer interaction       |\n| `closeOnEscape`     | `true`         | Close the topmost panel with Escape        |\n| `restoreFocus`      | `true`         | Restore trigger for explicit closes        |\n| `matchTriggerWidth` | `false`        | Match the active trigger width             |\n| `showArrow`         | `false`        | Render the optional structural arrow       |\n| `role`              | `null`         | Optional `dialog` or `region` role         |\n| `ariaLabel`         | `null`         | Accessible name                            |\n| `ariaLabelledby`    | `null`         | Visible accessible-name reference          |\n| `ariaDescribedby`   | `null`         | Accessible-description reference           |\n| `unstyled`          | `false`        | Remove NeuralNg visual classes             |\n| `popoverClass`      | empty          | Consumer class on the panel root           |\n| `classes`           | `{}`           | Typed `root`, `content`, and `arrow` slots |\n\nThe trigger directive accepts `popoverPosition`, `popoverOffset`,\n`popoverViewportPadding`, `popoverFocusOnOpen`, and `popoverDisabled`.\n\n## Styling\n\nStructural classes remain in unstyled mode:\n\n- `neural-popover-root`\n- `neural-popover-content-root`\n- `neural-popover-arrow-root`\n\nImportant tokens include:\n\n```css\n--neural-popover-width\n--neural-popover-min-width\n--neural-popover-max-width\n--neural-popover-max-height\n--neural-popover-padding\n--neural-popover-color\n--neural-popover-background\n--neural-popover-border\n--neural-popover-radius\n--neural-popover-shadow\n--neural-popover-arrow-size\n--neural-popover-enter-duration\n--neural-popover-leave-duration\n```\n\nNeutral, experimental Glass, and experimental Futuristic themes provide token\nvalues. Reduced-motion preferences collapse animation duration.\n\n## SSR\n\nSSR renders deterministic closed markup without accessing browser globals,\nopening the top layer, or connecting the positioner. Opening and positioning\nbegin only in the browser after the trigger and panel exist.\n",
    "llms": "# NeuralNg Popover\n\n> Arbitrary, non-modal, trigger-anchored top-layer content from `@neural-ng/core/popover`.\n\n## Generation rules\n\n- Import `NeuralPopover`, `NeuralPopoverTrigger`, `NeuralPopoverClose`, and when needed `NeuralPopoverInitialFocus` only from `@neural-ng/core/popover`.\n- Use a native interactive trigger with `[neuralPopoverTriggerFor]=\"panel\"`.\n- Prefer logical `bottom-start` or `bottom-end` positions; start/end follow RTL.\n- Put any Angular content inside `<neural-popover #panel>`.\n- Use `neuralPopoverClose` for an in-panel close action.\n- Popover is non-modal and never traps focus. Use Dialog for modal workflows.\n- Popover is not a command list. Use Menu when menu roles and arrow-key item navigation are required.\n- Do not generate `appendTo=\"body\"`; native top-layer rendering avoids clipping and stacking-context problems.\n- Focus remains on the trigger by default. Set `popoverFocusOnOpen=\"first\"` and apply `neuralPopoverInitialFocus` only when the workflow benefits from moving focus.\n- Use `role=\"dialog\"` or `role=\"region\"` only when semantically correct, and provide `ariaLabel` or `ariaLabelledby`.\n- Bind `[(open)]` for controlled state. Use `opened` and `closed` only when lifecycle details are needed.\n- `closed.reason` is typed as `trigger`, `outside`, `escape`, `close-directive`, `api`, or `native`.\n- Use `unstyled` and typed `root`, `content`, and `arrow` class slots for headless rendering.\n- Do not create an NgModule.\n\n## Canonical example\n\n```html\n<button\n  type=\"button\"\n  [neuralPopoverTriggerFor]=\"account\"\n  popoverPosition=\"bottom-end\"\n>\n  Account\n</button>\n\n<neural-popover #account role=\"dialog\" ariaLabel=\"Account panel\">\n  <h2>Neural Admin</h2>\n  <button type=\"button\" neuralPopoverClose>Close</button>\n</neural-popover>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/popover-initial-focus/contract",
      "readme": "neural://components/popover-initial-focus/readme",
      "llms": "neural://components/popover-initial-focus/llms"
    },
    "sourceDirectory": "libs/neural-ng/popover",
    "readme": "# NeuralNg Popover\n\n`@neural-ng/core/popover` renders arbitrary Angular content in a non-modal,\ntrigger-anchored top-layer panel. It composes the shared Overlay positioner and\ndoes not impose Menu item or Dialog layout semantics.\n\n## Basic usage\n\n```ts\nimport { NeuralPopover, NeuralPopoverClose, NeuralPopoverTrigger } from '@neural-ng/core/popover';\n\n@Component({\n  imports: [NeuralPopover, NeuralPopoverClose, NeuralPopoverTrigger],\n  template: `\n    <button type=\"button\" [neuralPopoverTriggerFor]=\"account\" popoverPosition=\"bottom-end\">Account</button>\n\n    <neural-popover #account ariaLabel=\"Account panel\">\n      <h2>Neural Admin</h2>\n      <button type=\"button\" neuralPopoverClose>Close</button>\n    </neural-popover>\n  `,\n})\nexport class AccountPanel {}\n```\n\nUse an interactive native element such as `button` for the trigger. The\ndirective synchronizes `aria-controls` and `aria-expanded`.\n\n## Positioning and top layer\n\nAvailable logical placements are `top`, `top-start`, `top-end`, `bottom`,\n`bottom-start`, `bottom-end`, `left`, and `right`. Start and end follow the\ntrigger's writing direction.\n\n```html\n<button [neuralPopoverTriggerFor]=\"panel\" popoverPosition=\"bottom-end\" [popoverOffset]=\"10\" [popoverViewportPadding]=\"12\">Open</button>\n```\n\nPopover uses the native HTML Popover top layer where available. It therefore\ndoes not need an `appendTo=\"body\"` API and is not clipped by an ancestor's\noverflow or stacking context. `NeuralOverlayPositioner` supplies CSS Anchor\nPositioning or a viewport-aware fixed-position fallback with flip, clamp,\nscroll, resize, and RTL behavior.\n\n## Controlled and imperative state\n\n```html\n<neural-popover #panel [(open)]=\"open\" />\n```\n\n```ts\npanel.showFor(trigger, { position: 'bottom-end' });\npanel.toggleFor(trigger);\npanel.hide();\n```\n\n`opened` emits the trigger and requested position. `closed` reports one of\n`trigger`, `outside`, `escape`, `close-directive`, `api`, or `native`.\n\n## Focus and semantics\n\nPopover is non-modal and does not trap focus. Focus remains on the disclosure\ntrigger by default:\n\n```html\n<neural-popover focusOnOpen=\"none\" />\n```\n\nFor an interactive panel, explicitly request initial focus:\n\n```html\n<button [neuralPopoverTriggerFor]=\"profile\" popoverFocusOnOpen=\"first\">Edit profile</button>\n\n<neural-popover #profile role=\"dialog\" ariaLabel=\"Edit profile\">\n  <input neuralPopoverInitialFocus />\n</neural-popover>\n```\n\nEscape closes the topmost Popover and restores the trigger focus. Outside\npointer dismissal does not steal focus from the newly selected target.\n`role=\"dialog\"` and `role=\"region\"` are opt-in because arbitrary disclosure\ncontent does not always have dialog semantics. Label either role with\n`ariaLabel` or `ariaLabelledby`.\n\nUse Dialog when content must be modal or focus must remain trapped. Use Menu\nfor a flat command collection with menu keyboard semantics.\n\n## Inputs\n\n| Input               | Default        | Purpose                                    |\n| ------------------- | -------------- | ------------------------------------------ |\n| `open`              | `false`        | Controlled Signal model                    |\n| `position`          | `bottom-start` | Component-level fallback placement         |\n| `offset`            | `8`            | Trigger gap in pixels                      |\n| `viewportPadding`   | `8`            | Minimum viewport edge distance             |\n| `focusOnOpen`       | `none`         | `none` or first focusable control          |\n| `dismissible`       | `true`         | Close on outside pointer interaction       |\n| `closeOnEscape`     | `true`         | Close the topmost panel with Escape        |\n| `restoreFocus`      | `true`         | Restore trigger for explicit closes        |\n| `matchTriggerWidth` | `false`        | Match the active trigger width             |\n| `showArrow`         | `false`        | Render the optional structural arrow       |\n| `role`              | `null`         | Optional `dialog` or `region` role         |\n| `ariaLabel`         | `null`         | Accessible name                            |\n| `ariaLabelledby`    | `null`         | Visible accessible-name reference          |\n| `ariaDescribedby`   | `null`         | Accessible-description reference           |\n| `unstyled`          | `false`        | Remove NeuralNg visual classes             |\n| `popoverClass`      | empty          | Consumer class on the panel root           |\n| `classes`           | `{}`           | Typed `root`, `content`, and `arrow` slots |\n\nThe trigger directive accepts `popoverPosition`, `popoverOffset`,\n`popoverViewportPadding`, `popoverFocusOnOpen`, and `popoverDisabled`.\n\n## Styling\n\nStructural classes remain in unstyled mode:\n\n- `neural-popover-root`\n- `neural-popover-content-root`\n- `neural-popover-arrow-root`\n\nImportant tokens include:\n\n```css\n--neural-popover-width\n--neural-popover-min-width\n--neural-popover-max-width\n--neural-popover-max-height\n--neural-popover-padding\n--neural-popover-color\n--neural-popover-background\n--neural-popover-border\n--neural-popover-radius\n--neural-popover-shadow\n--neural-popover-arrow-size\n--neural-popover-enter-duration\n--neural-popover-leave-duration\n```\n\nNeutral, experimental Glass, and experimental Futuristic themes provide token\nvalues. Reduced-motion preferences collapse animation duration.\n\n## SSR\n\nSSR renders deterministic closed markup without accessing browser globals,\nopening the top layer, or connecting the positioner. Opening and positioning\nbegin only in the browser after the trigger and panel exist.\n",
    "llms": "# NeuralNg Popover\n\n> Arbitrary, non-modal, trigger-anchored top-layer content from `@neural-ng/core/popover`.\n\n## Generation rules\n\n- Import `NeuralPopover`, `NeuralPopoverTrigger`, `NeuralPopoverClose`, and when needed `NeuralPopoverInitialFocus` only from `@neural-ng/core/popover`.\n- Use a native interactive trigger with `[neuralPopoverTriggerFor]=\"panel\"`.\n- Prefer logical `bottom-start` or `bottom-end` positions; start/end follow RTL.\n- Put any Angular content inside `<neural-popover #panel>`.\n- Use `neuralPopoverClose` for an in-panel close action.\n- Popover is non-modal and never traps focus. Use Dialog for modal workflows.\n- Popover is not a command list. Use Menu when menu roles and arrow-key item navigation are required.\n- Do not generate `appendTo=\"body\"`; native top-layer rendering avoids clipping and stacking-context problems.\n- Focus remains on the trigger by default. Set `popoverFocusOnOpen=\"first\"` and apply `neuralPopoverInitialFocus` only when the workflow benefits from moving focus.\n- Use `role=\"dialog\"` or `role=\"region\"` only when semantically correct, and provide `ariaLabel` or `ariaLabelledby`.\n- Bind `[(open)]` for controlled state. Use `opened` and `closed` only when lifecycle details are needed.\n- `closed.reason` is typed as `trigger`, `outside`, `escape`, `close-directive`, `api`, or `native`.\n- Use `unstyled` and typed `root`, `content`, and `arrow` class slots for headless rendering.\n- Do not create an NgModule.\n\n## Canonical example\n\n```html\n<button\n  type=\"button\"\n  [neuralPopoverTriggerFor]=\"account\"\n  popoverPosition=\"bottom-end\"\n>\n  Account\n</button>\n\n<neural-popover #account role=\"dialog\" ariaLabel=\"Account panel\">\n  <h2>Neural Admin</h2>\n  <button type=\"button\" neuralPopoverClose>Close</button>\n</neural-popover>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/popover-trigger/contract",
      "readme": "neural://components/popover-trigger/readme",
      "llms": "neural://components/popover-trigger/llms"
    },
    "sourceDirectory": "libs/neural-ng/popover",
    "readme": "# NeuralNg Popover\n\n`@neural-ng/core/popover` renders arbitrary Angular content in a non-modal,\ntrigger-anchored top-layer panel. It composes the shared Overlay positioner and\ndoes not impose Menu item or Dialog layout semantics.\n\n## Basic usage\n\n```ts\nimport { NeuralPopover, NeuralPopoverClose, NeuralPopoverTrigger } from '@neural-ng/core/popover';\n\n@Component({\n  imports: [NeuralPopover, NeuralPopoverClose, NeuralPopoverTrigger],\n  template: `\n    <button type=\"button\" [neuralPopoverTriggerFor]=\"account\" popoverPosition=\"bottom-end\">Account</button>\n\n    <neural-popover #account ariaLabel=\"Account panel\">\n      <h2>Neural Admin</h2>\n      <button type=\"button\" neuralPopoverClose>Close</button>\n    </neural-popover>\n  `,\n})\nexport class AccountPanel {}\n```\n\nUse an interactive native element such as `button` for the trigger. The\ndirective synchronizes `aria-controls` and `aria-expanded`.\n\n## Positioning and top layer\n\nAvailable logical placements are `top`, `top-start`, `top-end`, `bottom`,\n`bottom-start`, `bottom-end`, `left`, and `right`. Start and end follow the\ntrigger's writing direction.\n\n```html\n<button [neuralPopoverTriggerFor]=\"panel\" popoverPosition=\"bottom-end\" [popoverOffset]=\"10\" [popoverViewportPadding]=\"12\">Open</button>\n```\n\nPopover uses the native HTML Popover top layer where available. It therefore\ndoes not need an `appendTo=\"body\"` API and is not clipped by an ancestor's\noverflow or stacking context. `NeuralOverlayPositioner` supplies CSS Anchor\nPositioning or a viewport-aware fixed-position fallback with flip, clamp,\nscroll, resize, and RTL behavior.\n\n## Controlled and imperative state\n\n```html\n<neural-popover #panel [(open)]=\"open\" />\n```\n\n```ts\npanel.showFor(trigger, { position: 'bottom-end' });\npanel.toggleFor(trigger);\npanel.hide();\n```\n\n`opened` emits the trigger and requested position. `closed` reports one of\n`trigger`, `outside`, `escape`, `close-directive`, `api`, or `native`.\n\n## Focus and semantics\n\nPopover is non-modal and does not trap focus. Focus remains on the disclosure\ntrigger by default:\n\n```html\n<neural-popover focusOnOpen=\"none\" />\n```\n\nFor an interactive panel, explicitly request initial focus:\n\n```html\n<button [neuralPopoverTriggerFor]=\"profile\" popoverFocusOnOpen=\"first\">Edit profile</button>\n\n<neural-popover #profile role=\"dialog\" ariaLabel=\"Edit profile\">\n  <input neuralPopoverInitialFocus />\n</neural-popover>\n```\n\nEscape closes the topmost Popover and restores the trigger focus. Outside\npointer dismissal does not steal focus from the newly selected target.\n`role=\"dialog\"` and `role=\"region\"` are opt-in because arbitrary disclosure\ncontent does not always have dialog semantics. Label either role with\n`ariaLabel` or `ariaLabelledby`.\n\nUse Dialog when content must be modal or focus must remain trapped. Use Menu\nfor a flat command collection with menu keyboard semantics.\n\n## Inputs\n\n| Input               | Default        | Purpose                                    |\n| ------------------- | -------------- | ------------------------------------------ |\n| `open`              | `false`        | Controlled Signal model                    |\n| `position`          | `bottom-start` | Component-level fallback placement         |\n| `offset`            | `8`            | Trigger gap in pixels                      |\n| `viewportPadding`   | `8`            | Minimum viewport edge distance             |\n| `focusOnOpen`       | `none`         | `none` or first focusable control          |\n| `dismissible`       | `true`         | Close on outside pointer interaction       |\n| `closeOnEscape`     | `true`         | Close the topmost panel with Escape        |\n| `restoreFocus`      | `true`         | Restore trigger for explicit closes        |\n| `matchTriggerWidth` | `false`        | Match the active trigger width             |\n| `showArrow`         | `false`        | Render the optional structural arrow       |\n| `role`              | `null`         | Optional `dialog` or `region` role         |\n| `ariaLabel`         | `null`         | Accessible name                            |\n| `ariaLabelledby`    | `null`         | Visible accessible-name reference          |\n| `ariaDescribedby`   | `null`         | Accessible-description reference           |\n| `unstyled`          | `false`        | Remove NeuralNg visual classes             |\n| `popoverClass`      | empty          | Consumer class on the panel root           |\n| `classes`           | `{}`           | Typed `root`, `content`, and `arrow` slots |\n\nThe trigger directive accepts `popoverPosition`, `popoverOffset`,\n`popoverViewportPadding`, `popoverFocusOnOpen`, and `popoverDisabled`.\n\n## Styling\n\nStructural classes remain in unstyled mode:\n\n- `neural-popover-root`\n- `neural-popover-content-root`\n- `neural-popover-arrow-root`\n\nImportant tokens include:\n\n```css\n--neural-popover-width\n--neural-popover-min-width\n--neural-popover-max-width\n--neural-popover-max-height\n--neural-popover-padding\n--neural-popover-color\n--neural-popover-background\n--neural-popover-border\n--neural-popover-radius\n--neural-popover-shadow\n--neural-popover-arrow-size\n--neural-popover-enter-duration\n--neural-popover-leave-duration\n```\n\nNeutral, experimental Glass, and experimental Futuristic themes provide token\nvalues. Reduced-motion preferences collapse animation duration.\n\n## SSR\n\nSSR renders deterministic closed markup without accessing browser globals,\nopening the top layer, or connecting the positioner. Opening and positioning\nbegin only in the browser after the trigger and panel exist.\n",
    "llms": "# NeuralNg Popover\n\n> Arbitrary, non-modal, trigger-anchored top-layer content from `@neural-ng/core/popover`.\n\n## Generation rules\n\n- Import `NeuralPopover`, `NeuralPopoverTrigger`, `NeuralPopoverClose`, and when needed `NeuralPopoverInitialFocus` only from `@neural-ng/core/popover`.\n- Use a native interactive trigger with `[neuralPopoverTriggerFor]=\"panel\"`.\n- Prefer logical `bottom-start` or `bottom-end` positions; start/end follow RTL.\n- Put any Angular content inside `<neural-popover #panel>`.\n- Use `neuralPopoverClose` for an in-panel close action.\n- Popover is non-modal and never traps focus. Use Dialog for modal workflows.\n- Popover is not a command list. Use Menu when menu roles and arrow-key item navigation are required.\n- Do not generate `appendTo=\"body\"`; native top-layer rendering avoids clipping and stacking-context problems.\n- Focus remains on the trigger by default. Set `popoverFocusOnOpen=\"first\"` and apply `neuralPopoverInitialFocus` only when the workflow benefits from moving focus.\n- Use `role=\"dialog\"` or `role=\"region\"` only when semantically correct, and provide `ariaLabel` or `ariaLabelledby`.\n- Bind `[(open)]` for controlled state. Use `opened` and `closed` only when lifecycle details are needed.\n- `closed.reason` is typed as `trigger`, `outside`, `escape`, `close-directive`, `api`, or `native`.\n- Use `unstyled` and typed `root`, `content`, and `arrow` class slots for headless rendering.\n- Do not create an NgModule.\n\n## Canonical example\n\n```html\n<button\n  type=\"button\"\n  [neuralPopoverTriggerFor]=\"account\"\n  popoverPosition=\"bottom-end\"\n>\n  Account\n</button>\n\n<neural-popover #account role=\"dialog\" ariaLabel=\"Account panel\">\n  <h2>Neural Admin</h2>\n  <button type=\"button\" neuralPopoverClose>Close</button>\n</neural-popover>\n```\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/radio-group/contract",
      "readme": "neural://components/radio-group/readme",
      "llms": "neural://components/radio-group/llms"
    },
    "sourceDirectory": "libs/neural-ng/radio",
    "readme": "# NeuralNg Radio\n\nNative, Signal-first RadioGroup and Radio components for Angular 22+.\n\n## Import\n\n```ts\nimport { NeuralRadio, NeuralRadioGroup, type NeuralRadioSelectionChange } from '@neural-ng/core/radio';\n```\n\n## Data options\n\n```html\n<neural-radio-group [options]=\"plans\" optionLabel=\"name\" optionValue=\"id\" optionDisabled=\"unavailable\" optionIcon=\"iconClass\" [(value)]=\"planId\" (selectionChange)=\"planSelected($event)\" />\n```\n\n`options` is the concise path for data-driven interfaces. The property inputs\ndefault to `label`, `value`, `disabled`, and `iconClass`. Primitive options are\nalso supported.\n\n## Projected options\n\n```html\n<neural-radio-group [(value)]=\"delivery\">\n  <neural-radio value=\"standard\" iconClass=\"nt-truck\">\n    <strong>Standard</strong>\n    <small>Three to five days</small>\n  </neural-radio>\n  <neural-radio value=\"express\">Express</neural-radio>\n</neural-radio-group>\n```\n\nUse projected `neural-radio` children when a choice needs rich content. Data\noptions and projected radios are alternatives; when both are present,\n`options` wins.\n\n## Angular Forms\n\n`NeuralRadioGroup` implements `FormValueControl<TValue | null>`. Bind the\nsame nullable `value` model through any Angular Forms adapter:\n\n```html\n<!-- Signal Forms -->\n<neural-radio-group [options]=\"plans\" [formField]=\"form.plan\" />\n\n<!-- Reactive Forms -->\n<neural-radio-group [options]=\"plans\" [formControl]=\"planControl\" />\n\n<!-- Template-driven Forms -->\n<neural-radio-group [options]=\"plans\" name=\"plan\" [(ngModel)]=\"plan\" />\n```\n\nProgrammatic form writes update selection without emitting `selectionChange`.\nOnly pointer and keyboard selection emit the semantic event. `reset()` restores\n`null`, `focus()` targets the roving tab stop, and `touch` is emitted when focus\nleaves the group.\n\n## State and events\n\n- `value` is a `TValue | null` model and produces `valueChange` for two-way\n  binding.\n- `selectionChange` is emitted only for user interaction and contains\n  `{ value, previousValue, option, source }`.\n- `source` is `pointer` or `keyboard`.\n- Selecting the current value again does not clear it or emit a duplicate\n  event.\n\n## Native behavior and keyboard\n\nEvery choice contains a real `<input type=\"radio\">` and all inputs share a\nstable native name. Arrow keys move and select while skipping disabled choices.\nHome and End select the first and last enabled choices. Only the selected\nchoice, or the first enabled choice when empty, participates in the tab order.\n\n`orientation` accepts `vertical` (default) or `horizontal` and is exposed as\n`aria-orientation`. Readonly groups remain enabled and keyboard-focusable, expose\n`aria-readonly=\"true\"`, and block pointer and keyboard mutation. Disabled\ngroups use native disabled inputs and leave the tab order.\n\n## Styling\n\n`unstyled` removes NeuralNg visual classes while keeping native inputs,\nstructural hooks, state, keyboard behavior, and consumer classes. Global and\nField-level unstyled mode are inherited.\n\nUse `radioGroupClass`, the projected radio's `radioClass`, or typed `classes`\nslots: `root`, `option`, `input`, `control`, `selectedControl`,\n`disabledOption`, `label`, and `optionIcon`.\n\nThe neutral theme exposes `--neural-radio-*` and\n`--neural-radio-group-*` tokens.\n\n## Field composition\n\nInside `neural-field`, RadioGroup inherits the deterministic control id,\ndescriptions, required, invalid, disabled, readonly, fluid, and unstyled state.\nField-provided readonly remains distinct from disabled and preserves the roving\ntab stop.\n\n`RadioGroupComponent` and `RadioComponent` remain deprecated compatibility\naliases. New applications should import `NeuralRadioGroup` and `NeuralRadio`.\n",
    "llms": "# NeuralNg Radio\n\nIMPORT\nimport { NeuralRadio, NeuralRadioGroup, type NeuralRadioSelectionChange } from '@neural-ng/core/radio';\n\nRULES\n- Use NeuralRadioGroup for every radio set; do not compose unrelated native names manually.\n- Prefer [options] with optionLabel and optionValue for data-driven choices.\n- Use projected <neural-radio [value]=\"...\"> only for rich option content.\n- Do not combine [options] and projected neural-radio children. [options] wins.\n- NeuralRadioGroup implements FormValueControl<TValue | null>.\n- RadioGroupComponent and RadioComponent are deprecated compatibility aliases; never generate them in new code.\n- Bind the model with [(value)] or use [formField], [formControl], or [(ngModel)].\n- Programmatic Forms writes update value without emitting selectionChange.\n- valueChange is the generated model output. selectionChange is the detailed user-only event.\n- selectionChange payload is { value, previousValue, option, source }.\n- source is \"pointer\" or \"keyboard\".\n- Radio selection does not toggle back to null. Use a separate clear action if product UX needs clearing.\n- orientation is \"vertical\" by default and also accepts \"horizontal\".\n- Native radio inputs, shared name, Arrow keys, Home, End, Space, focus, required, disabled, validation, and form submission are preserved.\n- readonly is not disabled: the roving tab stop remains focusable, aria-readonly is exposed on the group, and user mutation is blocked.\n- touch is emitted when focus leaves the group. focus() targets the roving tab stop and reset() restores null.\n- iconClass and optionIcon values may use Neural Icons classes such as \"nt-user\"; the base \"nt\" class is added automatically.\n- Set unstyled for local headless mode or provideNeuralNg({ unstyled: true }) globally.\n- Consumer classes survive unstyled mode.\n- Inside neural-field, RadioGroup inherits id, descriptions, required, invalid, disabled, readonly, fluid, and unstyled state.\n\nDATA EXAMPLE\n<neural-radio-group\n  [options]=\"plans\"\n  optionLabel=\"name\"\n  optionValue=\"id\"\n  optionDisabled=\"disabled\"\n  optionIcon=\"iconClass\"\n  [(value)]=\"planId\"\n  (selectionChange)=\"planSelected($event)\"\n/>\n\nFORMS EXAMPLE\n<!-- Signal Forms -->\n<neural-radio-group [options]=\"plans\" [formField]=\"form.plan\" />\n\n<!-- Reactive Forms -->\n<neural-radio-group [options]=\"plans\" [formControl]=\"planControl\" />\n\n<!-- Template-driven Forms -->\n<neural-radio-group [options]=\"plans\" name=\"plan\" [(ngModel)]=\"plan\" />\n\nPROJECTED EXAMPLE\n<neural-radio-group [(value)]=\"delivery\">\n  <neural-radio value=\"standard\" iconClass=\"nt-truck\">\n    <strong>Standard delivery</strong>\n  </neural-radio>\n  <neural-radio value=\"express\">Express delivery</neural-radio>\n</neural-radio-group>\n\nCLASS SLOTS\nroot, option, input, control, selectedControl, disabledOption, label, optionIcon\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/select/contract",
      "readme": "neural://components/select/readme",
      "llms": "neural://components/select/llms"
    },
    "sourceDirectory": "libs/neural-ng/select",
    "readme": "# NeuralNg Select v0.1 Beta\n\nAccessible, Signal-first combobox/listbox for Angular 22+.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { OptionComponent, NeuralSelect, type NeuralSelectChange } from '@neural-ng/core/select';\n```\n\n## Data options\n\n```html\n<neural-select [options]=\"cities\" optionLabel=\"name\" optionValue=\"id\" optionDisabled=\"unavailable\" optionIcon=\"iconClass\" [(value)]=\"cityId\" placeholder=\"Select a city\" clearable (selectionChange)=\"citySelected($event)\" (cleared)=\"cityCleared()\" />\n```\n\nPrimitive arrays work without field mappings:\n\n```html\n<neural-select [options]=\"['Small', 'Medium', 'Large']\" [(value)]=\"size\" />\n```\n\n## Declarative options\n\nUse projected options when custom option content is needed. `label` remains\nrequired for the selected value, typeahead, and accessible text.\n\n```html\n<neural-select [(value)]=\"status\">\n  <neural-option value=\"ready\" label=\"Ready\" iconClass=\"nt-circle-check\">\n    <strong>Ready</strong>\n  </neural-option>\n  <neural-option value=\"paused\" label=\"Paused\">Paused</neural-option>\n</neural-select>\n```\n\nUse either `[options]` or projected `neural-option` children in one Select.\nWhen both are present, `[options]` is authoritative and a development warning\nis emitted.\n\n## Angular Forms\n\n`NeuralSelect` implements `FormValueControl<TValue | null>`. Bind the same\nnullable `value` model through any Angular Forms adapter:\n\n```html\n<!-- Signal Forms -->\n<neural-select [options]=\"cities\" [formField]=\"form.city\" />\n\n<!-- Reactive Forms -->\n<neural-select [options]=\"cities\" [formControl]=\"cityControl\" />\n\n<!-- Template-driven Forms -->\n<neural-select [options]=\"cities\" name=\"city\" [(ngModel)]=\"city\" />\n```\n\nProgrammatic form writes update selection without emitting `selectionChange`.\nOnly pointer and keyboard selection emit the semantic event. `reset()` restores\n`null`, `focus()` targets the combobox trigger, and `touch` is emitted when\nfocus leaves the control.\n\n## State and events\n\n- `value` is a `TValue | null` model and produces `valueChange` for two-way\n  binding.\n- `selectionChange` emits `{ value, previousValue, option, source }` only when\n  a user changes the selected value.\n- `cleared` emits `{ previousValue }` for an explicit user clear action.\n- `openChange` emits the panel state.\n- Selecting the current value again closes the panel without a duplicate\n  semantic event.\n\nReadonly is distinct from disabled. A readonly Select remains enabled and\nfocusable, exposes `aria-readonly=\"true\"`, can open for inspection, and blocks\npointer, keyboard, and clear mutations. Disabled Selects use the native disabled\nbutton state and leave the tab order. Programmatic value writes continue to work\nin both states.\n\nUse `appendTo=\"body\"` when the Select lives inside an overflow-clipped table,\ndialog, or scroll surface. The panel enters the browser top layer and uses the\nshared logical Overlay positioner with `bottom-start` placement, viewport\nflipping, and automatic resize/scroll updates. The default is\n`appendTo=\"self\"`.\n\n## Chained selects\n\nUpdate or compute the second options array from the first Select's model. Reset\nthe dependent model when `selectionChange` fires. Use `loading` while async\noptions are fetched.\n\n## Styling\n\n`unstyled` removes visual classes while retaining structure and behavior.\nGlobal unstyled mode and `neural-field` unstyled mode are inherited. Use\n`selectClass` for the root and `classes` for typed slots.\n\nThe stable neutral theme exposes `--neural-select-*` tokens. Icons beginning\nwith `nt-` automatically receive the Neural Icons `nt` base class.\n\n## Accessibility\n\nThe trigger uses `role=\"combobox\"` and keeps DOM focus while the active option\nis exposed through `aria-activedescendant`. The popup uses listbox/option\nsemantics. Arrow keys, Home, End, Enter, Space, Escape, Tab, and typeahead are\nsupported. Disabled options are skipped.\n\nInside `neural-field`, Select inherits the deterministic control id,\ndescriptions, required, invalid, disabled, readonly, fluid, and unstyled state.\nField-provided readonly remains distinct from disabled and preserves the\ncombobox tab stop.\n\nFor large fixed-height lists, enable `virtualScroll` and configure\n`virtualItemSize`, `virtualScrollHeight`, and `virtualOverscan`. Only the\noverscanned viewport is rendered while listbox size and position metadata stay\navailable to assistive technology. Option paths may be nested, for example\n`optionLabel=\"profile.name\"`.\n",
    "llms": "# @neural-ng/core/select\n\nCurrent component maturity: beta.\n\nAngular 22+ standalone, Signal-first Select.\n\nIMPORT\nimport { NeuralSelect, OptionComponent, type NeuralSelectChange } from '@neural-ng/core/select';\n\nPREFERRED DATA API\n<neural-select\n  [options]=\"cities\"\n  optionLabel=\"name\"\n  optionValue=\"id\"\n  [(value)]=\"cityId\"\n  placeholder=\"Select a city\"\n  clearable\n  (selectionChange)=\"citySelected($event)\"\n/>\n\nFORMS API\n<!-- Signal Forms -->\n<neural-select [options]=\"cities\" [formField]=\"form.city\" />\n\n<!-- Reactive Forms -->\n<neural-select [options]=\"cities\" [formControl]=\"cityControl\" />\n\n<!-- Template-driven Forms -->\n<neural-select [options]=\"cities\" name=\"city\" [(ngModel)]=\"city\" />\n\nPROJECTED API\n<neural-select [(value)]=\"status\">\n  <neural-option value=\"ready\" label=\"Ready\" iconClass=\"nt-circle-check\">\n    Ready\n  </neural-option>\n</neural-select>\n\nRULES\n- NeuralSelect implements FormValueControl<TValue | null>.\n- Bind the model with [(value)] or use [formField], [formControl], or [(ngModel)].\n- Programmatic Forms writes update value without emitting selectionChange.\n- Use either [options] or neural-option children in one instance, not both.\n- optionLabel, optionValue, optionDisabled, and optionIcon support nested\n  property paths. Primitive arrays need no mappings.\n- valueChange is the generated model output. selectionChange is the detailed\n  user-only event with value, previousValue, option, and source.\n- source is \"pointer\" or \"keyboard\".\n- Selecting the current value again does not emit a duplicate selectionChange.\n- Use cleared for explicit clear actions and openChange for panel state.\n- readonly is not disabled: the trigger remains enabled and focusable,\n  aria-readonly is exposed, and pointer, keyboard, and clear mutation are blocked.\n- touch emits when focus leaves the control. focus() targets the trigger and\n  reset() restores null.\n- appendTo defaults to self. Use appendTo=\"body\" inside clipped scroll,\n  table, or dialog surfaces; it uses the browser top layer and shared Overlay\n  positioner without requiring a global container.\n- Do not invent onSelected, onChange, or onSelectLink outputs.\n- Build chained selects by updating the dependent options Signal from the\n  parent value/selectionChange. Reset the dependent value explicitly.\n- Set loading while dependent async options load.\n- neural-option requires both value and label. label is used for selection\n  display, typeahead, and accessible text; projected content renders in the\n  list.\n- iconClass values such as nt-map-pin automatically receive the nt base class.\n- Use unstyled for local headless mode or provideNeuralNg({ unstyled: true })\n  globally. Keep structural classes; replace visual classes with classes slots.\n- Preserve combobox/listbox semantics and keyboard behavior.\n- Inside neural-field, Select inherits id, descriptions, required, invalid,\n  disabled, readonly, fluid, and unstyled state.\n- For fixed-height large lists use virtualScroll with virtualItemSize,\n  virtualScrollHeight and virtualOverscan.\n- Select shares option resolution, enabled navigation and typeahead primitives\n  with MultiSelect through @neural-ng/core.\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/slider/readme",
      "llms": "neural://components/slider/llms"
    },
    "sourceDirectory": "libs/neural-ng/slider",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/tab-list/contract",
      "readme": "neural://components/tab-list/readme",
      "llms": "neural://components/tab-list/llms"
    },
    "sourceDirectory": "libs/neural-ng/tabs",
    "readme": "# NeuralNg Tabs v0.1 Beta\n\nComposable, Signal-first and headless-friendly tabs for Angular 22+.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralTab, NeuralTabList, NeuralTabPanel, NeuralTabPanels, NeuralTabs } from '@neural-ng/core/tabs';\n```\n\nAdd the standalone declarations used by the template to the consumer\ncomponent's `imports` array. The former `*Component` names remain deprecated\naliases for migration only.\n\n## Basic usage\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">\n      <i class=\"my-security-icon\" aria-hidden=\"true\"></i>\n      Security\n    </neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nTab and panel values are strings or numbers, must be unique within their group,\nand must match. If `value` is null, invalid, disabled, or removed, the first\nenabled tab becomes active.\n\n## Icons\n\n`iconClass` is a convenience input on `neural-tab`. A Neural Icons name such as\n`nt-user` automatically receives the required `nt` base class:\n\n```html\n<neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n```\n\nMultiple classes, including color utilities, are preserved. Other class-based\nicon systems are not modified. For custom markup, badges, or layered icons,\nproject content directly inside the tab instead. Tabs has no package dependency\non `@neural-ng/icons`.\n\n## Activation and orientation\n\nAutomatic activation is the default. Arrow-key focus immediately selects the\nnew tab. Manual activation moves focus only; Enter or Space selects it:\n\n```html\n<neural-tabs orientation=\"vertical\" activationMode=\"manual\">\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n- Horizontal lists use Left/Right. Their direction follows computed LTR/RTL.\n- Vertical lists use Up/Down.\n- Home and End move to the first and last enabled tab.\n- Navigation wraps and skips disabled tabs.\n- Tab moves through the tablist as one stop using roving `tabindex`.\n\n## Responsive overflow and motion\n\nHorizontal lists scroll naturally when their container becomes narrower than\ntheir tabs. Vertical lists use block-axis overflow when the consumer gives the\nlist a constrained height. Focused tabs remain reachable through native browser\nscrolling; no duplicate navigation buttons are added to the accessibility tree.\n\nStyled tabs use a token-driven active indicator and a short panel-enter motion.\n`prefers-reduced-motion: reduce` disables panel animation and makes indicator\ntransitions effectively immediate. Both behaviors are absent in `unstyled`\nmode and can be replaced by consumer classes.\n\n## Accessibility\n\nThe components implement the WAI-ARIA Tabs pattern with native buttons,\n`tablist`, `tab`, and `tabpanel` roles, linked IDs, `aria-selected`,\n`aria-controls`, and `aria-labelledby`. Give each list an accessible name using\n`ariaLabel` or `ariaLabelledby`.\n\nPanels are focusable by default so keyboard users can enter their content. Set\n`[focusable]=\"false\"` when the panel begins with an appropriate focusable\nelement. Generated IDs are deterministic and SSR/hydration-safe; use `tabsId`\nwhen a stable application-defined prefix is preferred.\n\nIn development builds, NeuralNg warns once per invalid composition signature:\nduplicate tab/panel values, tabs without panels, and panels without tabs. These\ndiagnostics do not run in production builds.\n\n## Class slots and unstyled mode\n\n`tabsClass`, `listClass`, `tabClass`, `panelsClass`, and `panelClass` are\nadditive native-element classes. Typed class slots can style shared parts:\n\n```html\n<neural-tabs\n  unstyled\n  tabsClass=\"my-tabs\"\n  [classes]=\"{\n    list: 'my-list',\n    tab: 'my-tab',\n    activeTab: 'my-tab-active',\n    disabledTab: 'my-tab-disabled',\n    panels: 'my-panels',\n    panel: 'my-panel'\n  }\"\n>\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n`unstyled` removes visual `*-base` classes while retaining structural classes,\nbehavior, and ARIA. Global `provideNeuralNg({ unstyled: true })` is also\nrespected.\n\nThe reference themes expose component tokens under `--neural-tabs-*` and\n`--neural-tab-*`, including list spacing/border, tab colors/backgrounds,\nactive/hover/focus/disabled states, typography, transitions, and panel padding.\nOverride tokens on any ancestor to theme one Tabs instance without replacing\nits class structure.\n\nThe Neutral theme has no tab or list border by default. Opt in with\n`--neural-tab-border` or `--neural-tabs-list-border`. Vertical layouts keep the\nlist and panel visually separate through `--neural-tabs-vertical-gap`.\n\nMotion and overflow tokens include `--neural-tab-indicator-*`,\n`--neural-tab-panel-enter-*`, `--neural-tabs-scrollbar-color`, and\n`--neural-tabs-scrollbar-width`.\n\n## Public inputs\n\n### `neural-tabs`\n\n| Input            | Default        | Purpose                                     |\n| ---------------- | -------------- | ------------------------------------------- |\n| `value`          | `null`         | Active string/number model value            |\n| `orientation`    | `'horizontal'` | Horizontal or vertical keyboard behavior    |\n| `activationMode` | `'automatic'`  | Automatic or manual selection on focus      |\n| `tabsId`         | generated      | ID prefix linking tabs and panels           |\n| `unstyled`       | `false`        | Remove visual classes                       |\n| `tabsClass`      | `''`           | Add classes to the root element             |\n| `classes`        | `{}`           | Typed root/list/tab/state/panel class slots |\n\n### Child components\n\n- `neural-tab-list`: `ariaLabel`, `ariaLabelledby`, `listClass`.\n- `neural-tab`: required `value`; `disabled`, `iconClass`, `tabClass`.\n- `neural-tab-panels`: `panelsClass`.\n- `neural-tab-panel`: required `value`; `focusable`, `panelClass`.\n\nPanel content is eager in the Beta release and inactive panels use the native\n`hidden` state. A lazy rendering API is intentionally deferred until its SSR,\nstate preservation, and accessibility contract is settled.\n",
    "llms": "# NeuralNg Tabs\n\n> Angular 22+ composable Signal tabs at `@neural-ng/core/tabs`.\n\n## Rules\n\n- Import `NeuralTabs`, `NeuralTabList`, `NeuralTab`, `NeuralTabPanels`, and\n  `NeuralTabPanel` from\n  `@neural-ng/core/tabs`; do not create a consumer NgModule.\n- Bind the active string/number value through the `value` model input.\n- Every `neural-tab` value must be unique and match one unique\n  `neural-tab-panel` value.\n- Place tabs inside `neural-tab-list` and panels inside `neural-tab-panels`.\n- Give each tab list an accessible name with `ariaLabel` or `ariaLabelledby`.\n- Use `iconClass=\"nt-user\"` for a concise Neural Icons tab icon. The component\n  adds the `nt` base class when an `nt-*` class is present.\n- Project an `<i aria-hidden=\"true\">` or other markup inside `neural-tab` when\n  the icon needs custom content. Do not set `iconClass` for the same icon.\n- Additional `iconClass` utility classes are preserved. Third-party icon\n  classes are not rewritten.\n- Core Tabs does not depend on `@neural-ng/icons`.\n- `activationMode=\"automatic\"` selects on arrow-key focus. Use `manual` only\n  when panel activation should require Enter or Space.\n- Use `orientation=\"vertical\"` only when the visual list is vertical; this\n  changes both ARIA orientation and keyboard keys.\n- `unstyled` removes visual classes, not structure, behavior, or ARIA.\n- Use `tabsClass`, child local class inputs, or typed `classes` slots for custom\n  styling. Do not query generated IDs for styling.\n- Horizontal overflow is built in. Constrain the Tabs container rather than\n  creating a second, non-semantic tab navigation control.\n- Preserve the `prefers-reduced-motion` behavior when overriding indicator or\n  panel-enter motion.\n- Development builds warn about duplicate and unmatched tab/panel values; fix\n  the composition rather than suppressing the warning.\n- Panel rendering is eager in the Beta release; do not invent a lazy input.\n\n## Canonical example\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">Security</neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nKeyboard behavior follows the WAI-ARIA Tabs pattern: roving `tabindex`,\norientation-aware arrows, Home/End, wrapping, and disabled-tab skipping.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/tab-panel/contract",
      "readme": "neural://components/tab-panel/readme",
      "llms": "neural://components/tab-panel/llms"
    },
    "sourceDirectory": "libs/neural-ng/tabs",
    "readme": "# NeuralNg Tabs v0.1 Beta\n\nComposable, Signal-first and headless-friendly tabs for Angular 22+.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralTab, NeuralTabList, NeuralTabPanel, NeuralTabPanels, NeuralTabs } from '@neural-ng/core/tabs';\n```\n\nAdd the standalone declarations used by the template to the consumer\ncomponent's `imports` array. The former `*Component` names remain deprecated\naliases for migration only.\n\n## Basic usage\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">\n      <i class=\"my-security-icon\" aria-hidden=\"true\"></i>\n      Security\n    </neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nTab and panel values are strings or numbers, must be unique within their group,\nand must match. If `value` is null, invalid, disabled, or removed, the first\nenabled tab becomes active.\n\n## Icons\n\n`iconClass` is a convenience input on `neural-tab`. A Neural Icons name such as\n`nt-user` automatically receives the required `nt` base class:\n\n```html\n<neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n```\n\nMultiple classes, including color utilities, are preserved. Other class-based\nicon systems are not modified. For custom markup, badges, or layered icons,\nproject content directly inside the tab instead. Tabs has no package dependency\non `@neural-ng/icons`.\n\n## Activation and orientation\n\nAutomatic activation is the default. Arrow-key focus immediately selects the\nnew tab. Manual activation moves focus only; Enter or Space selects it:\n\n```html\n<neural-tabs orientation=\"vertical\" activationMode=\"manual\">\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n- Horizontal lists use Left/Right. Their direction follows computed LTR/RTL.\n- Vertical lists use Up/Down.\n- Home and End move to the first and last enabled tab.\n- Navigation wraps and skips disabled tabs.\n- Tab moves through the tablist as one stop using roving `tabindex`.\n\n## Responsive overflow and motion\n\nHorizontal lists scroll naturally when their container becomes narrower than\ntheir tabs. Vertical lists use block-axis overflow when the consumer gives the\nlist a constrained height. Focused tabs remain reachable through native browser\nscrolling; no duplicate navigation buttons are added to the accessibility tree.\n\nStyled tabs use a token-driven active indicator and a short panel-enter motion.\n`prefers-reduced-motion: reduce` disables panel animation and makes indicator\ntransitions effectively immediate. Both behaviors are absent in `unstyled`\nmode and can be replaced by consumer classes.\n\n## Accessibility\n\nThe components implement the WAI-ARIA Tabs pattern with native buttons,\n`tablist`, `tab`, and `tabpanel` roles, linked IDs, `aria-selected`,\n`aria-controls`, and `aria-labelledby`. Give each list an accessible name using\n`ariaLabel` or `ariaLabelledby`.\n\nPanels are focusable by default so keyboard users can enter their content. Set\n`[focusable]=\"false\"` when the panel begins with an appropriate focusable\nelement. Generated IDs are deterministic and SSR/hydration-safe; use `tabsId`\nwhen a stable application-defined prefix is preferred.\n\nIn development builds, NeuralNg warns once per invalid composition signature:\nduplicate tab/panel values, tabs without panels, and panels without tabs. These\ndiagnostics do not run in production builds.\n\n## Class slots and unstyled mode\n\n`tabsClass`, `listClass`, `tabClass`, `panelsClass`, and `panelClass` are\nadditive native-element classes. Typed class slots can style shared parts:\n\n```html\n<neural-tabs\n  unstyled\n  tabsClass=\"my-tabs\"\n  [classes]=\"{\n    list: 'my-list',\n    tab: 'my-tab',\n    activeTab: 'my-tab-active',\n    disabledTab: 'my-tab-disabled',\n    panels: 'my-panels',\n    panel: 'my-panel'\n  }\"\n>\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n`unstyled` removes visual `*-base` classes while retaining structural classes,\nbehavior, and ARIA. Global `provideNeuralNg({ unstyled: true })` is also\nrespected.\n\nThe reference themes expose component tokens under `--neural-tabs-*` and\n`--neural-tab-*`, including list spacing/border, tab colors/backgrounds,\nactive/hover/focus/disabled states, typography, transitions, and panel padding.\nOverride tokens on any ancestor to theme one Tabs instance without replacing\nits class structure.\n\nThe Neutral theme has no tab or list border by default. Opt in with\n`--neural-tab-border` or `--neural-tabs-list-border`. Vertical layouts keep the\nlist and panel visually separate through `--neural-tabs-vertical-gap`.\n\nMotion and overflow tokens include `--neural-tab-indicator-*`,\n`--neural-tab-panel-enter-*`, `--neural-tabs-scrollbar-color`, and\n`--neural-tabs-scrollbar-width`.\n\n## Public inputs\n\n### `neural-tabs`\n\n| Input            | Default        | Purpose                                     |\n| ---------------- | -------------- | ------------------------------------------- |\n| `value`          | `null`         | Active string/number model value            |\n| `orientation`    | `'horizontal'` | Horizontal or vertical keyboard behavior    |\n| `activationMode` | `'automatic'`  | Automatic or manual selection on focus      |\n| `tabsId`         | generated      | ID prefix linking tabs and panels           |\n| `unstyled`       | `false`        | Remove visual classes                       |\n| `tabsClass`      | `''`           | Add classes to the root element             |\n| `classes`        | `{}`           | Typed root/list/tab/state/panel class slots |\n\n### Child components\n\n- `neural-tab-list`: `ariaLabel`, `ariaLabelledby`, `listClass`.\n- `neural-tab`: required `value`; `disabled`, `iconClass`, `tabClass`.\n- `neural-tab-panels`: `panelsClass`.\n- `neural-tab-panel`: required `value`; `focusable`, `panelClass`.\n\nPanel content is eager in the Beta release and inactive panels use the native\n`hidden` state. A lazy rendering API is intentionally deferred until its SSR,\nstate preservation, and accessibility contract is settled.\n",
    "llms": "# NeuralNg Tabs\n\n> Angular 22+ composable Signal tabs at `@neural-ng/core/tabs`.\n\n## Rules\n\n- Import `NeuralTabs`, `NeuralTabList`, `NeuralTab`, `NeuralTabPanels`, and\n  `NeuralTabPanel` from\n  `@neural-ng/core/tabs`; do not create a consumer NgModule.\n- Bind the active string/number value through the `value` model input.\n- Every `neural-tab` value must be unique and match one unique\n  `neural-tab-panel` value.\n- Place tabs inside `neural-tab-list` and panels inside `neural-tab-panels`.\n- Give each tab list an accessible name with `ariaLabel` or `ariaLabelledby`.\n- Use `iconClass=\"nt-user\"` for a concise Neural Icons tab icon. The component\n  adds the `nt` base class when an `nt-*` class is present.\n- Project an `<i aria-hidden=\"true\">` or other markup inside `neural-tab` when\n  the icon needs custom content. Do not set `iconClass` for the same icon.\n- Additional `iconClass` utility classes are preserved. Third-party icon\n  classes are not rewritten.\n- Core Tabs does not depend on `@neural-ng/icons`.\n- `activationMode=\"automatic\"` selects on arrow-key focus. Use `manual` only\n  when panel activation should require Enter or Space.\n- Use `orientation=\"vertical\"` only when the visual list is vertical; this\n  changes both ARIA orientation and keyboard keys.\n- `unstyled` removes visual classes, not structure, behavior, or ARIA.\n- Use `tabsClass`, child local class inputs, or typed `classes` slots for custom\n  styling. Do not query generated IDs for styling.\n- Horizontal overflow is built in. Constrain the Tabs container rather than\n  creating a second, non-semantic tab navigation control.\n- Preserve the `prefers-reduced-motion` behavior when overriding indicator or\n  panel-enter motion.\n- Development builds warn about duplicate and unmatched tab/panel values; fix\n  the composition rather than suppressing the warning.\n- Panel rendering is eager in the Beta release; do not invent a lazy input.\n\n## Canonical example\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">Security</neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nKeyboard behavior follows the WAI-ARIA Tabs pattern: roving `tabindex`,\norientation-aware arrows, Home/End, wrapping, and disabled-tab skipping.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/tab-panels/contract",
      "readme": "neural://components/tab-panels/readme",
      "llms": "neural://components/tab-panels/llms"
    },
    "sourceDirectory": "libs/neural-ng/tabs",
    "readme": "# NeuralNg Tabs v0.1 Beta\n\nComposable, Signal-first and headless-friendly tabs for Angular 22+.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralTab, NeuralTabList, NeuralTabPanel, NeuralTabPanels, NeuralTabs } from '@neural-ng/core/tabs';\n```\n\nAdd the standalone declarations used by the template to the consumer\ncomponent's `imports` array. The former `*Component` names remain deprecated\naliases for migration only.\n\n## Basic usage\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">\n      <i class=\"my-security-icon\" aria-hidden=\"true\"></i>\n      Security\n    </neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nTab and panel values are strings or numbers, must be unique within their group,\nand must match. If `value` is null, invalid, disabled, or removed, the first\nenabled tab becomes active.\n\n## Icons\n\n`iconClass` is a convenience input on `neural-tab`. A Neural Icons name such as\n`nt-user` automatically receives the required `nt` base class:\n\n```html\n<neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n```\n\nMultiple classes, including color utilities, are preserved. Other class-based\nicon systems are not modified. For custom markup, badges, or layered icons,\nproject content directly inside the tab instead. Tabs has no package dependency\non `@neural-ng/icons`.\n\n## Activation and orientation\n\nAutomatic activation is the default. Arrow-key focus immediately selects the\nnew tab. Manual activation moves focus only; Enter or Space selects it:\n\n```html\n<neural-tabs orientation=\"vertical\" activationMode=\"manual\">\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n- Horizontal lists use Left/Right. Their direction follows computed LTR/RTL.\n- Vertical lists use Up/Down.\n- Home and End move to the first and last enabled tab.\n- Navigation wraps and skips disabled tabs.\n- Tab moves through the tablist as one stop using roving `tabindex`.\n\n## Responsive overflow and motion\n\nHorizontal lists scroll naturally when their container becomes narrower than\ntheir tabs. Vertical lists use block-axis overflow when the consumer gives the\nlist a constrained height. Focused tabs remain reachable through native browser\nscrolling; no duplicate navigation buttons are added to the accessibility tree.\n\nStyled tabs use a token-driven active indicator and a short panel-enter motion.\n`prefers-reduced-motion: reduce` disables panel animation and makes indicator\ntransitions effectively immediate. Both behaviors are absent in `unstyled`\nmode and can be replaced by consumer classes.\n\n## Accessibility\n\nThe components implement the WAI-ARIA Tabs pattern with native buttons,\n`tablist`, `tab`, and `tabpanel` roles, linked IDs, `aria-selected`,\n`aria-controls`, and `aria-labelledby`. Give each list an accessible name using\n`ariaLabel` or `ariaLabelledby`.\n\nPanels are focusable by default so keyboard users can enter their content. Set\n`[focusable]=\"false\"` when the panel begins with an appropriate focusable\nelement. Generated IDs are deterministic and SSR/hydration-safe; use `tabsId`\nwhen a stable application-defined prefix is preferred.\n\nIn development builds, NeuralNg warns once per invalid composition signature:\nduplicate tab/panel values, tabs without panels, and panels without tabs. These\ndiagnostics do not run in production builds.\n\n## Class slots and unstyled mode\n\n`tabsClass`, `listClass`, `tabClass`, `panelsClass`, and `panelClass` are\nadditive native-element classes. Typed class slots can style shared parts:\n\n```html\n<neural-tabs\n  unstyled\n  tabsClass=\"my-tabs\"\n  [classes]=\"{\n    list: 'my-list',\n    tab: 'my-tab',\n    activeTab: 'my-tab-active',\n    disabledTab: 'my-tab-disabled',\n    panels: 'my-panels',\n    panel: 'my-panel'\n  }\"\n>\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n`unstyled` removes visual `*-base` classes while retaining structural classes,\nbehavior, and ARIA. Global `provideNeuralNg({ unstyled: true })` is also\nrespected.\n\nThe reference themes expose component tokens under `--neural-tabs-*` and\n`--neural-tab-*`, including list spacing/border, tab colors/backgrounds,\nactive/hover/focus/disabled states, typography, transitions, and panel padding.\nOverride tokens on any ancestor to theme one Tabs instance without replacing\nits class structure.\n\nThe Neutral theme has no tab or list border by default. Opt in with\n`--neural-tab-border` or `--neural-tabs-list-border`. Vertical layouts keep the\nlist and panel visually separate through `--neural-tabs-vertical-gap`.\n\nMotion and overflow tokens include `--neural-tab-indicator-*`,\n`--neural-tab-panel-enter-*`, `--neural-tabs-scrollbar-color`, and\n`--neural-tabs-scrollbar-width`.\n\n## Public inputs\n\n### `neural-tabs`\n\n| Input            | Default        | Purpose                                     |\n| ---------------- | -------------- | ------------------------------------------- |\n| `value`          | `null`         | Active string/number model value            |\n| `orientation`    | `'horizontal'` | Horizontal or vertical keyboard behavior    |\n| `activationMode` | `'automatic'`  | Automatic or manual selection on focus      |\n| `tabsId`         | generated      | ID prefix linking tabs and panels           |\n| `unstyled`       | `false`        | Remove visual classes                       |\n| `tabsClass`      | `''`           | Add classes to the root element             |\n| `classes`        | `{}`           | Typed root/list/tab/state/panel class slots |\n\n### Child components\n\n- `neural-tab-list`: `ariaLabel`, `ariaLabelledby`, `listClass`.\n- `neural-tab`: required `value`; `disabled`, `iconClass`, `tabClass`.\n- `neural-tab-panels`: `panelsClass`.\n- `neural-tab-panel`: required `value`; `focusable`, `panelClass`.\n\nPanel content is eager in the Beta release and inactive panels use the native\n`hidden` state. A lazy rendering API is intentionally deferred until its SSR,\nstate preservation, and accessibility contract is settled.\n",
    "llms": "# NeuralNg Tabs\n\n> Angular 22+ composable Signal tabs at `@neural-ng/core/tabs`.\n\n## Rules\n\n- Import `NeuralTabs`, `NeuralTabList`, `NeuralTab`, `NeuralTabPanels`, and\n  `NeuralTabPanel` from\n  `@neural-ng/core/tabs`; do not create a consumer NgModule.\n- Bind the active string/number value through the `value` model input.\n- Every `neural-tab` value must be unique and match one unique\n  `neural-tab-panel` value.\n- Place tabs inside `neural-tab-list` and panels inside `neural-tab-panels`.\n- Give each tab list an accessible name with `ariaLabel` or `ariaLabelledby`.\n- Use `iconClass=\"nt-user\"` for a concise Neural Icons tab icon. The component\n  adds the `nt` base class when an `nt-*` class is present.\n- Project an `<i aria-hidden=\"true\">` or other markup inside `neural-tab` when\n  the icon needs custom content. Do not set `iconClass` for the same icon.\n- Additional `iconClass` utility classes are preserved. Third-party icon\n  classes are not rewritten.\n- Core Tabs does not depend on `@neural-ng/icons`.\n- `activationMode=\"automatic\"` selects on arrow-key focus. Use `manual` only\n  when panel activation should require Enter or Space.\n- Use `orientation=\"vertical\"` only when the visual list is vertical; this\n  changes both ARIA orientation and keyboard keys.\n- `unstyled` removes visual classes, not structure, behavior, or ARIA.\n- Use `tabsClass`, child local class inputs, or typed `classes` slots for custom\n  styling. Do not query generated IDs for styling.\n- Horizontal overflow is built in. Constrain the Tabs container rather than\n  creating a second, non-semantic tab navigation control.\n- Preserve the `prefers-reduced-motion` behavior when overriding indicator or\n  panel-enter motion.\n- Development builds warn about duplicate and unmatched tab/panel values; fix\n  the composition rather than suppressing the warning.\n- Panel rendering is eager in the Beta release; do not invent a lazy input.\n\n## Canonical example\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">Security</neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nKeyboard behavior follows the WAI-ARIA Tabs pattern: roving `tabindex`,\norientation-aware arrows, Home/End, wrapping, and disabled-tab skipping.\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/tabs/contract",
      "readme": "neural://components/tabs/readme",
      "llms": "neural://components/tabs/llms"
    },
    "sourceDirectory": "libs/neural-ng/tabs",
    "readme": "# NeuralNg Tabs v0.1 Beta\n\nComposable, Signal-first and headless-friendly tabs for Angular 22+.\n\nCurrent component maturity: `beta`.\n\n## Import\n\n```ts\nimport { NeuralTab, NeuralTabList, NeuralTabPanel, NeuralTabPanels, NeuralTabs } from '@neural-ng/core/tabs';\n```\n\nAdd the standalone declarations used by the template to the consumer\ncomponent's `imports` array. The former `*Component` names remain deprecated\naliases for migration only.\n\n## Basic usage\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">\n      <i class=\"my-security-icon\" aria-hidden=\"true\"></i>\n      Security\n    </neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nTab and panel values are strings or numbers, must be unique within their group,\nand must match. If `value` is null, invalid, disabled, or removed, the first\nenabled tab becomes active.\n\n## Icons\n\n`iconClass` is a convenience input on `neural-tab`. A Neural Icons name such as\n`nt-user` automatically receives the required `nt` base class:\n\n```html\n<neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n```\n\nMultiple classes, including color utilities, are preserved. Other class-based\nicon systems are not modified. For custom markup, badges, or layered icons,\nproject content directly inside the tab instead. Tabs has no package dependency\non `@neural-ng/icons`.\n\n## Activation and orientation\n\nAutomatic activation is the default. Arrow-key focus immediately selects the\nnew tab. Manual activation moves focus only; Enter or Space selects it:\n\n```html\n<neural-tabs orientation=\"vertical\" activationMode=\"manual\">\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n- Horizontal lists use Left/Right. Their direction follows computed LTR/RTL.\n- Vertical lists use Up/Down.\n- Home and End move to the first and last enabled tab.\n- Navigation wraps and skips disabled tabs.\n- Tab moves through the tablist as one stop using roving `tabindex`.\n\n## Responsive overflow and motion\n\nHorizontal lists scroll naturally when their container becomes narrower than\ntheir tabs. Vertical lists use block-axis overflow when the consumer gives the\nlist a constrained height. Focused tabs remain reachable through native browser\nscrolling; no duplicate navigation buttons are added to the accessibility tree.\n\nStyled tabs use a token-driven active indicator and a short panel-enter motion.\n`prefers-reduced-motion: reduce` disables panel animation and makes indicator\ntransitions effectively immediate. Both behaviors are absent in `unstyled`\nmode and can be replaced by consumer classes.\n\n## Accessibility\n\nThe components implement the WAI-ARIA Tabs pattern with native buttons,\n`tablist`, `tab`, and `tabpanel` roles, linked IDs, `aria-selected`,\n`aria-controls`, and `aria-labelledby`. Give each list an accessible name using\n`ariaLabel` or `ariaLabelledby`.\n\nPanels are focusable by default so keyboard users can enter their content. Set\n`[focusable]=\"false\"` when the panel begins with an appropriate focusable\nelement. Generated IDs are deterministic and SSR/hydration-safe; use `tabsId`\nwhen a stable application-defined prefix is preferred.\n\nIn development builds, NeuralNg warns once per invalid composition signature:\nduplicate tab/panel values, tabs without panels, and panels without tabs. These\ndiagnostics do not run in production builds.\n\n## Class slots and unstyled mode\n\n`tabsClass`, `listClass`, `tabClass`, `panelsClass`, and `panelClass` are\nadditive native-element classes. Typed class slots can style shared parts:\n\n```html\n<neural-tabs\n  unstyled\n  tabsClass=\"my-tabs\"\n  [classes]=\"{\n    list: 'my-list',\n    tab: 'my-tab',\n    activeTab: 'my-tab-active',\n    disabledTab: 'my-tab-disabled',\n    panels: 'my-panels',\n    panel: 'my-panel'\n  }\"\n>\n  <!-- list and panels -->\n</neural-tabs>\n```\n\n`unstyled` removes visual `*-base` classes while retaining structural classes,\nbehavior, and ARIA. Global `provideNeuralNg({ unstyled: true })` is also\nrespected.\n\nThe reference themes expose component tokens under `--neural-tabs-*` and\n`--neural-tab-*`, including list spacing/border, tab colors/backgrounds,\nactive/hover/focus/disabled states, typography, transitions, and panel padding.\nOverride tokens on any ancestor to theme one Tabs instance without replacing\nits class structure.\n\nThe Neutral theme has no tab or list border by default. Opt in with\n`--neural-tab-border` or `--neural-tabs-list-border`. Vertical layouts keep the\nlist and panel visually separate through `--neural-tabs-vertical-gap`.\n\nMotion and overflow tokens include `--neural-tab-indicator-*`,\n`--neural-tab-panel-enter-*`, `--neural-tabs-scrollbar-color`, and\n`--neural-tabs-scrollbar-width`.\n\n## Public inputs\n\n### `neural-tabs`\n\n| Input            | Default        | Purpose                                     |\n| ---------------- | -------------- | ------------------------------------------- |\n| `value`          | `null`         | Active string/number model value            |\n| `orientation`    | `'horizontal'` | Horizontal or vertical keyboard behavior    |\n| `activationMode` | `'automatic'`  | Automatic or manual selection on focus      |\n| `tabsId`         | generated      | ID prefix linking tabs and panels           |\n| `unstyled`       | `false`        | Remove visual classes                       |\n| `tabsClass`      | `''`           | Add classes to the root element             |\n| `classes`        | `{}`           | Typed root/list/tab/state/panel class slots |\n\n### Child components\n\n- `neural-tab-list`: `ariaLabel`, `ariaLabelledby`, `listClass`.\n- `neural-tab`: required `value`; `disabled`, `iconClass`, `tabClass`.\n- `neural-tab-panels`: `panelsClass`.\n- `neural-tab-panel`: required `value`; `focusable`, `panelClass`.\n\nPanel content is eager in the Beta release and inactive panels use the native\n`hidden` state. A lazy rendering API is intentionally deferred until its SSR,\nstate preservation, and accessibility contract is settled.\n",
    "llms": "# NeuralNg Tabs\n\n> Angular 22+ composable Signal tabs at `@neural-ng/core/tabs`.\n\n## Rules\n\n- Import `NeuralTabs`, `NeuralTabList`, `NeuralTab`, `NeuralTabPanels`, and\n  `NeuralTabPanel` from\n  `@neural-ng/core/tabs`; do not create a consumer NgModule.\n- Bind the active string/number value through the `value` model input.\n- Every `neural-tab` value must be unique and match one unique\n  `neural-tab-panel` value.\n- Place tabs inside `neural-tab-list` and panels inside `neural-tab-panels`.\n- Give each tab list an accessible name with `ariaLabel` or `ariaLabelledby`.\n- Use `iconClass=\"nt-user\"` for a concise Neural Icons tab icon. The component\n  adds the `nt` base class when an `nt-*` class is present.\n- Project an `<i aria-hidden=\"true\">` or other markup inside `neural-tab` when\n  the icon needs custom content. Do not set `iconClass` for the same icon.\n- Additional `iconClass` utility classes are preserved. Third-party icon\n  classes are not rewritten.\n- Core Tabs does not depend on `@neural-ng/icons`.\n- `activationMode=\"automatic\"` selects on arrow-key focus. Use `manual` only\n  when panel activation should require Enter or Space.\n- Use `orientation=\"vertical\"` only when the visual list is vertical; this\n  changes both ARIA orientation and keyboard keys.\n- `unstyled` removes visual classes, not structure, behavior, or ARIA.\n- Use `tabsClass`, child local class inputs, or typed `classes` slots for custom\n  styling. Do not query generated IDs for styling.\n- Horizontal overflow is built in. Constrain the Tabs container rather than\n  creating a second, non-semantic tab navigation control.\n- Preserve the `prefers-reduced-motion` behavior when overriding indicator or\n  panel-enter motion.\n- Development builds warn about duplicate and unmatched tab/panel values; fix\n  the composition rather than suppressing the warning.\n- Panel rendering is eager in the Beta release; do not invent a lazy input.\n\n## Canonical example\n\n```ts\nreadonly activeTab = signal<string | number | null>('profile');\n```\n\n```html\n<neural-tabs [(value)]=\"activeTab\">\n  <neural-tab-list ariaLabel=\"Account sections\">\n    <neural-tab value=\"profile\" iconClass=\"nt-user\">Profile</neural-tab>\n    <neural-tab value=\"security\">Security</neural-tab>\n    <neural-tab value=\"billing\" disabled>Billing</neural-tab>\n  </neural-tab-list>\n  <neural-tab-panels>\n    <neural-tab-panel value=\"profile\">Profile content</neural-tab-panel>\n    <neural-tab-panel value=\"security\">Security content</neural-tab-panel>\n    <neural-tab-panel value=\"billing\">Billing content</neural-tab-panel>\n  </neural-tab-panels>\n</neural-tabs>\n```\n\nKeyboard behavior follows the WAI-ARIA Tabs pattern: roving `tabindex`,\norientation-aware arrows, Home/End, wrapping, and disabled-tab skipping.\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/tag/readme",
      "llms": "neural://components/tag/llms"
    },
    "sourceDirectory": "libs/neural-ng/tag",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/toast/contract",
      "readme": "neural://components/toast/readme",
      "llms": "neural://components/toast/llms"
    },
    "sourceDirectory": "libs/neural-ng/toast",
    "readme": "# NeuralNg Toast v0.1 Beta\n\nModern Angular 22+ Toast renderer for the headless Signal store in\n`@neural-ng/core/message`. Toast is standalone, SSR-safe, direction-aware,\nthemeable, and fully consumer-stylable.\n\nCurrent component maturity: `beta`.\n\n## Setup\n\nRegister the Message API once. Toast configuration is optional:\n\n```ts\nimport { ApplicationConfig } from '@angular/core';\nimport { provideNeuralNg } from '@neural-ng/core';\nimport { provideNeuralMessages } from '@neural-ng/core/message';\nimport { provideNeuralToast } from '@neural-ng/core/toast';\n\nexport const appConfig: ApplicationConfig = {\n  providers: [\n    provideNeuralNg({ unstyled: false }),\n    provideNeuralMessages(),\n    provideNeuralToast({\n      position: 'top-end',\n      showProgress: true,\n    }),\n  ],\n};\n```\n\n`provideNeuralNg()` and `provideNeuralToast()` may be omitted when their defaults\nare sufficient. `provideNeuralMessages()` is required because it owns notification\nstate.\n\nImport the standalone renderer:\n\n```ts\nimport { Component } from '@angular/core';\nimport { NeuralToast } from '@neural-ng/core/toast';\n\n@Component({\n  imports: [NeuralToast],\n  template: `<neural-toast />`,\n})\nexport class App {}\n```\n\nThe zero-configuration form renders the `global` channel at `top-end`:\n\n```html\n<neural-toast />\n```\n\n## Send messages\n\n```ts\nimport { Component, inject } from '@angular/core';\nimport { NeuralMessageService } from '@neural-ng/core/message';\n\n@Component({\n  /* ... */\n})\nexport class SaveAction {\n  private readonly messages = inject(NeuralMessageService);\n\n  save(): void {\n    this.messages.notify({\n      severity: 'success',\n      title: 'Saved',\n      message: 'Your changes are ready.',\n    });\n  }\n}\n```\n\nButton and Toast are intentionally decoupled. Call MessageService from a Button\n`clicked` handler or application service; Button never creates notifications by\nitself.\n\n## Inputs and defaults\n\nComponent inputs override `provideNeuralToast()`, which overrides library defaults.\nGlobal `provideNeuralNg({ unstyled: true })` forces all participating components\ninto unstyled mode.\n\n| Input                | Effective default          | Purpose                                           |\n| -------------------- | -------------------------- | ------------------------------------------------- |\n| `channel`            | `'global'`                 | Renders only this Message channel.                |\n| `position`           | `'top-end'`                | Selects one of nine logical viewport positions.   |\n| `ariaLabel`          | `'Notifications'`          | Labels the Toast region.                          |\n| `closeLabel`         | `'Close notification'`     | Prefix for native close-button labels.            |\n| `toastClass`         | `''`                       | Adds classes to the fixed outlet.                 |\n| `messageClass`       | `''`                       | Adds classes to every rendered message.           |\n| `icon`               | `true`                     | Shows the default message icon.                   |\n| `iconClass`          | automatic by severity      | Overrides the icon class on every message.        |\n| `unstyled`           | global value, then `false` | Removes built-in visual classes and animation.    |\n| `pauseOnInteraction` | `true`                     | Pauses finite timers on hover, focus, or swipe.   |\n| `showProgress`       | `false`                    | Shows a duration-synchronized progress bar.       |\n| `swipeToDismiss`     | `true`                     | Allows touch/pen horizontal dismissal.            |\n| `swipeThreshold`     | `72`                       | Required horizontal swipe distance in CSS pixels. |\n| `animated`           | `true`                     | Enables modern enter/leave classes.               |\n\nBoolean inputs support attribute syntax:\n\n```html\n<neural-toast showProgress />\n<neural-toast [swipeToDismiss]=\"false\" />\n<neural-toast [icon]=\"false\" />\n<neural-toast unstyled />\n```\n\nInvalid empty channels, labels, positions, or non-positive swipe thresholds fail\nearly with a descriptive error.\n\n## Positions and channels\n\nPositions use logical `start` and `end` and therefore follow document direction:\n\n- `top-start`, `top-center`, `top-end`\n- `middle-start`, `middle-center`, `middle-end`\n- `bottom-start`, `bottom-center`, `bottom-end`\n\n```html\n<neural-toast channel=\"billing\" position=\"middle-center\" /> <neural-toast channel=\"uploads\" position=\"bottom-start\" />\n```\n\nUse one outlet per channel. Development mode warns when multiple outlets render the\nsame channel.\n\n## Global and headless styling\n\nEnable unstyled mode application-wide:\n\n```ts\nprovideNeuralNg({ unstyled: true });\n```\n\nOr enable it for one Toast:\n\n```html\n<neural-toast unstyled toastClass=\"fixed right-4 top-4 grid gap-3\" messageClass=\"grid bg-slate-950 text-white\" />\n```\n\n`unstyled` removes built-in visual message, close, progress, and animation styles.\nIt preserves state, channel filtering, positioning hooks, timers, swipe, native\ncontrols, live regions, and dismissal behavior.\n\n## Type-safe custom template\n\nImport both standalone declarations when using a template:\n\n```ts\nimport { NeuralToast, NeuralToastTemplateDirective } from '@neural-ng/core/toast';\n\n@Component({\n  imports: [NeuralToast, NeuralToastTemplateDirective],\n})\nexport class App {}\n```\n\n```html\n<neural-toast channel=\"custom\">\n  <ng-template neuralToastTemplate let-message let-dismiss=\"dismiss\" let-paused=\"paused\" let-remaining=\"remaining\" let-progress=\"progress\">\n    <article class=\"my-toast\">\n      <strong>{{ message.title }}</strong>\n      <span>{{ message.message }}</span>\n      <span>{{ progress === null ? 'Persistent' : progress }}</span>\n      <button type=\"button\" (click)=\"dismiss()\">Close</button>\n    </article>\n  </ng-template>\n</neural-toast>\n```\n\n`NeuralToastTemplateContext` exposes:\n\n| Property               | Type                  | Meaning                                       |\n| ---------------------- | --------------------- | --------------------------------------------- |\n| `$implicit`, `message` | `NeuralMessageRecord` | Current immutable message.                    |\n| `dismiss`              | `() => void`          | Dismisses with reason `user`.                 |\n| `paused`               | `boolean`             | Current interaction pause state.              |\n| `remaining`            | `number \\| null`      | Remaining milliseconds at context evaluation. |\n| `progress`             | `number \\| null`      | Remaining ratio from `0` to `1`.              |\n\nThe template replaces default message content, not the structural outlet, timer,\nanimation, swipe, or accessibility infrastructure.\n\n## Lifetime, progress, and interaction\n\n- Finite timers start only after browser rendering.\n- Timer completion dismisses with reason `timeout`.\n- Hover, keyboard focus, and an active swipe pause all finite timers together.\n- Resume continues from the actual remaining duration.\n- `duration: null` is persistent and has no progress bar.\n- `pauseOnInteraction=\"false\"` disables interaction pausing.\n- Progress uses the same duration and pause state as the JavaScript timer.\n\nHorizontal touch or pen gestures use Pointer Events and pointer capture. Vertical\npage scrolling remains available through `touch-action: pan-y`. Swipe never dismisses\na message whose `dismissible` value is false.\n\n## Animation\n\nToast v0.1 uses Angular's compiler-native `animate.enter` and `animate.leave` with\nnative CSS keyframes. It does not import the deprecated `@angular/animations`\npackage and does not require `provideAnimations()`.\n\nAnimation direction follows Toast position. CSS respects\n`prefers-reduced-motion: reduce`. Disable per outlet when required:\n\n```html\n<neural-toast [animated]=\"false\" />\n```\n\n## Accessibility\n\n- Polite and assertive live regions exist before messages are inserted.\n- `neutral`, `info`, and `success` are announced politely.\n- `warning` and `error` are announced assertively.\n- Toast never moves focus automatically.\n- The default close control is a native `button` with a localized label.\n- Focus and hover pause finite content so users have more reading time.\n- Persistent messages are supported with `duration: null`.\n- Development mode warns about `duration: null` plus `dismissible: false`, because\n  that message can only be removed through MessageService.\n\n## SSR, hydration, mobile, and RTL\n\n- Browser timers and outlet registration start with `afterNextRender`.\n- No browser global is read during server rendering.\n- Logical CSS positions support RTL without a second position API.\n- Mobile width adapts below 40rem.\n- Insets include CSS safe-area environment values for notched devices.\n\n## Theme tokens\n\nImport the stable neutral theme once:\n\n```css\n@import '@neural-ng/core/themes/neutral.css';\n```\n\nToast tokens include size, inset, stack gap, severity-tinted surfaces, borders, accents,\nfocus ring, progress track, enter/leave duration, and swipe reset duration. Glass\nand Futuristic remain experimental token-only overrides. All included themes\nrespond to the independent `data-neural-mode=\"light|dark\"` contract.\n\n## Icons\n\nToast shows a decorative severity icon by default:\n\n| Severity  | Default class          |\n| --------- | ---------------------- |\n| primary   | `nt nt-settings`       |\n| secondary | `nt nt-bell`           |\n| neutral   | `nt nt-bell`           |\n| info      | `nt nt-info-circle`    |\n| success   | `nt nt-circle-check`   |\n| warning   | `nt nt-alert-triangle` |\n| error     | `nt nt-circle-times`   |\n\nInstall and import the optional Neural Icons package to render the defaults:\n\n```sh\nnpm install @neural-ng/icons\n```\n\n```css\n@import '@neural-ng/icons/icons.css';\n```\n\nDisable the icon or replace it per outlet:\n\n```html\n<neural-toast [icon]=\"false\" />\n<neural-toast iconClass=\"nt-user\" />\n<neural-toast iconClass=\"pi pi-info-circle\" />\n```\n\nWhen `iconClass` starts with an `nt-*` class, Toast adds the required `nt` base\nclass automatically. Other class systems remain unchanged. Icons are\n`aria-hidden`; live-region announcements continue to use the message text.\nCustom `neuralToastTemplate` content owns its complete visual structure, so the\ntwo icon inputs do not inject content into a custom template.\n",
    "llms": "# NeuralNg Toast v0.1 Beta - AI Context\n\nCurrent component maturity: beta.\n\nPackage: @neural-ng/core/toast\nAngular: 22+\nArchitecture: standalone, Signals, SSR/hydration-safe, headless-capable\nState dependency: @neural-ng/core/message\n\n## Required generation rules\n\n1. Register provideNeuralMessages() in ApplicationConfig.\n2. Import NeuralToast from @neural-ng/core/toast.\n3. Add <neural-toast /> once for the global channel.\n4. Inject NeuralMessageService from @neural-ng/core/message to send messages.\n5. Do not make Button depend on Message or Toast. Call notify() in application code.\n6. Do not import BrowserAnimationsModule, provideAnimations(), or @angular/animations.\n7. Do not invent left/right positions. Use logical start/end positions.\n8. Use one Toast outlet per channel.\n\n## Zero-config usage\n\n<neural-toast />\n\nEffective defaults:\n- channel: global\n- position: top-end\n- ariaLabel: Notifications\n- closeLabel: Close notification\n- toastClass: empty\n- messageClass: empty\n- icon: true\n- iconClass: automatic by severity\n- unstyled: false, unless global unstyled is true\n- pauseOnInteraction: true\n- showProgress: false\n- swipeToDismiss: true\n- swipeThreshold: 72\n- animated: true\n\n## Providers\n\n- provideNeuralMessages() is required.\n- provideNeuralNg({ unstyled: true }) is optional and affects Button, Toast, and future participating components.\n- provideNeuralToast(options) is optional and defines application-level Toast defaults.\n- Component inputs override provideNeuralToast values.\n- Global unstyled=true forces visual classes off.\n\n## Positions\n\nAllowed values only:\n- top-start, top-center, top-end\n- middle-start, middle-center, middle-end\n- bottom-start, bottom-center, bottom-end\n\n## Styling and unstyled\n\n- toastClass is additive on the fixed outlet.\n- messageClass is additive on every message article.\n- <neural-toast unstyled /> is valid boolean attribute syntax.\n- unstyled removes built-in visual message, close, progress, and animation styling.\n- unstyled preserves structure, position hooks, state, timers, swipe, ARIA, and dismissal.\n- Prefer CSS custom properties for themed usage and consumer classes for full ownership.\n- Treat `data-neural-theme` and resolved `data-neural-mode=\"light|dark\"` as independent selectors.\n\n## Icons\n\n- icon=true renders a decorative severity icon in the default template.\n- Styled messages tint their background, border, content, icon, close control,\n  and progress treatment from the selected severity; severity is not only a\n  leading-border accent.\n- Default classes are primary=nt-settings, secondary=nt-bell, neutral=nt-bell,\n  info=nt-info-circle, success=nt-circle-check, warning=nt-alert-triangle,\n  error=nt-circle-times.\n- Set `[icon]=\"false\"` to remove the icon and collapse the layout correctly.\n- `iconClass=\"nt-user\"` overrides every severity and automatically receives the\n  required `nt` base class.\n- Third-party values such as `iconClass=\"pi pi-user\"` remain unchanged.\n- Default Neural icon artwork requires the optional `@neural-ng/icons`\n  stylesheet. Core behavior must continue without that package.\n- A custom `neuralToastTemplate` owns its content and does not receive the\n  default icon element.\n\n## Custom template\n\nImport NeuralToastTemplateDirective alongside NeuralToast.\n\n```html\n<neural-toast channel=\"custom\">\n  <ng-template\n    neuralToastTemplate\n    let-message\n    let-dismiss=\"dismiss\"\n    let-paused=\"paused\"\n    let-remaining=\"remaining\"\n    let-progress=\"progress\"\n  >\n    <div>{{ message.message }}</div>\n    <button type=\"button\" (click)=\"dismiss()\">Close</button>\n  </ng-template>\n</neural-toast>\n```\n\nContext:\n- $implicit/message: immutable NeuralMessageRecord\n- dismiss(): closes with user reason\n- paused: boolean\n- remaining: milliseconds or null\n- progress: remaining ratio or null\n\nDo not wrap neuralToastTemplate on a non-ng-template element.\n\n## Timer and interaction rules\n\n- duration:null is persistent.\n- Finite durations are owned by Toast and close with timeout reason.\n- Hover, focus, and swipe pause finite timers when pauseOnInteraction is true.\n- Resume uses remaining time; it does not restart the full duration.\n- Progress is shown only when showProgress=true and duration is finite.\n- Touch/pen horizontal swipe dismisses only dismissible messages.\n- Vertical scrolling remains available.\n\n## Animation rules\n\n- Use Angular compiler-native animate.enter and animate.leave with CSS.\n- Do not use legacy Angular animation triggers/providers.\n- animated=false disables built-in enter/leave classes.\n- unstyled=true also removes built-in animation classes.\n- Respect prefers-reduced-motion.\n\n## Accessibility rules\n\n- Keep stable polite and assertive live regions in the DOM.\n- neutral/info/success announce politely.\n- warning/error announce assertively.\n- Never move focus automatically.\n- Keep the default close control a native button.\n- Localize ariaLabel and closeLabel when the application language requires it.\n- Avoid duration:null plus dismissible:false unless application code will clear it.\n\n## SSR and layout rules\n\n- Start browser work with afterNextRender.\n- Never read window, document, Element, or browser timers during server rendering.\n- Preserve logical start/end CSS and safe-area insets.\n- Do not create a second Toast for the same channel.\n\n## Canonical example\n\n```ts\nimport { ApplicationConfig, Component, inject } from '@angular/core';\nimport { provideNeuralMessages, NeuralMessageService } from '@neural-ng/core/message';\nimport { provideNeuralToast, NeuralToast } from '@neural-ng/core/toast';\n\nexport const appConfig: ApplicationConfig = {\n  providers: [\n    provideNeuralMessages(),\n    provideNeuralToast({ showProgress: true }),\n  ],\n};\n\n@Component({\n  selector: 'app-root',\n  imports: [NeuralToast],\n  template: `<neural-toast />`,\n})\nexport class App {\n  private readonly messages = inject(NeuralMessageService);\n\n  showSuccess(): void {\n    this.messages.notify({\n      severity: 'success',\n      title: 'Saved',\n      message: 'Changes saved.',\n    });\n  }\n}\n```\n"
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/toolbar-center/contract",
      "readme": "neural://components/toolbar-center/readme",
      "llms": "neural://components/toolbar-center/llms"
    },
    "sourceDirectory": "libs/neural-ng/toolbar",
    "readme": "# NeuralNg Toolbar\n\nAccessible, standalone action grouping for Angular 22+.\n\n**Beta status:** the documented contract is ready for application-level\nvalidation. Beta consumers should still pin an exact version until stable.\n\n```ts\nimport { NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, NeuralToolbarSeparator } from '@neural-ng/core/toolbar';\n```\n\n```html\n<neural-toolbar ariaLabel=\"Editor actions\">\n  <neural-toolbar-start>...</neural-toolbar-start>\n  <neural-toolbar-separator />\n  <neural-toolbar-center>...</neural-toolbar-center>\n  <neural-toolbar-end>...</neural-toolbar-end>\n</neural-toolbar>\n```\n\nToolbar uses `role=\"toolbar\"`, one roving tab stop, Arrow/Home/End navigation,\ndisabled-item skipping, RTL-aware horizontal arrows, and focus restoration of\nconsumer tabindex values on destroy. Use `orientation=\"vertical\"` for vertical\ntoolbars. `wrap`, `loop`, and `rovingFocus` are configurable.\n\n`ariaLabelledby` takes precedence over `ariaLabel`. The `focusChanged` output\nemits the focused index, element, and native keyboard or focus event. Editable\ncontrols keep their native arrow-key behavior. Dynamic projected controls are\nresynchronized without leaking the internal MutationObserver.\n\nStart, center, and end sections accept `sectionClass`; the separator accepts\n`separatorClass`. Root-level `toolbarClass` and typed `classes` slots are both\navailable for the internal semantic elements.\n\nLocal/global `unstyled` removes NeuralNg visual classes while structural hooks\nand typed `NeuralToolbarClasses` slots remain.\n\nThe former `Toolbar*Component` exports remain deprecated compatibility aliases.\nNew code should use the canonical `NeuralToolbar*` names.\n",
    "llms": "# @neural-ng/core/toolbar\n\n- Import NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, and NeuralToolbarSeparator from `@neural-ng/core/toolbar`. Toolbar*Component names are deprecated compatibility aliases.\n- Use one `neural-toolbar` with start, center, and end projected sections.\n- Add `neural-toolbar-separator` between related action groups.\n- Always provide a meaningful `ariaLabel` or `ariaLabelledby`.\n- Orientation is `horizontal` by default; use `vertical` when controls stack.\n- Arrow keys follow orientation. Horizontal ArrowLeft/ArrowRight mirror in RTL. Home/End move to edges.\n- Roving focus skips disabled and aria-disabled controls and restores consumer tabindex values on destroy.\n- focusChanged emits index, element, and nativeEvent after pointer, Tab, or directional focus changes.\n- Editable input, select, textarea, and contenteditable controls retain their native arrow-key behavior.\n- ariaLabelledby takes precedence over ariaLabel when both are supplied.\n- wrap and loop default to true; rovingFocus defaults to true.\n- Set `rovingFocus=\"false\"` only when embedded controls require their own composite keyboard model.\n- Set `unstyled` or global NeuralNg unstyled and use typed root, start, center, end, and separator classes for consumer visuals.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/toolbar-end/contract",
      "readme": "neural://components/toolbar-end/readme",
      "llms": "neural://components/toolbar-end/llms"
    },
    "sourceDirectory": "libs/neural-ng/toolbar",
    "readme": "# NeuralNg Toolbar\n\nAccessible, standalone action grouping for Angular 22+.\n\n**Beta status:** the documented contract is ready for application-level\nvalidation. Beta consumers should still pin an exact version until stable.\n\n```ts\nimport { NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, NeuralToolbarSeparator } from '@neural-ng/core/toolbar';\n```\n\n```html\n<neural-toolbar ariaLabel=\"Editor actions\">\n  <neural-toolbar-start>...</neural-toolbar-start>\n  <neural-toolbar-separator />\n  <neural-toolbar-center>...</neural-toolbar-center>\n  <neural-toolbar-end>...</neural-toolbar-end>\n</neural-toolbar>\n```\n\nToolbar uses `role=\"toolbar\"`, one roving tab stop, Arrow/Home/End navigation,\ndisabled-item skipping, RTL-aware horizontal arrows, and focus restoration of\nconsumer tabindex values on destroy. Use `orientation=\"vertical\"` for vertical\ntoolbars. `wrap`, `loop`, and `rovingFocus` are configurable.\n\n`ariaLabelledby` takes precedence over `ariaLabel`. The `focusChanged` output\nemits the focused index, element, and native keyboard or focus event. Editable\ncontrols keep their native arrow-key behavior. Dynamic projected controls are\nresynchronized without leaking the internal MutationObserver.\n\nStart, center, and end sections accept `sectionClass`; the separator accepts\n`separatorClass`. Root-level `toolbarClass` and typed `classes` slots are both\navailable for the internal semantic elements.\n\nLocal/global `unstyled` removes NeuralNg visual classes while structural hooks\nand typed `NeuralToolbarClasses` slots remain.\n\nThe former `Toolbar*Component` exports remain deprecated compatibility aliases.\nNew code should use the canonical `NeuralToolbar*` names.\n",
    "llms": "# @neural-ng/core/toolbar\n\n- Import NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, and NeuralToolbarSeparator from `@neural-ng/core/toolbar`. Toolbar*Component names are deprecated compatibility aliases.\n- Use one `neural-toolbar` with start, center, and end projected sections.\n- Add `neural-toolbar-separator` between related action groups.\n- Always provide a meaningful `ariaLabel` or `ariaLabelledby`.\n- Orientation is `horizontal` by default; use `vertical` when controls stack.\n- Arrow keys follow orientation. Horizontal ArrowLeft/ArrowRight mirror in RTL. Home/End move to edges.\n- Roving focus skips disabled and aria-disabled controls and restores consumer tabindex values on destroy.\n- focusChanged emits index, element, and nativeEvent after pointer, Tab, or directional focus changes.\n- Editable input, select, textarea, and contenteditable controls retain their native arrow-key behavior.\n- ariaLabelledby takes precedence over ariaLabel when both are supplied.\n- wrap and loop default to true; rovingFocus defaults to true.\n- Set `rovingFocus=\"false\"` only when embedded controls require their own composite keyboard model.\n- Set `unstyled` or global NeuralNg unstyled and use typed root, start, center, end, and separator classes for consumer visuals.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/toolbar-separator/contract",
      "readme": "neural://components/toolbar-separator/readme",
      "llms": "neural://components/toolbar-separator/llms"
    },
    "sourceDirectory": "libs/neural-ng/toolbar",
    "readme": "# NeuralNg Toolbar\n\nAccessible, standalone action grouping for Angular 22+.\n\n**Beta status:** the documented contract is ready for application-level\nvalidation. Beta consumers should still pin an exact version until stable.\n\n```ts\nimport { NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, NeuralToolbarSeparator } from '@neural-ng/core/toolbar';\n```\n\n```html\n<neural-toolbar ariaLabel=\"Editor actions\">\n  <neural-toolbar-start>...</neural-toolbar-start>\n  <neural-toolbar-separator />\n  <neural-toolbar-center>...</neural-toolbar-center>\n  <neural-toolbar-end>...</neural-toolbar-end>\n</neural-toolbar>\n```\n\nToolbar uses `role=\"toolbar\"`, one roving tab stop, Arrow/Home/End navigation,\ndisabled-item skipping, RTL-aware horizontal arrows, and focus restoration of\nconsumer tabindex values on destroy. Use `orientation=\"vertical\"` for vertical\ntoolbars. `wrap`, `loop`, and `rovingFocus` are configurable.\n\n`ariaLabelledby` takes precedence over `ariaLabel`. The `focusChanged` output\nemits the focused index, element, and native keyboard or focus event. Editable\ncontrols keep their native arrow-key behavior. Dynamic projected controls are\nresynchronized without leaking the internal MutationObserver.\n\nStart, center, and end sections accept `sectionClass`; the separator accepts\n`separatorClass`. Root-level `toolbarClass` and typed `classes` slots are both\navailable for the internal semantic elements.\n\nLocal/global `unstyled` removes NeuralNg visual classes while structural hooks\nand typed `NeuralToolbarClasses` slots remain.\n\nThe former `Toolbar*Component` exports remain deprecated compatibility aliases.\nNew code should use the canonical `NeuralToolbar*` names.\n",
    "llms": "# @neural-ng/core/toolbar\n\n- Import NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, and NeuralToolbarSeparator from `@neural-ng/core/toolbar`. Toolbar*Component names are deprecated compatibility aliases.\n- Use one `neural-toolbar` with start, center, and end projected sections.\n- Add `neural-toolbar-separator` between related action groups.\n- Always provide a meaningful `ariaLabel` or `ariaLabelledby`.\n- Orientation is `horizontal` by default; use `vertical` when controls stack.\n- Arrow keys follow orientation. Horizontal ArrowLeft/ArrowRight mirror in RTL. Home/End move to edges.\n- Roving focus skips disabled and aria-disabled controls and restores consumer tabindex values on destroy.\n- focusChanged emits index, element, and nativeEvent after pointer, Tab, or directional focus changes.\n- Editable input, select, textarea, and contenteditable controls retain their native arrow-key behavior.\n- ariaLabelledby takes precedence over ariaLabel when both are supplied.\n- wrap and loop default to true; rovingFocus defaults to true.\n- Set `rovingFocus=\"false\"` only when embedded controls require their own composite keyboard model.\n- Set `unstyled` or global NeuralNg unstyled and use typed root, start, center, end, and separator classes for consumer visuals.\n"
  },
  {
    ...
    "resources": {
      "contract": "neural://components/toolbar-start/contract",
      "readme": "neural://components/toolbar-start/readme",
      "llms": "neural://components/toolbar-start/llms"
    },
    "sourceDirectory": "libs/neural-ng/toolbar",
    "readme": "# NeuralNg Toolbar\n\nAccessible, standalone action grouping for Angular 22+.\n\n**Beta status:** the documented contract is ready for application-level\nvalidation. Beta consumers should still pin an exact version until stable.\n\n```ts\nimport { NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, NeuralToolbarSeparator } from '@neural-ng/core/toolbar';\n```\n\n```html\n<neural-toolbar ariaLabel=\"Editor actions\">\n  <neural-toolbar-start>...</neural-toolbar-start>\n  <neural-toolbar-separator />\n  <neural-toolbar-center>...</neural-toolbar-center>\n  <neural-toolbar-end>...</neural-toolbar-end>\n</neural-toolbar>\n```\n\nToolbar uses `role=\"toolbar\"`, one roving tab stop, Arrow/Home/End navigation,\ndisabled-item skipping, RTL-aware horizontal arrows, and focus restoration of\nconsumer tabindex values on destroy. Use `orientation=\"vertical\"` for vertical\ntoolbars. `wrap`, `loop`, and `rovingFocus` are configurable.\n\n`ariaLabelledby` takes precedence over `ariaLabel`. The `focusChanged` output\nemits the focused index, element, and native keyboard or focus event. Editable\ncontrols keep their native arrow-key behavior. Dynamic projected controls are\nresynchronized without leaking the internal MutationObserver.\n\nStart, center, and end sections accept `sectionClass`; the separator accepts\n`separatorClass`. Root-level `toolbarClass` and typed `classes` slots are both\navailable for the internal semantic elements.\n\nLocal/global `unstyled` removes NeuralNg visual classes while structural hooks\nand typed `NeuralToolbarClasses` slots remain.\n\nThe former `Toolbar*Component` exports remain deprecated compatibility aliases.\nNew code should use the canonical `NeuralToolbar*` names.\n",
    "llms": "# @neural-ng/core/toolbar\n\n- Import NeuralToolbar, NeuralToolbarStart, NeuralToolbarCenter, NeuralToolbarEnd, and NeuralToolbarSeparator from `@neural-ng/core/toolbar`. Toolbar*Component names are deprecated compatibility aliases.\n- Use one `neural-toolbar` with start, center, and end projected sections.\n- Add `neural-toolbar-separator` between related action groups.\n- Always provide a meaningful `ariaLabel` or `ariaLabelledby`.\n- Orientation is `horizontal` by default; use `vertical` when controls stack.\n- Arrow keys follow orientation. Horizontal ArrowLeft/ArrowRight mirror in RTL. Home/End move to edges.\n- Roving focus skips disabled and aria-disabled controls and restores consumer tabindex values on destroy.\n- focusChanged emits index, element, and nativeEvent after pointer, Tab, or directional focus changes.\n- Editable input, select, textarea, and contenteditable controls retain their native arrow-key behavior.\n- ariaLabelledby takes precedence over ariaLabel when both are supplied.\n- wrap and loop default to true; rovingFocus defaults to true.\n- Set `rovingFocus=\"false\"` only when embedded controls require their own composite keyboard model.\n- Set `unstyled` or global NeuralNg unstyled and use typed root, start, center, end, and separator classes for consumer visuals.\n"
  ...
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/tree-select/readme",
      "llms": "neural://components/tree-select/llms"
    },
    "sourceDirectory": "libs/neural-ng/tree-select",
  ...
  },
  {
    ...
    "resources": {
      "contract": "neural://components/tri-state-checkbox/contract",
      "readme": "neural://components/tri-state-checkbox/readme",
      "llms": "neural://components/tri-state-checkbox/llms"
    },
    "sourceDirectory": "libs/neural-ng/checkbox",
    "readme": "# NeuralNg Checkbox\n\nCheckbox Beta provides native, Signal-first binary and tri-state controls for Angular 22+.\nThe two value contracts are intentionally separate so every Angular Forms\nadapter sees one stable model type.\n\n## Import\n\n```ts\nimport { NeuralCheckbox, NeuralTriStateCheckbox, type NeuralCheckboxChange, type NeuralTriStateCheckboxChange, type NeuralTriStateCheckboxValue } from '@neural-ng/core/checkbox';\n```\n\n## Binary checkbox\n\n```html\n<neural-checkbox [(checked)]=\"accepted\" required (stateChange)=\"acceptedChanged($event)\"> I accept the terms </neural-checkbox>\n```\n\n`NeuralCheckbox` implements `FormCheckboxControl`. Its `checked` model is\nalways `boolean`, which makes the same component compatible with Signal Forms,\nReactive Forms, and template-driven forms.\n\nFor collection-level “some selected” controls, set `[indeterminate]=\"true\"`.\nThis is presentation and accessibility state (`aria-checked=\"mixed\"`), not a\nthird model value: `checked` remains strictly boolean. Use\n`NeuralTriStateCheckbox` when `null` is part of the application value.\n\n```html\n<neural-checkbox [formField]=\"form.accepted\">Accept</neural-checkbox>\n<neural-checkbox [formControl]=\"acceptedControl\">Accept</neural-checkbox>\n<neural-checkbox name=\"accepted\" [(ngModel)]=\"accepted\">Accept</neural-checkbox>\n```\n\n## Tri-state checkbox\n\n```html\n<neural-tri-state-checkbox [(value)]=\"permission\"> Inherit permission </neural-tri-state-checkbox>\n```\n\n`NeuralTriStateCheckbox` implements\n`FormValueControl<boolean | null>`. Interaction cycles\n`false -> true -> null -> false`. `null` is rendered through the native\ncheckbox's `indeterminate` property and `aria-checked=\"mixed\"`.\n\n```html\n<neural-tri-state-checkbox [formField]=\"form.permission\"> Inherit permission </neural-tri-state-checkbox>\n<neural-tri-state-checkbox [formControl]=\"permissionControl\"> Inherit permission </neural-tri-state-checkbox>\n<neural-tri-state-checkbox name=\"permission\" [(ngModel)]=\"permission\"> Inherit permission </neural-tri-state-checkbox>\n```\n\nTri-state has no separate `indeterminate` model. Its `value` remains the single\nauthoritative source; the binary Checkbox input is only for collection-state\npresentation.\n\n## Migration from the combined alpha API\n\n```html\n<!-- Before -->\n<neural-checkbox triState [(checked)]=\"permission\"> Inherit permission </neural-checkbox>\n\n<!-- After -->\n<neural-tri-state-checkbox [(value)]=\"permission\"> Inherit permission </neural-tri-state-checkbox>\n```\n\nBinary usages keep `neural-checkbox` and `[(checked)]` unchanged.\n\n## Events\n\nBinary Checkbox:\n\n- `checkedChange` is generated by the `checked` model.\n- `stateChange` emits `{ checked, previousChecked, nativeEvent }` for user\n  actions.\n\nTri-state Checkbox:\n\n- `valueChange` is generated by the `value` model.\n- `stateChange` emits `{ value, previousValue, nativeEvent }` for user actions.\n\nProgrammatic form or model updates do not emit either semantic `stateChange`\nevent.\n\n## Readonly and disabled\n\n`disabled` removes the native control from interaction and focus. `readonly`\nkeeps it focusable, exposes `aria-readonly=\"true\"`, and blocks mutation. Both\ncontrols emit `touch` when the native input loses focus.\n\n## Native behavior\n\nBoth components contain a real `<input type=\"checkbox\">`. Label activation,\nSpace, focus, required, name, input value, constraint validation, and form\nsubmission retain native behavior. Native HTML submission only submits checked\ncheckboxes; use the Angular model when `false` or `null` must be persisted.\n\n## Styling\n\nThe default check and mixed marks are pure CSS, so neither component depends on\nan icon package. Both share `--neural-checkbox-*` theme tokens.\n\n`unstyled` removes visual classes while preserving the native input, structure,\nstate, and consumer classes. Use `checkboxClass`, `inputClass`, `labelClass`, or\ntyped `classes` slots.\n\nBinary slots: `root`, `input`, `control`, `checkedControl`, and `label`.\nTri-state adds `mixedControl`.\n\n## Field composition\n\nInside `neural-field`, both components inherit deterministic control ids,\ndescriptions, required, invalid, disabled, readonly, pending, fluid, and\nunstyled state.\n\nThe generated ids use Angular's application id and deterministic counters. The\ncomponents contain no eager browser globals and are safe for SSR and hydration;\n`focus()` only touches the native element when explicitly called in a browser.\n\n## Compatibility aliases\n\n`CheckboxComponent` and `TriStateCheckboxComponent` remain deprecated aliases.\nNew application and AI-generated code must use `NeuralCheckbox` and\n`NeuralTriStateCheckbox`.\n\n## Beta boundary\n\nCheckbox Beta includes native binary and tri-state inputs, all three Angular\nForms adapters, Field composition, readonly and disabled semantics, required,\ninvalid and pending state, semantic user events, imperative focus/reset,\ntyped class slots, global/local unstyled behavior, theme tokens, SSR and\nhydration safety. Group validation and business rules remain application or\nField responsibilities.\n",
    "llms": "# @neural-ng/core/checkbox\n\nAngular 22+ standalone native binary and tri-state Checkbox Beta controls.\n\nIMPORT\nimport {\n  NeuralCheckbox,\n  NeuralTriStateCheckbox,\n} from '@neural-ng/core/checkbox';\n\nBINARY\n<neural-checkbox [(checked)]=\"accepted\">\n  I accept the terms\n</neural-checkbox>\n\nTRI-STATE\n<neural-tri-state-checkbox [(value)]=\"permission\">\n  Inherit permission\n</neural-tri-state-checkbox>\n\nFORMS\n<neural-checkbox [formField]=\"form.accepted\">Accept</neural-checkbox>\n<neural-checkbox [formControl]=\"acceptedControl\">Accept</neural-checkbox>\n<neural-checkbox name=\"accepted\" [(ngModel)]=\"accepted\">Accept</neural-checkbox>\n\n<neural-tri-state-checkbox [formField]=\"form.permission\">\n  Inherit\n</neural-tri-state-checkbox>\n\nRULES\n- NeuralCheckbox implements FormCheckboxControl.\n- Binary checked is always boolean and generates checkedChange.\n- Binary `indeterminate` is presentation-only for partial collection\n  selection. It maps to native indeterminate plus aria-checked=\"mixed\" and\n  never changes the boolean checked model.\n- NeuralTriStateCheckbox implements FormValueControl<boolean | null>.\n- Never generate the deprecated CheckboxComponent or\n  TriStateCheckboxComponent aliases.\n- Tri-state value generates valueChange and cycles false -> true -> null -> false.\n- null means mixed and maps to the native indeterminate property plus\n  aria-checked=\"mixed\".\n- Do not add triState back to neural-checkbox and do not bind nullable data to\n  checked.\n- Do not invent a separate indeterminate model for tri-state; tri-state value\n  is authoritative.\n- stateChange is a user-only semantic event. Programmatic form/model writes do\n  not emit it.\n- disabled removes interaction. readonly remains focusable and blocks mutation.\n- touch emits when the native input blurs.\n- Preserve the real input[type=checkbox], projected label, native Space\n  activation, required, name, value, focus, and form behavior.\n- Use ariaLabel when there is no visible projected label.\n- Both components share --neural-checkbox-* theme tokens.\n- Use unstyled or global provideNeuralNg({ unstyled: true }) for headless mode.\n- Inside neural-field, inherit accessible ids, descriptions, and field state.\n- The components are SSR/hydration safe. Call focus() only from browser-side\n  interaction code.\n- Beta boundary: Checkbox owns native binary/tri-state input behavior and form\n  integration. Business validation and group semantics belong to the consumer\n  or Neural Field.\n"
  },
  {
    ...
    "resources": {
      ...
      "readme": "neural://components/virtual-scroller/readme",
      "llms": "neural://components/virtual-scroller/llms"
    },
    "sourceDirectory": "libs/neural-ng/virtual-scroller",
    "readme": "# NeuralNg VirtualScroller\n\nFixed-size, SSR-safe collection windowing for Angular Signals applications.\n\nCurrent maturity: **Beta**.\n\n```ts\nimport { NeuralVirtualScroller, NeuralVirtualScrollerItemTemplate } from '@neural-ng/core/virtual-scroller';\n```\n\n```html\n<neural-virtual-scroller [items]=\"records\" [itemSize]=\"48\" [viewportSize]=\"320\" [(first)]=\"first\">\n  <ng-template [neuralVirtualScrollerItem]=\"records\" let-record let-index=\"index\"> {{ index + 1 }}. {{ record.name }} </ng-template>\n</neural-virtual-scroller>\n```\n\n`rangeChange` and `lazyLoad` expose `start`/`end` rendered indices and\n`visibleStart`/`visibleEnd` viewport indices. Both `end` values are exclusive.\nUse `scrollToIndex()` or `scrollToOffset()` for imperative navigation.\n\nBeta supports fixed-size vertical and horizontal items, overscan, controlled\n`first`, immutable data, typed item/empty/loading templates, loading overlay,\nglobal or local `unstyled`, typed class slots, native list semantics, and SSR.\nVariable-size measurement and two-dimensional grids are intentionally outside\nthis entry point's beta contract.\n",
    "llms": "# NeuralNg VirtualScroller AI context\n\nCurrent component maturity: beta.\n\nImport `NeuralVirtualScroller` only from\n`@neural-ng/core/virtual-scroller`; never create an NgModule.\n`VirtualScrollerComponent` is a deprecated compatibility alias; never generate\nit in new code.\n\nAlways provide an immutable `items` collection, a deterministic positive\n`itemSize`, and the viewport's scroll-axis size through `viewportSize`. Bind the\nsame collection to `[neuralVirtualScrollerItem]` so Angular infers the item\ntemplate type.\n\nRanges are end-exclusive. `start`/`end` describe the overscanned rendered\nwindow; `visibleStart`/`visibleEnd` describe items intersecting the viewport.\nUse `lazyLoad` for server range requests and keep request-race handling in the\nconsumer data source.\n\nVirtualScroller is presentation infrastructure. Do not add selection, editing,\ntree expansion, or layout switching to its state. Compose those behaviors in a\nconsumer component. Beta requires fixed-size items; never generate variable\nitem heights and claim deterministic positioning.\n\nUse `unstyled` and typed `classes` for custom visuals. Preserve region/list/\nlistitem semantics and `aria-posinset`/`aria-setsize` metadata.\n"
  }
] satisfies readonly NeuralComponentDocument[];
...
export const GENERATED_PACKAGE_CATALOG = {
  ...
  "runtimeEntryPoints": [
    ...
    "@neural-ng/core/appearance",
    "@neural-ng/core/auto-complete",
    "@neural-ng/core/avatar",
    "@neural-ng/core/badge",
    "@neural-ng/core/breadcrumb",
    "@neural-ng/core/button",
    "@neural-ng/core/card",
    "@neural-ng/core/checkbox",
    "@neural-ng/core/color-mode",
    "@neural-ng/core/confirm-dialog",
    "@neural-ng/core/data-view",
    "@neural-ng/core/date-picker",
    "@neural-ng/core/dialog",
    "@neural-ng/core/divider",
    "@neural-ng/core/drawer",
    "@neural-ng/core/field",
    "@neural-ng/core/file-upload",
    "@neural-ng/core/i18n",
    "@neural-ng/core/input",
    "@neural-ng/core/input-mask",
    "@neural-ng/core/input-number",
    "@neural-ng/core/input-otp",
    "@neural-ng/core/loading-overlay",
    ...
    "@neural-ng/core/menu",
    "@neural-ng/core/message",
    "@neural-ng/core/meter-group",
    "@neural-ng/core/multi-select",
    "@neural-ng/core/overlay",
    "@neural-ng/core/paginator",
    "@neural-ng/core/panel-menu",
    "@neural-ng/core/password",
    "@neural-ng/core/popover",
    "@neural-ng/core/progress-bar",
    "@neural-ng/core/progress-spinner",
    "@neural-ng/core/radio",
    "@neural-ng/core/select",
    "@neural-ng/core/sidebar",
    "@neural-ng/core/skeleton",
    "@neural-ng/core/slider",
    "@neural-ng/core/switch",
    "@neural-ng/core/table",
    "@neural-ng/core/tabs",
    "@neural-ng/core/tag",
    "@neural-ng/core/textarea",
    "@neural-ng/core/toast",
    "@neural-ng/core/toolbar",
    "@neural-ng/core/tooltip",
    "@neural-ng/core/tree",
    "@neural-ng/core/tree-select",
    "@neural-ng/core/virtual-scroller"
  ],
  "documentedExports": [
    "./accordion/llms.txt",
    "./accordion/README.md",
...
export const GENERATED_THEMES = [
  {
    "id": "experimental/futuristic",
    "exportPath": "@neural-ng/core/themes/experimental/futuristic.css",
    "stability": "experimental"
  },
  {
    "id": "experimental/glass",
    "exportPath": "@neural-ng/core/themes/experimental/glass.css",
    "stability": "experimental"
  },
  {
    "id": "experimental/mist",
    "exportPath": "@neural-ng/core/themes/experimental/mist.css",
    "stability": "experimental"
  },
  {
    "id": "neutral",
    "exportPath": "@neural-ng/core/themes/neutral.css",
    "stability": "stable"
  },
  {
    "id": "tailwind",
    "exportPath": "@neural-ng/core/themes/tailwind.css",
    "stability": "bridge"
  }
] satisfies readonly NeuralThemeCatalogEntry[];
